---
description: Obtenga información sobre las integraciones de Adobe Experience Cloud con Marketo Engage, incluida la sincronización de audiencias nativas y Audience Manager. Configure integraciones y desbloquee el marketing a petición B2B en todas las aplicaciones de Adobe.
...
>[!NOTE]
>
>Las integraciones, que incluyen Audience Manager y [!DNL Adobe Real-Time CDP Marketo Connecter], pueden requerir la asignación de la organización de IMS en Marketo Engage. [Aprenda a configurar la asignación de organizaciones de Adobe](/help/marketo/product-docs/adobe-experience-cloud-integrations/set-up-adobe-organization-mapping.md){target="_blank"}.
