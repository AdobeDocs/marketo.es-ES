...
Descargue [el complemento](http://docs.marketo.com/x/LoJo) más reciente correspondiente a su versión de Dynamics.
...
1. Verá la siguiente ventana emergente. Seleccione las opciones de personalización **Actualizar** y **Sobrescribir** y, a continuación, haga clic en **Importar**.
