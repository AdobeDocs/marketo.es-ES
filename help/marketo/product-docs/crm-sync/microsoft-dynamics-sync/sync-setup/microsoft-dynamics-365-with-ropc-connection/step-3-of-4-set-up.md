...
1. Clic **Nuevo secreto de cliente**.

   ![](assets/step-3-of-4-set-up-client-app-ms-dynamics-ropc-2.png)

1. Añada una descripción del Secreto del cliente y haga clic en **Añadir**.
...
>[!MORELIKETHIS]
>
>* [Paso 4 de 4: Conectar la solución de Marketo con la conexión de control de contraseña del propietario de los recursos](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-365-with-ropc-connection/step-4-of-4-connect.md)
