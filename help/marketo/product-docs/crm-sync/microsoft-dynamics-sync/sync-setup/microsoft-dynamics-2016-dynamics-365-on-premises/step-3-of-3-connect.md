...
>* [Instale Marketo para Microsoft Dynamics 2016/Dynamics 365 local, paso 2 de 3](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-2016-dynamics-365-on-premises/step-2-of-3-set-up.md)
...
1. Introduzca el **Nombre de usuario**, **Contraseña** a Microsoft Dynamics **URL**, y a **Id/Secreto De Cliente**. Clic **Guardar** cuando termine.
   ...
   >[!TIP]
   >
   >¿No conoce la dirección URL? Le mostraremos cómo encontrar su [URL del servicio de organización de Dynamics](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/view-the-organization-service-url.md) aquí.
