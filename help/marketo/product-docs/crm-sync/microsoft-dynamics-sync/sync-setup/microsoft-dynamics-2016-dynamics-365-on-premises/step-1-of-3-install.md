...
1. Iniciar sesión en **[!DNL Dynamics].** Haga clic en el menú desplegable **[!DNL Microsoft Dynamics]CRM** y seleccione **[!UICONTROL Configuración]**.
...
1. Seleccione la solución Marketo y haga clic en **[!UICONTROL Publicar todas las personalizaciones]**.
   ...
   >[!MORELIKETHIS]
   >
   >[Instalar Marketo para [!DNL Dynamics] 2015 local y 365 local 2 de 3](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-2016-dynamics-365-on-premises/step-2-of-3-set-up.md) de 2016
