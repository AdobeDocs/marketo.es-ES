...
# Conceder consentimiento para el ID de cliente y el registro de la aplicación {#grant-consent-for-client-id-and-app-registration}
...
Como administrador, también puede dar su consentimiento a los permisos delegados de una aplicación en nombre de todos los usuarios del inquilino. El consentimiento administrativo evita que aparezca el cuadro de diálogo de consentimiento para cada usuario del inquilino y los usuarios con la función de administrador pueden hacerlo en el portal de Azure. Descubra qué funciones de administrador pueden [consentimiento a permisos delegados aquí](https://docs.microsoft.com/en-us/azure/active-directory/roles/permissions-reference).
...
1. Haga clic en el **Conceder consentimiento de administrador** (para el inquilino).
