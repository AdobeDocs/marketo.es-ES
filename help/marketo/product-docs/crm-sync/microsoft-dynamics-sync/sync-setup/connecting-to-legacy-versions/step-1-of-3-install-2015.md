...
description: Obtenga información sobre cómo instalar la solución de Marketo para Dynamics 2015 local. Importe la solución y complete los pasos de instalación en Dynamics.
