...
description: Obtenga información sobre cómo configurar el usuario de sincronización de Marketo para Dynamics 2015 local. Cree el usuario y asigne la función Usuario de sincronización de Marketo en Dynamics.
