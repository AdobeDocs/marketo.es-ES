...
# Paso 1 de 3: Instalación de la solución de Marketo en Dynamics (local 2013) {#step-of-install-the-marketo-solution-in-dynamics-on-premises}
...
>
>[Descargar la solución de Marketo](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/download-the-marketo-lead-management-solution.md) antes de comenzar.
...
1. Iniciar sesión **Dynamics**. Haga clic en el **Microsoft Dynamics CRM** menú desplegable y seleccione **Configuración**.
...
1. Haga clic en **Examinar** y seleccione [solución descargada](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/download-the-marketo-lead-management-solution.md). Haga clic en **Siguiente**.
...
1. Asegúrese de que la opción SDK esté seleccionada. Haga clic en **Importar**.
