...
Hay que saber algunas cosas a la hora de eliminar posibles clientes o contactos en Microsoft Dynamics.

* Marketo no elimina automáticamente a las personas solo porque se eliminaron posibles clientes en Dynamics. En su lugar, el indicador de campo &quot;Microsoft is Deleted&quot; se establece en true. Puede desactivar este campo para eliminar el registro en Marketo si lo desea.
