...
description: Obtenga información acerca de cómo funciona la sincronización de oportunidades de Microsoft Dynamics a Marketo. Comprenda la sincronización unidireccional y cómo las oportunidades se asocian con los contactos y los posibles clientes.
