...
description: Microsoft Dynamics Sync - Sincronización de usuarios - Documentos de marketing - Documentación del producto
...
Necesitará un usuario de Microsoft Dynamics CRM dedicado para la integración. Llamamos a este usuario al usuario de sincronización.

## ¿Cómo se mantienen sincronizados los datos del usuario entre los dos sistemas? {#how-are-user-details-kept-in-sync-between-the-two-systems}

La sincronización de usuarios es de una forma: de Dynamics a Marketing. Si realiza cambios en un usuario de Dynamics, los cambios se reflejarán en Marketing.

## ¿Puedo crear un usuario con Marketing? {#can-i-create-an-user-using-marketo}

No. Marketing no puede crear usuarios en Dynamics.
