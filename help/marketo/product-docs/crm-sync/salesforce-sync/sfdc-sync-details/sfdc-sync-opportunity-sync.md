...
description: Descubra cómo funciona la sincronización de oportunidades de Salesforce a Marketo. Vea cómo las oportunidades se sincronizan, se asocian con los contactos y utilizan déclencheur y filtros de oportunidad.
...
>[!TIP]
>
>Revise las restricciones de los filtros y déclencheur para obtener más información.
>
>Cree un nuevo campo en el objeto de oportunidad en [!DNL Salesforce] y se convertirá automáticamente en una restricción.
