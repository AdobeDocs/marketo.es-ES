...
* Combinando dos personas en **Marketo** en realidad invoca el mismo proceso que fusionarlos como posibles clientes en Salesforce. Sigue funcionando automáticamente.
* Combinación de **posible cliente (persona) en un contacto** funciona de la misma manera. Acabas con un solo contacto en ambos lados.
...
>[!NOTE]
>
>Análisis profundo para obtener más información sobre [combinación de personas en Marketo](/help/marketo/product-docs/core-marketo-concepts/smart-lists-and-static-lists/managing-people-in-smart-lists/find-and-merge-duplicate-people.md).
