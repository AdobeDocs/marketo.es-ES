...
description: Aprenda a personalizar las actividades que Marketo inserta en Salesforce. Habilite los tipos de actividades en Opciones de administración y sincronización para crear el historial de actividades de Salesforce a partir de eventos.
...
>[!TIP]
>
>Si está interesado en obtener más información de Marketo en Salesforce, eche un vistazo a nuestro producto [Marketo Sales Insight](/help/marketo/product-docs/marketo-sales-insight/msi-for-salesforce/installation/install-marketo-sales-insight-package-in-salesforce-appexchange.md){target="_blank"}.
