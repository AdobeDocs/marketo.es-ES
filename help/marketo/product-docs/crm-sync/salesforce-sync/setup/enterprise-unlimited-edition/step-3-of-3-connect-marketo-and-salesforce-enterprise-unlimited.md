...
description: Aprenda a conectar Marketo y Salesforce en el paso final Enterprise o Unlimited. Recupere el token de seguridad del usuario de sincronización y establezca las credenciales.
