...
1. Inicie sesión en Salesforce con el usuario de sincronización de Marketo, haga clic en el nombre del usuario de sincronización y luego **[!UICONTROL Mis configuraciones]**.

   ![](assets/image2015-6-12-9-3a12-3a47.png)

1. En búsqueda rápida, escriba &quot;restablecer&quot; y haga clic en **[!UICONTROL Restablecer mi token de seguridad]**.

   ![](assets/image2015-6-12-9-3a13-3a39.png)

1. Clic **[!UICONTROL Restablecer token de seguridad]**.
...
1. En Marketo, vaya a **[!UICONTROL Administrador]**, seleccione **[!UICONTROL CRM]** y haga clic en **Sincronizar con [Salesforce.com](https://Salesforce.com)**

   ![](assets/image2014-12-9-9-3a52-3a58.png)

   >[!NOTE]
   >
   >Asegúrese de [oculte todos los campos que no necesite](/help/marketo/product-docs/crm-sync/salesforce-sync/sfdc-sync-details/hide-a-salesforce-field-from-the-marketo-sync.md){target="_blank"} en Marketo desde el usuario de sincronización antes de hacer clic en **[!UICONTROL Sincronizar campos]**. Una vez que haga clic en Sincronizar campos, todos los campos que el usuario pueda ver se crearán en Marketo de forma permanente y no se podrán eliminar.

1. Introduzca las credenciales del usuario de sincronización de Salesforce creadas en la parte 2 de la configuración de Salesforce ([Profesional](/help/marketo/product-docs/crm-sync/salesforce-sync/setup/professional-edition/step-2-of-3-create-a-salesforce-user-for-marketo-professional.md){target="_blank"} or [Enterprise](/help/marketo/product-docs/crm-sync/salesforce-sync/setup/enterprise-unlimited-edition/step-2-of-3-create-a-salesforce-user-for-marketo-enterprise-unlimited.md){target="_blank"}) y haga clic en **[!UICONTROL Sincronizar campos]** (marca **[!UICONTROL Sandbox]** solo si está sincronizando una zona protegida de Marketo con una de Salesforce).

   ![](assets/image2014-12-9-9-3a53-3a8.png)

   >[!CAUTION]
   >
   >Si ve el botón &quot;Iniciar sesión en Salesforce&quot; en lugar de los campos Nombre de usuario/Contraseña/Token, su suscripción a Marketo estará habilitada para OAuth. Por favor [consulte este artículo](/help/marketo/product-docs/crm-sync/salesforce-sync/log-in-using-oauth-2-0.md){target="_blank"}. En cuanto la sincronización comience a utilizar un conjunto de credenciales, _no hay cambio de credenciales o suscripción de Salesforce_. Si desea utilizar la autenticación básica, póngase en contacto con el equipo de cuenta de Adobe (su administrador de cuentas).
...
1. Lea la advertencia y haga clic en **[!UICONTROL Confirmar credenciales]**.
   ...
   >[!CAUTION]
   >
   >Si desea ver el [asignaciones y personalizarlas](/help/marketo/product-docs/crm-sync/salesforce-sync/setup/optional-steps/edit-initial-field-mappings.md){target="_blank"}¡Esta es tu única oportunidad de hacerlo! Una vez que haga clic en Iniciar sincronización de Salesforce, ya estará listo.

## Iniciar sincronización de Salesforce {#start-salesforce-sync}

1. Clic **[!UICONTROL Iniciar sincronización de Salesforce]** para iniciar la sincronización persistente entre Marketo y Salesforce.
...
1. En Marketo, haga clic en **[!UICONTROL Administrador]**, entonces **Salesforce**.

   ![](assets/image2014-12-9-9-3a53-3a40.png)

1. El estado de sincronización es visible en la esquina superior derecha. Mostrará uno de los tres mensajes siguientes: **[!UICONTROL Última sincronización]**, **[!UICONTROL Sincronización en curso]**, o **[!UICONTROL Error]**.
