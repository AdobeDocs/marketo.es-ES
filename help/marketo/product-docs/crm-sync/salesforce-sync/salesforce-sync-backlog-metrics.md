---
description: Obtenga información acerca de las métricas de registro de pendientes de sincronización de Salesforce y cómo supervisar los registros pendientes de sincronización. Vea la tendencia del registro de pendientes y el rendimiento por tipo de objeto en Administración y Salesforce.
