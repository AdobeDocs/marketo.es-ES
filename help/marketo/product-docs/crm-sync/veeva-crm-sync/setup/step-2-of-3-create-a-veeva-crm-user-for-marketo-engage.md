...
1. Haga clic en los diseños de página Cuenta (cuenta de persona) en la barra de búsqueda de navegación sin pulsar Intro y, a continuación, haga clic en Diseño de página en Contactos.
...
1. Clic **HCP - Profesional**.

   ![](assets/step-2-of-3-create-a-veeva-crm-user-3.png)

1. Haga clic y arrastre un nuevo **Sección** en el diseño de página.

1. Introduzca &quot;Marketo&quot; en Nombre de sección y haga clic en **OK**.
...
1. En la sección Permisos generales de usuario, asegúrese de que las opciones Editar eventos y Editar tareas están seleccionadas.

   ![](assets/step-2-of-3-create-a-veeva-crm-user-13.png)

1. En la sección Permisos de objetos estándar, asegúrese de que los permisos Leer, Crear, Editar y Eliminar están comprobados para Cuentas y Contactos.

   ![](assets/step-2-of-3-create-a-veeva-crm-user-14.png)

1. En la sección Permisos de objetos personalizados, asegúrese de que los permisos de lectura estén comprobados para Llamada, Mensaje de clave de llamada y cualquier otro objeto personalizado deseado.
...
1. En la página de detalles del perfil, vaya a la sección Seguridad de nivel de campo. Haga clic en Ver para editar la accesibilidad de los objetos Contacto y Cuenta.
...
Busque los campos innecesarios, asegúrese de que el acceso de lectura y el acceso de edición están **onu** comprobado. Clic **Guardar** cuando termine.
...
1. Cuando termine de deshabilitar todos los campos innecesarios, compruebe Acceso de lectura y Acceso de edición para ver los siguientes campos de objeto. Haga clic en Guardar cuando termine.
...
1. Rellene los campos obligatorios, seleccione la licencia de usuario: Salesforce, establezca el perfil: Sincronizar usuario de Marketo y haga clic en **Guardar**.
