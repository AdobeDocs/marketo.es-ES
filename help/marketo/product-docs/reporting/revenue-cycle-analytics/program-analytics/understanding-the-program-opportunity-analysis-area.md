...
Las medidas disponibles para su uso en el análisis suelen ser números y se representan con puntos azules. Los Dimension son atributos que proporcionan diferentes vistas de las medidas y que están representados por puntos amarillos.
...
## Dimension en análisis de oportunidades de programas (puntos amarillos) {#program-opportunity-analysis-dimensions-yellow-dots}
