...
description: Obtenga información sobre cómo aprobar o desaprobar un modelo de ingresos en Marketo Engage mediante Aprobar o desaprobar un modelo de ingresos. Utilice esta guía para completar el siguiente paso.
title: Aprobar/no aprobar un modelo de ingresos
...
# Aprobar/no aprobar un modelo de ingresos {#approve-unapprove-a-revenue-model}
