...
description: Obtenga información sobre el modelo de ingresos en Marketo Engage, incluido el informe sobre el modelo de ingresos. Utilice esta guía para completar el siguiente paso.
...
¿Por qué es útil esto? El modelo muestra su funnel de ventas y marketing. Realice un seguimiento de sus balances a lo largo del tiempo para identificar cuellos de botella antes de que se conviertan en un problema.
