...
description: Obtenga información sobre el análisis de perspectivas de correo electrónico que explora los datos de series temporales acumulados para las métricas de envío y participación de correo electrónico. Utilice gráficos y perspectivas guiadas para descubrir controladores de rendimiento relevantes.
title: Información general de Analytics de perspectivas de correo electrónico
