...
1. Elija [mostrar personas](../../../../product-docs/reporting/basic-reporting/report-activity/display-people-or-anonymous-visitors-in-web-reports.md) conocidas o anónimas en el informe.
...
1. ¡Lo tienes! Revise el informe para ver quién está visitando el sitio.
   ...
   >[!TIP]
   >
   >Para averiguar quién visita más su sitio, [clasifique el informe](../../../../product-docs/reporting/basic-reporting/editing-reports/sort-report-on-columns.md) [](../../../../product-docs/reporting/basic-reporting/editing-reports/sort-report-on-columns.md)en la columna Vistas *de* página y elija Ordenar De bajada.

   [Marketo agrega visitantes de sitios web anónimos](../../../../product-docs/reporting/basic-reporting/report-activity/tracking-anonymous-activity-and-people.md) a la base de datos y puede elegir mostrarlos en este informe. Proporciona una gran cantidad de información aunque sean anónimas.\
   [Las columnas que puede seleccionar](../../../../product-docs/reporting/basic-reporting/editing-reports/select-report-columns.md) para un informe de Actividad de página Web incluyen:
...
<table> 
 ...
 <tbody> 
  <tr> 
   <td>Persona</td> 
   <td>Nombre, título y compañía del visitante.<br><strong>Haga clic</strong> para vista de los detalles de la persona y del historial de actividades.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td>Número de páginas cargadas por este visitante.<br><strong><a href="web-page-activity-report/web-pages-viewed-web-page-activity-report.md">Haga clic</a></strong> para ver la vista de las páginas visitadas.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td>La compañía, según se infiere de la dirección IP de los visitantes. <strong>Los nombres en negrita</strong> indican que esta es la compañía, no el ISP. </td> 
  </tr> 
  <tr> 
...
>**Buceo profundo**
>
>Obtenga información sobre otros informes interesantes en [Basic Sistema de informes](http://docs.marketo.com/display/docs/basic+reporting).
