...
1. Se crea una actividad anónima cuando alguien:
   ...
   * Utiliza Marketo [API DE REST](https://developers.marketo.com/rest-api/lead-database/leads/) o [Munchkin](https://developers.marketo.com/documentation/websites/lead-tracking-munchkin-js/) API (para desarrolladores) para asociar una actividad anónima con un registro conocido.
