...
1. Haga clic con el doble en el campo de intervalo de tiempo, con una etiqueta diferente según el tipo de informe:
   ...
   * **Fecha de Actividad**, en todos los demás informes
   ...
   >[!NOTE]
   >
   >**Persona creada en hace** referencia al momento en que la persona fue conocida en su base de datos.
...
1. Elija el intervalo de tiempo adecuado en el menú desplegable.
   ...
   >[!TIP]
   >
   >Para definir fechas específicas, seleccione **Personalizado** en el menú desplegable e introduzca las fechas en los campos **Desde** y **Hasta** .

   Haga clic en la ficha **Informe** para ver el informe durante el intervalo de tiempo seleccionado.\
   ...
   >
   >
   >Para reducir el informe según atributos de persona específicos, puede [filtrar personas en un informe con una Lista](filter-people-in-a-report-with-a-smart-list.md)inteligente.
