...
# Cambiar el lapso de tiempo de un informe {#change-a-report-time-frame}
...
1. Elija el lapso de tiempo adecuado en el menú desplegable.
   ...
   >[!MORELIKETHIS]
   >
   >Para restringir el informe por atributos de persona específicos, puede [Filtrar personas en un informe con una lista inteligente](/help/marketo/product-docs/reporting/basic-reporting/editing-reports/filter-people-in-a-report-with-a-smart-list.md).
