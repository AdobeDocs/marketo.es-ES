...
>[!NOTE]
>
>Clientes actuales, [Actualizar el paquete MSI](/help/marketo/product-docs/marketo-sales-insight/msi-for-salesforce/upgrading/upgrading-your-msi-package.md) antes de continuar.
...
1. Clic **Configurar** y luego **Administración móvil**.
...
1. Clic **Configuración de Salesforce1**.

   ![](assets/image2015-4-21-15-3a32-3a21.png)

1. Clic **Habilitar la aplicación de navegador móvil Salesforce1**.
...
1. Seleccionar **Administración móvil**.

   ![](assets/image2015-4-22-11-3a10-3a14.png)

1. Clic **Administrar el menú de navegación móvil**.

   ![](assets/image2015-4-22-11-3a13-3a10.png)

1. Seleccionar **Marketo** y **Añadir** a la **Seleccionado** elementos de menú.

   ![](assets/image2015-4-22-14-3a55-3a37.png)

1. Seleccionar **Marketo**, moverlo **Arriba** a un área deseada y haga clic en **Guardar**.
...
1. En **Configuración de ficha**, seleccione la _primero_ **Marketo**.

   ![](assets/image2015-5-5-13-3a55-3a36.png)

1. Seleccionar **Tabulación oculta**.
...
1. Seleccionar **Marketo** y **Añadir** Seleccione las fichas seleccionadas.
...
1. Clic **Configurar**, tipo **Diseños de página** y haga clic en **Diseños de página** en Posibles clientes.
...
1. Clic **Editar** para realizar cambios en el diseño del posible cliente.

   ![](assets/image2015-4-22-17-3a44-3a0.png)

1. Clic **Visualforce Pages** y luego arrastre **Móvil principal** Vaya a la sección Tarjetas móviles.
...
1. Clic **Campos** y arrastre **Añadir a Marketo Campaign** a la **Perspectiva de ventas de Marketo** sección.
