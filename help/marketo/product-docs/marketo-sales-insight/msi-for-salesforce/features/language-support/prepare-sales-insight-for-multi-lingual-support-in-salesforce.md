...
description: Preparar el conocimiento de ventas para el soporte multilingüe en Salesforce - Documentos de Marketo - Documentación del producto
title: Preparación de perspectivas de ventas para el soporte multilingüe en Salesforce
...
# Preparación de perspectivas de ventas para el soporte multilingüe en Salesforce {#prepare-sales-insight-for-multi-lingual-support-in-salesforce}
...
Cuando termine de personalizar su organización de Salesforce, le explicamos cómo devolver su configuración personal al inglés.
...
1. Seleccionar **Inglés** en la lista desplegable Idioma y haga clic en **Guardar**.
   ...
   ¡Ahora su Salesforce está de vuelta en inglés!
