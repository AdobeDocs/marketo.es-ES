...
1. Vaya a **Administrador** y, a continuación, haga clic en Perspectiva **de ventas**.
...
>[!NOTE]
>
>Cambiar esta configuración como administrador **no afectará** retroactivamente a las plantillas existentes; es decir, no los bloqueará automáticamente.
...
1. Marque **Publicar en perspectiva** de ventas de marketing si no está marcado. Ahora puede desactivar **Permitir que el usuario de CRM edite el correo electrónico** para bloquear la plantilla. Haga clic en **Guardar**.
