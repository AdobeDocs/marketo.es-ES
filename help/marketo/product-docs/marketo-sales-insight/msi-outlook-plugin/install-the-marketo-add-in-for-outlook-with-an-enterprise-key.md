...
description: Instale el complemento de Marketo para  [!DNL Outlook] con una clave de empresa - Documentos de Marketo - Documentación del producto
...
>[!PREREQUISITES]
>
>El administrador debe haber [emitido una licencia de complemento de correo electrónico de Marketo](/help/marketo/product-docs/marketo-sales-insight/msi-outlook-plugin/issue-a-marketo-email-add-in-license.md).
...
1. Haga clic en **[!UICONTROL Ver clave de empresa]**.

   ![](assets/image2016-7-25-14-3a35-3a38.png)

1. Copie la clave de licencia [!DNL Outlook Enterprise] y péguela en un mensaje de correo electrónico, junto con [este vínculo](/help/marketo/product-docs/marketo-sales-insight/msi-outlook-plugin/marketo-outlook-plugin-installation-by-it.md), y envíela a su departamento de TI para que la instale de forma remota.
