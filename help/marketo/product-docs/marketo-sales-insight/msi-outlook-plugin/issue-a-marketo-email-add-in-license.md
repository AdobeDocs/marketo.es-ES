...
1. En la ficha **Complemento de correo electrónico**, haga clic en **Licencia de problema**.

   ![](assets/image2016-7-22-10-3a20-3a15.png)

1. Escriba las direcciones de correo electrónico de los representantes de ventas que necesitan autorización para usar el complemento y haga clic en **Emitir licencia**.
...
>[!MORELIKETHIS]
>
>* [Instalar el complemento de Marketo para Outlook con una clave de empresa](/help/marketo/product-docs/marketo-sales-insight/msi-outlook-plugin/install-the-marketo-add-in-for-outlook-with-an-enterprise-key.md)
>* [Instalar el complemento de correo electrónico de Marketo para Outlook con un código de registro](/help/marketo/product-docs/marketo-sales-insight/msi-outlook-plugin/install-the-marketo-email-add-in-for-outlook-with-a-registration-code.md)
