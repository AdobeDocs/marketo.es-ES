...
1. Introduzca su **Código de registro**, **Correo electrónico**, **Nombre**, y **Apellidos**. Clic **Verificar y guardar**.

   ![](assets/three.png)

   >[!CAUTION]
   >
   >Asegúrese de utilizar su **cuenta de correo electrónico principal** al registrarse, ya que no se admite el uso de alias para este complemento.
