---
description: Obtenga información acerca de la configuración de administración de inicios de sesión para la autenticación de acciones de Sales Insight. Configure Solo Salesforce u otras opciones.
