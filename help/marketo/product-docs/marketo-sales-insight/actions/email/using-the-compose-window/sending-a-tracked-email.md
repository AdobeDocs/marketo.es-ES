---
description: Obtenga información sobre cómo enviar un correo electrónico de ventas rastreado para poder ver vistas, clics y respuestas. Utilice un canal de envío y rastree desde el Centro de comandos.
...
1. Componga el correo electrónico con el editor. Haga clic en **Enviar** (o en [Programar](/help/marketo/product-docs/marketo-sales-connect/email/using-the-compose-window/scheduling-an-email.md), si lo prefiere) cuando haya terminado.
   ...
   >[!MORELIKETHIS]
   >
   >* [Programando un correo electrónico](/help/marketo/product-docs/marketo-sales-insight/actions/email/using-the-compose-window/scheduling-an-email.md)
