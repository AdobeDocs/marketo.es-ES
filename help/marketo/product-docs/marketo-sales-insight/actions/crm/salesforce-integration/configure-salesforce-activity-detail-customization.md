---
description: Aprenda a configurar la personalización de los detalles de actividad de Salesforce para los campos de asunto de la tarea. Establezca lo que registra en la Tarea de Salesforce cuando se sincronizan las actividades.
