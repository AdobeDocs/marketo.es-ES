---
description: Obtenga información sobre el registro de respuestas para que las respuestas de los posibles clientes se registren en Salesforce. Habilitar las respuestas de registro cuando el registro de API esté activado y el seguimiento de respuestas esté disponible.
