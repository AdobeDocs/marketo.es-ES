---
description: Acciones de perspectiva de ventas y cumplimiento del RGPD - Documentos de Marketo - Documentación del producto
title: Acciones de perspectiva de ventas y cumplimiento del RGPD
...
# Acciones de perspectiva de ventas y cumplimiento del RGPD {#sales-insight-actions-and-gdpr-compliance}
...
Sales Insight Actions es una potente aplicación, parte de Marketo Engagement Platform, que proporciona un flujo de trabajo y una vista únicos para que las ventas y el marketing impulsen colectivamente una canalización más rápida mediante la participación colaborativa. Se ha creado una nueva funcionalidad en las acciones de información de ventas específica teniendo en cuenta el cumplimiento del RGPD. Describiremos las tres funciones y explicaremos cómo, cuando se utilicen correctamente, ayudarán a los esfuerzos de cumplimiento del RGPD de su organización.
...
Dentro de la tarjeta de cumplimiento, los usuarios pueden realizar un seguimiento de la base legal para procesar los datos personales de un contacto a través de la lista desplegable Autorización. Comprender el tipo de autorización de un contacto ayuda a los usuarios de Acciones de perspectiva de ventas a tomar decisiones más informadas sobre las prácticas de divulgación, lo que garantiza que cada campaña o participación sea legal y adecuada.
...
## Exportación De Datos De Contacto Desde Acciones De Perspectiva De Ventas {#exporting-contact-data-from-marketo-sales-connect}
...
>[!NOTE]
>
>El RGPD también requiere la capacidad de eliminar contactos de la interfaz de usuario, pero las acciones de información de ventas ya poseen esta funcionalidad.
