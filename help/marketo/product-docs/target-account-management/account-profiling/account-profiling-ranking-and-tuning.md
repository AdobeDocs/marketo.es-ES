...
description: Comprenda cómo la generación de perfiles de cuenta clasifica a las compañías según su ICP y agrega datos de indicadores a las cuentas con nombre. Ajuste el modelo y promocione las cuentas.
