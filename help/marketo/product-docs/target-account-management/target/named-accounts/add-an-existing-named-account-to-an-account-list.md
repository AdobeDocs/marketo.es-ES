...
description: 'Agregar una cuenta con un nombre existente a una lista de cuentas: Marketo Docs: Documentación del producto'
...
>[!NOTE]
>
>Esto solo se aplica a Listas de cuentas, **no** Listas de cuentas dinámicas.
...
1. Haga clic en la lista desplegable **Account List**, seleccione la lista de cuentas que desee y haga clic en **Add**.
