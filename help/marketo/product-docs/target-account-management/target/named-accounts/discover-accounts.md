...
## Descubrimiento de cuentas CRM {#discover-crm-accounts}

Identifique las posibles cuentas de destino desde su CRM.

>[!NOTE]
>
>Después de conectar su CRM a Marketo TAM, **Descubrimiento de cuentas CRM** mostrará todas las cuentas de CRM y la información relevante para ayudarle a elegir las cuentas con nombre adecuado. Marketo agrega información adicional sobre lo que se recibe del CRM.

**People** (En Discover CRM Accounts &amp; Discover Marketo Companies): Incluye contactos y posibles clientes. Marketo Los posibles clientes se pueden descubrir utilizando el [coincidencia de cliente potencial con cuenta](/help/marketo/product-docs/target-account-management/target/named-accounts/lead-to-account-matching.md).

**Personas potenciales** (En Discover CRM Accounts &amp; Discover Marketo Companies): Muestra cuántos posibles clientes Marketo encontró que podrían pertenecer a una cuenta CRM.

**Campo personalizado de CRM** (Solo en Discover cuentas CRM): Esto le ayudará a alinear su organización de ventas y marketing para la selección de cuentas de destino correctas. Una vez que [asignar el campo personalizado CRM](/help/marketo/product-docs/target-account-management/setup-tam/create-a-custom-field-for-crm-discovery.md) con Marketo TAM, le mostraremos los datos asignados para ayudarle a identificar sus cuentas de destino.

1. En Cuentas con nombre, haga clic en **Nuevo** y seleccione. **Descubrimiento de cuentas CRM**.

   ![](assets/disc-crm-one.png)

1. Se abrirá una nueva ventana/pestaña. Seleccione las cuentas de CRM que desee añadir a sus cuentas con nombre y haga clic en **Siguiente**.
...
## Descubre compañías de Marketo {#discover-marketo-companies}
...
1. En Cuentas con nombre, haga clic en **Nuevo** y seleccione. **Descubre compañías de Marketo**.

   ![](assets/one-1.png)

1. Se abrirá una nueva ventana/pestaña. Seleccione las empresas que desea agregar a sus cuentas con nombre y haga clic en **Siguiente**.
   ...
   >
   >Entrada **Discover CRM** solo, Marketo automáticamente:
   >
   >* Sincroniza y asocia los contactos de CRM con la cuenta con nombre
   >
   >Entrada **Descubre compañías de Marketo** solo, Marketo automáticamente:
   >
   ...
   >
   >Si desea que Marketo anule la duplicación de cuentas por ID de CRM o Propietario de cuenta en lugar de por Nombre de empresa, póngase en contacto con [Asistencia de Marketo](https://nation.marketo.com/t5/Support/ct-p/Support).
...
1. Para seleccionar una cuenta existente, haga clic en **Cuenta con nombre** , elija la cuenta que desee y haga clic en **Siguiente**.
   ...
   ...y verá su nueva Cuenta con Nombre. En ese punto, simplemente haga clic en **Siguiente** como en el paso 4.
