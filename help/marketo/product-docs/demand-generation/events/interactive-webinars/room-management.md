---
description: Obtenga información sobre la administración de salas para seminarios web interactivos. Cree y administre salas de seminarios web y controle el acceso y la configuración.
