...
* **Seminario web recurrente**- Mantenga sin marcar.
...
>[!TIP]
>
>Hay campos adicionales que puede configurar en Zoom que NO afectarán a la integración. Consulte la [Centro de ayuda del seminario web de zoom](https://support.zoom.us/hc/en-us/sections/200324965-Video-Webinar) para obtener información adicional sobre estos campos.
...
1. Choose **Zoom** de la variable **Evento** **Socio** Lista.
...
1. Haga clic en **Guardar**.
   ...
   Las personas que se registren en el seminario web se enviarán al proveedor de seminarios web a través de **Cambiar estado del programa** paso de flujo cuando el nuevo estado está establecido en &quot;Registrado&quot;. Ningún otro estado empuja a la persona. Además, asegúrese de asegurarse **Cambiar estado del programa** paso de flujo n.º 1 y **Enviar correo electrónico** paso de flujo n.º 2.
