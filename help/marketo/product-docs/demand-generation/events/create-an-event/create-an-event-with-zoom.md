...
description: Obtenga información sobre cómo crear un evento con Zoom en Marketo. Configure la integración de Zoom y sincronice reuniones o seminarios web con su programa de eventos.
