...
1. Seleccione el [!UICONTROL Rol exclusivo de API ON24 (todos los espacios de trabajo)] que acaba de crear. Seleccione la casilla **[!UICONTROL Solo API]**. Haga clic en **[!UICONTROL Next]**.
