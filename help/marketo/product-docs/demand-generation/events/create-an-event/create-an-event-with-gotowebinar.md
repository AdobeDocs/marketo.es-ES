...
>[!TIP]
>
>Si necesita ayuda adicional de [!DNL GoToWebinar], consulte su [Sitio de ayuda](https://support.logmeininc.com/gotowebinar).
...
1. Ahora **[!DNL GoToWebinar]** sincroniza y programa el evento.
