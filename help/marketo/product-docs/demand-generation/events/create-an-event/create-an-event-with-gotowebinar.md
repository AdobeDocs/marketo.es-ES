...
>[!PREREQUISITES]
>
>* [Añadir el seminario web de GoTo como servicio de LaunchPoint](/help/marketo/product-docs/administration/additional-integrations/add-gotowebinar-as-a-launchpoint-service.md)
...
Introduzca la siguiente información para el seminario web y se incorporará a Marketo mediante el adaptador. Si realiza cambios en esta información, debe hacer clic en el enlace &quot;**Actualizar del proveedor de seminarios web**&quot; en **Acciones de evento**, para que Marketo vea los cambios.
...
>[!TIP]
>
>Si necesita ayuda adicional con el seminario web de GoTo, visite su [Sitio de ayuda](https://support.logmeininc.com/gotowebinar).
...
1. Elegir **Seminario web de GoTo** desde el **Socio de evento** Lista.
...
1. ¡Excelente! Ahora sincroniza y programa el evento **Seminario web de GoTo**.
