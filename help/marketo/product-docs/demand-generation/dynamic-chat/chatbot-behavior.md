...
<table>
  <tbody>
    ...
    <tr>
      <td>D1, D2, D3, etc.</td>
      <td>Representa varios cuadros de diálogo donde D1 es el cuadro de diálogo 1</td>
    </tr>
    <tr>
      <td>P1, P2, P3, etc.</td>
...
<table>
  <tr>
    ...
    <tr>
      <td>
        <p>D1 dirigido únicamente a WP1</p>
        <p>Visitas V1 WP1</p>
      </td>
      <td>
    ...
    <tr>
      <td>
        <p>D1, destinado únicamente a WP1, WP2</p>
        <p>V1 visita el WP1 por primera vez</p>
        <p>V1 hace clic en D1 pero no respondió </p>
        <p>Visitas V1 WP2</p>
      </td>
    ...
    <tr>
      ...
      <td>D1 debe resolverse en el WP1<br/>D2 debe resolverse en el WP2</td>
      <td>
        <p>El recuento de déclencheur para D1 debe aumentarse en 1 </p>
    ...
    <tr>
      ...
      <td>
        <p>El déclencheur, la participación y el recuento finalizado para D1 deberían aumentarse en 1 </p>
        <p>El recuento de déclencheur para D2 debe incrementarse en 1 </p>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <p>D1 debe resolverse por primera vez en V1</p>
    ...
    <tr>
      ...
      <td>
        <p>El déclencheur, contratado y completado para D1 debe aumentarse en 1 </p>
    ...
    <tr>
      ...
      <td>El recuento de déclencheur para D1 debe aumentarse en 1 solo después de 30 segundos de tiempo empleado</td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      <td>
        <p>D1 destinado a WP1 con un déclencheur de "% de desplazamiento" del 50% </p>
        <p>Visitas V1 WP1</p>
      </td>
      <td>
        <p>D1 debe resolverse, pero no se activará en V1 </p>
    ...
    <tr>
      <td>
        ...
        <p>D2 dirigido para WP1 con 2 prioridad y evento "desplazamiento de página %" del 50 %</p>
