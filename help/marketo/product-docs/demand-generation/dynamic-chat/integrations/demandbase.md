---
description: Aprenda a utilizar los atributos de persona de Demandbase en Dynamic Chat para la segmentación y el enrutamiento de diálogos. Obtenga la clave de API y habilite la integración.
title: Demandbase
