...
>[!PREREQUISITES]
>
>Compruebe que se hayan concedido a sus agentes los [permisos](/help/marketo/product-docs/demand-generation/dynamic-chat/setup-and-configuration/permissions.md){target="_blank"} adecuados.
