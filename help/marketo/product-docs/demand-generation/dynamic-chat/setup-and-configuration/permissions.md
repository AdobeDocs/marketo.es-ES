---
description: Obtenga información acerca de los permisos de Dynamic Chat y los perfiles de producto en Admin Console. Edite perfiles existentes o cree perfiles personalizados con permisos específicos.
title: Permisos
