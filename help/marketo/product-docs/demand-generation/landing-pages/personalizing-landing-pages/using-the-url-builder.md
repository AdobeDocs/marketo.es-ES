...
1. Seleccione una página de aterrizaje, haga clic en **Acciones de página de aterrizaje**, pase el ratón sobre **Herramientas de URL** y, a continuación, haga clic en **Generador de URL**.

   ![](assets/image2014-9-18-13-3a5-3a19.png)

1. Seleccione los campos que desee usar, introduzca el valor y haga clic en **Actualizar URL**.
