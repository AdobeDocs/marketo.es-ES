...
1. Seleccione su lista o lista inteligente, haga clic en la ficha **Posibles clientes** para obtener los resultados y, a continuación, haga clic en el icono de Excel. EN LÍNEA Asegúrese de que tiene **Código único de Marketo** y **Nombre único de Marketo** [columnas visibles](/help/marketo/product-docs/core-marketo-concepts/smart-lists-and-static-lists/using-smart-lists/create-and-change-views-for-lists-and-smart-list.md).
