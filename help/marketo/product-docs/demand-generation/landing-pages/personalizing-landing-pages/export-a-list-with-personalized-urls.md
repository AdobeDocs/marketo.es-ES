...
1. Seleccione la lista o la lista inteligente y haga clic en **Posibles clientes** para obtener los resultados y luego haga clic en el icono de excel. INLINE Asegúrese de que dispone de **Código único de Marketo** y **Nombre exclusivo de Marketo** [columnas visibles](/help/marketo/product-docs/core-marketo-concepts/smart-lists-and-static-lists/using-smart-lists/create-and-change-views-for-lists-and-smart-list.md).

   ![](assets/image2014-9-25-11-3a10-3a43.png)

1. Marque **Incluir URL personalizada**, busque y seleccione la página de aterrizaje para la que desee generar PURL.
...
1. Elija una **Estilo** y haga clic en **Exportar**.

   ![](assets/image2014-9-18-13-3a37-3a6.png)

1. Cuando finalice la exportación, haga clic en **Descargar ahora** para guardar el archivo.
