...
title: Uso de contenido dinámico en una página de aterrizaje de forma libre
...
# Uso de contenido dinámico en una página de aterrizaje de forma libre {#use-dynamic-content-in-a-free-form-landing-page}
...
1. Su segmentación y sus segmentos aparecen en Dynamic, a la derecha.
...
1. Arrastre y suelte los elementos de contenido dinámico desde debajo de **Estático** hasta **Dinámico**.

   ![](assets/image2014-9-17-12-3a10-3a8.png)

1. También puede crear elementos **Estático** o **Dinámico** desde el elemento **Configuración**.
