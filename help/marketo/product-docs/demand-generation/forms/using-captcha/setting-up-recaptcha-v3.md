---
description: Obtenga información sobre cómo configurar reCAPTCHA v3 para formularios Marketo. Configure reCAPTCHA invisible para combatir el correo no deseado sin bloquear usuarios.
