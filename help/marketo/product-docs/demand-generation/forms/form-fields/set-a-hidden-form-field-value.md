...
description: Obtenga información sobre cómo establecer un valor de campo de formulario oculto en Marketo. Pase valores estáticos o de token con el envío del formulario.
