...
# Cambiar el idioma de los mensajes de error/validación del formulario y el botón Enviar {#change-the-language-of-form-validation-error-messages-and-submit-button}
...
¡Y voila! Los mensajes de error y validación del formulario se mostrarán ahora en el idioma que prefiera.