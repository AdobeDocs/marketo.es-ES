...
1. Busque y seleccione la campaña [!DNL Salesforce] a la que desee agregar los posibles clientes.
   ...
   >
   > 1. Compruebe que la sincronización de [campaña esté habilitada](/help/marketo/product-docs/crm-sync/salesforce-sync/setup/optional-steps/enable-disable-campaign-sync.md){target="_blank"}.
