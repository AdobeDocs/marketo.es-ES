...
1. Seleccione la campaña inteligente y haga clic en **[!UICONTROL Flujo]**.
...
¡Increíble! Asegúrese de [revisar y validar la campaña inteligente](/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/creating-a-smart-campaign/smart-campaign-checklist.md){target="_blank"} antes de programarlo o activarlo.
