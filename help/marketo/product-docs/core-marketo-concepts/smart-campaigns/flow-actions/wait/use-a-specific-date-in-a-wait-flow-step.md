...
description: 'Usar una fecha específica en un paso de flujo de espera: Documentos de Marketo: documentación del producto'
...
Puede usar la variable **Espera** paso de flujo para pausar el recorrido de una persona a través de una campaña inteligente hasta una fecha determinada.
...
1. En el **Tipo** desplegable, seleccione **Fecha**.
