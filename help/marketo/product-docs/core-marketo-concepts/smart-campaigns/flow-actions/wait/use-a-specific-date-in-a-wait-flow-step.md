...
Puede usar el complemento **Esperar** paso de flujo para pausar el recorrido de una persona a través de una campaña inteligente hasta una fecha determinada.
...
1. Desde el **Tipo** menú desplegable, seleccione **Fecha**.
