...
description: Obtenga información sobre cómo eliminar personas del flujo con el paso Eliminar del flujo. Detener el procesamiento posterior de las personas seleccionadas.
