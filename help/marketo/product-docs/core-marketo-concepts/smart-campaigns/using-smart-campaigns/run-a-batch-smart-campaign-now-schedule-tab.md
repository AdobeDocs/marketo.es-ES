...
1. Seleccione la campaña por lotes y vaya a **[!UICONTROL Programación]** y haga clic en **[!UICONTROL Ejecutar una vez]**.

   ![](assets/run-a-batch-smart-campaign-now-schedule-tab-1.png)

1. Asegúrese de **[!UICONTROL Ejecutar ahora]** y haga clic en **[!UICONTROL Ejecutar]**.
...
1. Confirme haciendo clic en **[!UICONTROL Ejecutar]** una vez más.
   ...
   ¡Tranquilo! También puede [programación se ejecuta para más tarde](/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/using-smart-campaigns/schedule-a-batch-smart-campaign-to-run-later.md){target="_blank"} si lo prefiere.
