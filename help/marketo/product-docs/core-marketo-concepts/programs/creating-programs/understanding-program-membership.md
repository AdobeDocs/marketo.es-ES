...
description: Obtenga información acerca de la pertenencia a programas y cómo entran las personas en los programas. Comprenda el estado y el éxito de los miembros del programa.
...
# Explicación del abono al programa {#understanding-program-membership}
...
Cuando un nuevo nombre entra en el sistema como miembro de un programa, Marketo establece automáticamente ese programa como &quot;adquisición&quot;.
