...
Este es un ejemplo de programa de eventos con una página de registro, tres correos electrónicos de invitación y correos electrónicos de seguimiento que utilizan un programa de eventos para Marketo Engage. Adecuado para todos los eventos en los que se requieren registros, incluidos espectáculos itinerantes, almuerzos, cenas o presentaciones en eventos de ferias comerciales. Utilice la aplicación Eventos del Marketo Engage para el registro y el seguimiento de asistencia en su iPad.
...
>[!NOTE]
>
>Antes del evento, descargue la información de registro en su iPad. A continuación, registre a los visitantes y sincronice la información de asistencia con el Marketo Engage. Si no tiene una tablet, puede hacer lo siguiente [importar asistentes](/help/marketo/product-docs/core-marketo-concepts/programs/working-with-programs/import-members-from-a-spreadsheet-into-a-program.md){target="_blank"} después, en la pestaña &quot;Miembros&quot; del programa, antes de enviar los correos electrónicos de seguimiento.
