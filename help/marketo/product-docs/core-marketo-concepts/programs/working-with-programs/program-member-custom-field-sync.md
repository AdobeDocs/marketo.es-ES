---
description: Obtenga información acerca de la sincronización de campos personalizados de miembros de programa con Salesforce. Mantenga los datos de los miembros personalizados sincronizados con su CRM.
