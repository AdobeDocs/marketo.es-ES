---
description: TBD.
title: Información general sobre Halo
...
Creación y generación de campañas de correo electrónico

Las secciones marcadas [PARA KEITH:] necesitan que se rellene más contenido específico del producto.\
Los marcadores de posición de captura de pantalla utilizan [SCREENSHOT: description]: extraiga las capturas de pantalla que ya se encuentran en el borrador de origen o capture las nuevas del entorno de prueba.

También tenga en cuenta Keith, he utilizado &quot;Halo&quot; como marcador de posición, pero este nombre cambiará según la decisión del liderazgo.

Forma

[PARA KEITH: Introducción de 1-2 oraciones que genera confianza y orienta al lector. Marco sugerido: &quot;Al final de esta guía, habrá creado y revisado su primera campaña de correo electrónico completa en Halo. De principio a fin, se tarda aproximadamente [ESTIMACIÓN TEMPORAL].&quot;]
...
Una cuenta activa de Halo (regístrese aquí si aún no lo ha hecho).

Su marca se configura en Sus cosas > Marcas. (Más información)

(Opcional, pero recomendada) Una plantilla de correo electrónico de HTML cargada en Sus cosas > Plantillas de correo electrónico.

Un CSV de audiencia listo para cargar. (Descargue un CSV de audiencia de ejemplo si necesita un punto de partida).
...
Marco de trabajo de coestrella
...
Elija una plantilla de campaña preconvertida de la sección templates debajo de la barra de mensajes.

Utilice una opción &quot;ayuda para preguntar&quot; en la lista desplegable de la barra de mensajes para que Halo le guíe a través de la escritura del mensaje.
...
Un indicador de Halo fuerte incluye:
...
El formato y la estructura: número de correos electrónicos, cadencia, tono.
...
[PARA KEITH: Introducción a la carga de CSV. Portada: - Donde está el botón de carga en la interfaz de usuario. : columnas requeridas y expectativas de formato. - Campos de personalización que Halo puede utilizar (nombre, fecha de último pedido, categoría del producto, etc.). - Vínculo a CSV de ejemplo. - ¿Qué sucede si los datos son confusos o faltan campos.]

[CAPTURA DE PANTALLA: flujo de carga de CSV]

Sugerencia: Excluya los contactos que no desee enviar por correo electrónico (usuarios sin suscribirse, direcciones internas, cuentas de prueba) antes de cargar. Aunque habilitaremos progresivamente la funcionalidad para &quot;excluir&quot; usuarios específicos o &quot;añadir atributos&quot; durante el transcurso de la prueba, no está disponible inmediatamente desde la fecha de lanzamiento.
...
Pulse &quot;Generar campaña&quot;. Halo hará:

Generación de un plan de campaña estructurado
...
Construir dinámicamente el recorrido a lo largo del camino
...
Aquí es donde la interfaz conversacional de Halo se gana la vida. Para hacer cambios, habla con Halo:
...
&quot;Cambiar la espera de 3 días a 5 días&quot;
...
Inicie la campaña. (No disponible actualmente con nuestra versión, pero se habilitará en un plazo de 2 semanas desde nuestra primera versión, pendiente de aprobación legal)
...
[FOR KEITH: detalles de cada opción y cualquier comprobación previa al lanzamiento que ejecute Halo (cumplimiento, vínculos rotos, campos de personalización que faltan, etc.).]
...
Casos de uso de nuestra colección: examine ejemplos de mensajes rápidos reales para mezclarlos con sus propias campañas.

Introducción a Halo: Volver a la descripción general.

Prompt Halo: prácticas recomendadas (próximamente)
