...
1. Seleccione una entrada y haga clic en **[!UICONTROL Mostrar enfoque del programa]**.
...
1. Observe que ahora estamos centrados en nuestro programa llamado &quot;Comunicado de prensa&quot;.
   ...
   >[!NOTE]
   >
   >Centrarse en un programa le permite interactuar únicamente con las entradas que le pertenecen y crear nuevas entradas que albergará.

1. Una vez finalizado, libere el enfoque para interactuar con otros programas o entradas.
