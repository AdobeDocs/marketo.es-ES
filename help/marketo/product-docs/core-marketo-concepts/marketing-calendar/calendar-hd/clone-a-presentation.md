...
description: Obtenga información sobre cómo clonar una presentación del calendario de marketing para reutilizarla. Cree una copia exacta para utilizarla en diferentes lugares.
...
1. Escriba un nombre para la presentación clonada y haga clic en **[!UICONTROL Clonar]**.
   ...
   Ya existe una copia exacta de la presentación.
