---
description: Obtenga información acerca de los filtros predictivos para segmentar audiencias con IA. Utilice filtros en listas inteligentes y campañas para llegar a las personas adecuadas.
