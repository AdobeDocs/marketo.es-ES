...
Una vez que haya [creó una lista inteligente](/help/marketo/product-docs/core-marketo-concepts/smart-lists-and-static-lists/creating-a-smart-list/create-a-smart-list.md), debe añadir y [definir](/help/marketo/product-docs/core-marketo-concepts/smart-lists-and-static-lists/creating-a-smart-list/define-smart-list-filters.md) filtros. A continuación, se indica cómo buscar y agregar filtros.
...
1. Seleccione la lista inteligente a la que desee añadir filtros y haga clic en **Lista inteligente** pestaña.

   ![](assets/two.png)

1. Busque y arrastre el **Estado** filtre en el lienzo.

   ![](assets/three.png)

1. También busque y arrastre el **Puntuación** filtre por encima.
