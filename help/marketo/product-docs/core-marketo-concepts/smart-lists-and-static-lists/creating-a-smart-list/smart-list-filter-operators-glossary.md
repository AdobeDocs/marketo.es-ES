...
| después del | Fecha única | Todos los registros posteriores a la fecha especificada |
| antes del | Fecha única | Todos los registros anteriores al especificado |
| el o después del | Fecha única | Igual que &quot;después&quot;, pero inclusivo |
...
>[!NOTE]
>
>&quot;En el pasado&quot; _hace_ incluya el día (hasta la hora, no después) en que crea la lista inteligente.

>[!CAUTION]
>
>Cuando crea una lista inteligente utilizando un filtro de campo de fecha (por ejemplo, Fecha de nacimiento, Fecha de creación de SFDC) y utiliza las restricciones **[!UICONTROL antes]**, **[!UICONTROL el o antes]**, o **[!UICONTROL en el pasado antes]**, la lista inteligente también incluirá a las personas que no tengan ningún valor en dicho campo de fecha.
...
| no es | Cualquier cosa excepto coincidencia exacta |
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colspan="1" rowspan="1">inferior a</td> 
