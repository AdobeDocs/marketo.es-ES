---
description: Obtenga información sobre cómo insertar un segmento de Adobe Experience Platform en una lista estática de Marketo. Sincronizar segmentos de AEP en listas de Marketo.
