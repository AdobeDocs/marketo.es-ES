...
1. Paso de flujo de campaña inteligente ([Añadir a lista](/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/flow-actions/add-to-list.md), [Eliminar de la lista](/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/flow-actions/remove-from-list.md))

1. [Paso de flujo de acción única](/help/marketo/product-docs/core-marketo-concepts/smart-lists-and-static-lists/using-smart-lists/run-a-single-flow-step-from-a-smart-list.md)
...
* Una lista temporal de personas en un estado particular, que luego se eliminan mediante campañas inteligentes cuando salen de ese estado.
