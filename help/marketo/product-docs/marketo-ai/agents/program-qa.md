...
1. Seleccione el agente **Program QA**.

   ![](assets/program-qa-2.png)

   Se le dirigirá a la pantalla de inteligencia artificial conversacional.

1. Seleccione el programa que desea realizar el control de calidad en el panel derecho.
...
1. En la ventana de solicitud, escriba &quot;Programa de control de calidad&quot; y haga clic en **Enviar**.
