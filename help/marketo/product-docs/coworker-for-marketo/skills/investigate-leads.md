...
1. El compañero de trabajo de Marketo Engage obtiene el historial relevante y el registro del posible cliente.

1. Revise la explicación. Un compañero de Marketo Engage le explica por qué no se ha alcanzado el hito y, si es posible, qué cambios debe realizar para que el posible cliente cumpla los requisitos.
...
**Umbral de MQL no alcanzado**: un gerente de generación de demanda observa un posible cliente que las ventas señalaron como interesado, pero que nunca llegó a MQL. Preguntan: &quot;¿Por qué `david.chen@techcorp.com` no llegó a MQL?&quot; Compañero de Marketo Engage encuentra que la puntuación de comportamiento del posible cliente es de 42 (8 puntos por debajo del umbral de MQL de 50) y enumera las actividades de puntuación que contribuyeron. Pueden ver exactamente qué comportamientos empujarían al posible cliente por encima del umbral.

**Omisión de campaña debido a supresión**: un administrador de campaña pregunta por qué un contacto específico no recibió un correo electrónico de invitación que se envió al resto de la lista. El compañero de Marketo Engage ve que el contacto está en la lista de marketing suspendido, lo que los excluye automáticamente de todos los envíos de campañas. El gerente se dirige a ellos directamente para investigar por qué fueron suprimidos.

**Error de calificación del programa**: un especialista en operaciones de marketing está solucionando el problema de por qué un posible cliente que asistió a un seminario web no se agregó al programa de seguimiento posterior al evento. El compañero de Marketo Engage rastrea el problema: el posible cliente se registró, pero se marcó como &quot;No mostrar&quot; en el programa de eventos y el filtro de campaña de seguimiento requiere el estado &quot;Asistido&quot;. El estado se estableció incorrectamente en la integración.
...
* Si el historial de actividades de un posible cliente es muy largo, Coworker for Marketo Engage se centra en los eventos más recientes y relevantes relacionados con su pregunta.
