...
Obtenga información sobre cómo exportar los datos de problemas de páginas a un archivo CSV si tiene pensado compartir esa información con personas fuera de Marketo.
...
1. Haga clic en la página cuyos detalles desee ver.

   ![](assets/seo-export-issues-to-csv-2.png)

   Aparecerá la opción Explorar en profundidad los detalles de la página. **[!UICONTROL Resultados de optimización de página]** es una lista de todos los problemas con esa página en particular.
