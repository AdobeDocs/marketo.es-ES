...
Puede exportar los datos del problema de página a un archivo CSV si desea compartir esa información con personas fuera de Marketo. Así es cómo se hace.
...
1. Haga clic en la página cuyos detalles desea ver.
   ...
   Este es el desglose de detalles de la página. **[!UICONTROL Resultados de optimización de página]** es una lista de todos los problemas con esa página en particular.
