...
| Palabras clave de destinatario | Las palabras clave para las que decide optimizar cada página. [Esto requiere su entrada](/help/marketo/product-docs/additional-apps/seo/pages/seo-using-the-page-detail-drill-down.md). |
...
Increíble, ahora que conoce los conceptos básicos de las páginas, consulte el [artículo Exploración detallada de detalles de la página](/help/marketo/product-docs/additional-apps/seo/pages/seo-using-the-page-detail-drill-down.md) para obtener más información sobre las cosas interesantes que puede hacer.
