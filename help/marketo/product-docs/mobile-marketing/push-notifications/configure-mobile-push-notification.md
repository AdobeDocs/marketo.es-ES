...
Los URI de redireccionamiento configurados en los mensajes de notificaciones push admiten tokens de Marketo en ellos. Solo se aplica a los &quot;URI de la aplicación de Launch&quot;.

Formato de muestra:

* Formato de aplicación existente:
  `com.onboardmd://financing?FirstName={{lead.First Name}}&City={{lead.City}}`

* Formato con valores de reserva:
