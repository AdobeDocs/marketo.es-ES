...
description: Aprenda a añadir un nuevo dispositivo de prueba para las notificaciones push. Utilice una URL o un código QR para conectar el dispositivo y enviar mensajes push de prueba.
