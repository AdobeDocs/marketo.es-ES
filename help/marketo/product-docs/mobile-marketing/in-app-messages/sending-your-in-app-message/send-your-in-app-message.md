...
title: Envío De Un Mensaje En La Aplicación
...
1. Seleccione el tipo de programa en la aplicación de la lista desplegable y haga clic en **Crear**.
...
1. Utilice el Panel de control de Campaign para definir el quién, el qué y el cuándo del mensaje en la aplicación y, cuando haya terminado, apruébelo. Hay un artículo separado para cada paso.
