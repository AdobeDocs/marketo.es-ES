---
description: Obtenga información acerca de los iconos de la experiencia de usuario moderna de Marketo Engage y cómo se asignan desde Classic. Utilice este glosario para identificar tipos de recursos, estados de campañas y tipos de programas.
...
A continuación se muestran los iconos de la nueva interfaz de Adobe Marketo Engage. Si necesita hacer referencia a los iconos de Marketo Classic, los puede [encontrar aquí](/help/marketo/getting-started/things-to-know/classic-icon-glossary.md).
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td>Programa de correo electrónico</td>
  </tr>
  <tr>
...
## Campañas de activador {#trigger-campaigns}
