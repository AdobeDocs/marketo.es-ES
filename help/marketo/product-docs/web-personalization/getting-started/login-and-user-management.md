...
description: Obtenga información sobre cómo iniciar sesión y administrar usuarios en Marketo Engage mediante el inicio de sesión y la administración de usuarios. Utilice esta guía para completar el siguiente paso.
...
1. Escriba un [!UICONTROL Nombre de rol] y seleccione [!UICONTROL Permisos]. Haga clic en **[!UICONTROL Crear]** (esta función debe [aplicarse a todos los espacios de trabajo](/help/marketo/product-docs/administration/users-and-roles/edit-user-workspaces.md)).
