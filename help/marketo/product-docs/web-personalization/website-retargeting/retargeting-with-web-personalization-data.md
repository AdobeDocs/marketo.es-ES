...
description: Obtenga información acerca del retargeting con datos de personalización web en Marketo Engage, incluido el retargeting con dnl web. Utilice esta guía para completar el siguiente paso.
