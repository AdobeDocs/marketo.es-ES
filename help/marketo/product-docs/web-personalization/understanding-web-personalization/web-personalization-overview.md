...
# Información general de la personalización web {#web-personalization-overview}
...
La pestaña Organizaciones muestra todos los detalles (nombre, ubicación, actividad y marca de tiempo) de las organizaciones que visitaron el sitio web durante un periodo determinado. La tabla se puede ordenar y organizar por tiempo, ubicación, dominio y mediante una búsqueda de texto libre.

![](assets/image2014-11-10-19-3a23-3a18.png)

>[!TIP]
>
>&quot;Más activo&quot; vs. &quot;Más reciente&quot;: la tabla está organizada por organizaciones identificadas y, a continuación, por proveedores de servicios de Internet (indicados por un icono de ISP). Se puede ordenar según lo siguiente:
>
>* Más activos: las organizaciones más activas de la tabla, según el número de vistas de página
>* Última: las organizaciones más recientes de la tabla (valor predeterminado)
>* Para obtener información valiosa, filtre según los recursos más activos
...
<table>
 ...
 <tbody>
  <tr>
   ...
   <td colspan="1" rowspan="1">Situado en la parte superior derecha del panel, el icono descarga la tabla Visitantes en formato CSV para su uso sin conexión</td>
  </tr>
  <tr>
   <td colspan="1" rowspan="1"><p><strong>Nombre de organización</strong></p></td>
   <td colspan="1" rowspan="1"> </td>
  </tr>
  <tr>
   <td colspan="1" rowspan="1"><strong>Definir campaña</strong></td>
   <td colspan="1" rowspan="1">Permite configurar una CTA de Campaign asociada al visitante seleccionado</td>
  </tr>
  <tr>
   <td colspan="1"><strong>Ubicación</strong></td>
   <td colspan="1">Muestra el país, estado y ciudad del visitante</td>
  </tr>
  <tr>
...
La página Tiempo real muestra los visitantes del sitio web en tiempo real y mide la actividad a medida que se produce.

![](assets/image2014-11-10-19-3a49-3a55.png)

La página Tiempo real se divide en 6 tablas informativas con detalles de visitantes en el sitio:
