...
Web Personalization tiene varios informes útiles que se envían por correo electrónico. A continuación se indica cómo suscribirse a ellos.

1. Inicie sesión en Web Personalization. En su nombre de inicio de sesión, haga clic en **Configuración de usuario**.
...
1. Seleccione el informe al que desee suscribirse y su frecuencia. Haga clic en **Guardar**.
   ...
   ¡Eso es todo! Para cancelar la suscripción al informe, simplemente desmarca y haz clic en **Guardar**.
