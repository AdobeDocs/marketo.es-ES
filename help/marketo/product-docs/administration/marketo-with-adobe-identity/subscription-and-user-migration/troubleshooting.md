---
description: Guía de solución de problemas para errores de migración de usuarios de IMS, como caracteres no válidos de Gmail, usuarios que no están en el directorio, usuarios inactivos y dominios no válidos, con pasos de resolución.
