...
Agregar y eliminar usuarios. Completado por el administrador de productos (o el sistema)
Admin).
...
[Preguntas más frecuentes](/help/marketo/product-docs/administration/marketo-with-adobe-identity/faq.md){target="_blank"}
