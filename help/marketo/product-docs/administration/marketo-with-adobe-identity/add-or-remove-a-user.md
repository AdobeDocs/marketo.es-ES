...
# Añadir o quitar un usuario {#add-or-remove-a-user}
...
1. Haga clic en el icono **+** y seleccione el perfil de producto deseado.
   ...
   >[!IMPORTANT]
   >
   >Se debe _añadir un usuario_ a un perfil de producto para obtener acceso a Marketo Engage.

1. Haga clic en **[!UICONTROL Guardar]**.

   ![](assets/add-or-remove-a-user-8.png)

El usuario recibirá un correo electrónico para iniciar sesión en Marketo Engage.
