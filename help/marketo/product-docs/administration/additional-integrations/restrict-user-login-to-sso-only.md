...
Ahora todos los usuarios (excepto los usuarios con permiso para omitir el inicio de sesión único) están restringidos a utilizar solo el inicio de sesión SSO.
