...
## Acceso a administrador  {#access-admin}
...
* Actividad de lectura-escritura
* Metadatos de actividades de lectura-escritura
* Recursos de lectura-escritura
* Campaña de lectura-escritura
* Compañía de lectura-escritura
* Objeto personalizado de lectura y escritura
* Persona de lectura-escritura
* Cuenta con nombre de lectura-escritura
* Oportunidad de lectura-escritura
* Vendedor de lectura-escritura
...
## Acceder a Calendar Presentations {#access-calendar-presentations}
...
## Acceder a Design Studio {#access-design-studio}
...
* Plantilla de correo electrónico de acceso
...
* Acceder a página de aterrizaje
...
* Plantilla de página de aterrizaje de acceso
...
* Acceso a mensaje SMS

   * Aprobar mensaje SMS
   * Eliminar mensaje SMS
   * Editar mensaje SMS

* Acceso a notificación push
