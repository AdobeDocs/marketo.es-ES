...
description: Reglas y pasos para compartir segmentaciones en espacios de trabajo y particiones, incluidos límites y sugerencias para crear segmentaciones en el espacio de trabajo predeterminado.
