...
description: Pasos para crear una nueva actividad personalizada que incluya nombre, nombre de la API, definición del déclencheur y del filtro, y campo principal.
