...
description: Obtenga información acerca de los campos administrados del sistema no editables en la página de detalles de la persona y el significado de cada tipo de campo.
