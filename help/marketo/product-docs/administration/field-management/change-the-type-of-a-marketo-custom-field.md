...
description: Cómo cambiar el tipo de datos de un campo personalizado en Administración de campos (los campos de puntuación y fórmula no se pueden cambiar).
