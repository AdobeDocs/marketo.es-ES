...
Si necesita editar la Vista &quot;[como una página web](/help/marketo/product-docs/email-marketing/general/functions-in-the-editor/add-a-view-as-web-page-link-to-an-email.md)&quot;, así es como.
...
1. Edite las versiones **Vista como HTML** y **Vista como texto de página Web** a su gusto y haga clic en **Guardar cambios**.
...
**Vista como texto de página web:**
