...
1. Edite las versiones **Cancelar la suscripción de HTML** y **Cancelar la suscripción de texto** a su gusto y haga clic en **Guardar cambios**.
   ...
   Ahí lo tienes. _¡Asegúrate de probar!_ No desea que sus correos electrónicos de marketing hayan roto los vínculos de cancelación de suscripciones.
...
>[!MORELIKETHIS]
>
>[Editar el mensaje &quot;Vista como página web&quot;](/help/marketo/product-docs/administration/email-setup/edit-the-view-as-web-page-message.md)
