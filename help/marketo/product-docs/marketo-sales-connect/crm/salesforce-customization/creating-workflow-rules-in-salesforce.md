...
description: Obtenga información sobre cómo crear reglas de flujo de trabajo en Salesforce para actividades de Sales Connect. Automatice las acciones cuando Sales Connect registre correos electrónicos o llamadas.
