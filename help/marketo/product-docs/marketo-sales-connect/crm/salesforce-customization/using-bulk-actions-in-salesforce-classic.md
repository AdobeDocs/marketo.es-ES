...
description: 'Uso de acciones masivas en Salesforce Classic: documentos de Marketo: documentación del producto'
...
>[!PREREQUISITES]
>
>Actualice a la última versión del paquete de Sales Connect e instale los botones de acción por lotes en la vista de cliente potencial/contacto. [Haga clic aquí para obtener instrucciones](https://s3.amazonaws.com/tout-user-store/salesforce/assets/Marketo+Sales+Engage+For+Salesforce_+Installation+and+Success+Guide.pdf).
...
1. En Salesforce, haga clic en la ficha **Posibles clientes** y luego en el botón **Ir**.

   ![](assets/one-5.png)

1. Elija los posibles clientes que quiera y haga clic en el botón **Correo electrónico con MSC (clásico)**.
...
1. Elija los posibles clientes que quiera y haga clic en el botón **Agregar a MSC Campaign (Classic)**.
...
1. Elija los posibles clientes que quiera y haga clic en el botón **Insertar en MSC (clásico)**.
