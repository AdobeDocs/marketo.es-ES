...
description: Obtenga información sobre cómo editar la accesibilidad de los campos de Salesforce para Sales Connect. Controle los campos que Sales Connect puede leer o escribir en Salesforce.
