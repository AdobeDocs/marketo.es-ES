...
description: Conexión de Sales Connect a su zona protegida de Salesforce - Documentos de Marketo - Documentación del producto
title: Conexión de Sales Connect a su zona protegida de Salesforce
...
# Conexión de Sales Connect a su zona protegida de Salesforce {#how-to-connect-sales-connect-to-your-salesforce-sandbox}
...
1. En la parte inferior de la página, haz clic en **Conectarse a espacio aislado**.
   ...
   >[!NOTE]
   >
   >Si ya inició sesión en su cuenta de zona protegida de Salesforce, se le redirigirá a una página de autorización en la que deberá permitir el acceso. Si aún no ha iniciado sesión, continúe con el paso 5.

1. Introduzca el nombre de usuario y la contraseña de su cuenta de zona protegida de Salesforce.
