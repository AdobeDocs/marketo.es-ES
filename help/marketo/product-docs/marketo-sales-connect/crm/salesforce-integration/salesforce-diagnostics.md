...
**Pasos de solución de problemas:** informe de cualquier caso de esto a nuestro equipo [ de ](http://nation.marketo.com/community/support_solutions)asistencia.
...
**Qué está sucediendo:** El autentificador de acceso o actualización ha caducado. Los tokens caducan según la configuración de [sesión en Salesforce](http://salesforce.stackexchange.com/questions/10759/invalid-grant-expired-access-refresh-token-error-when-authenticating-access-via).
...
**Qué está sucediendo: problema** de rendimiento con Salesforce, probablemente debido a activadores que no son óptimos en el cliente.\
**Pasos de solución de problemas:la lógica** Reintentar debe gestionar esto. Si aún no funciona, trabaje con el administrador de Salesforce para solucionar un problema de activación.
...
**Categoría:** Acceso/Validación*** ** 
**Mensaje:derechos de acceso** insuficientes en el identificador de objeto** ** 
...
**Pasos de solución de problemas:la lógica** Reintentar debe gestionar esto. Si aún no funciona, trabaje con el administrador de Salesforce para solucionar problemas con un activador problemático.
...
3 - ConcurrentRequest\
**Qué está sucediendo:**
1 - Se ha superado el límite de solicitudes simultáneas, probablemente debido a un código de activación ineficiente.\
...
**Categoría:** Acceso/Validación\
**Mensaje:** Faltan campos obligatorios:  [Amount_Commit_Private_Capital__c]\
...
**Qué está sucediendo:Problema** de rendimiento con Salesforce, probablemente debido a desencadenantes que no son óptimos por parte del cliente\
**Pasos de solución de problemas:la lógica** Reintentar debe gestionar esto. Si todavía no funciona, trabaje con el administrador de Salesforce para que le moleste disparar un activador problemático.
...
**Qué está sucediendo:** es probable que haya un activador que esté provocando varios intentos de acceso al mismo registro, posiblemente en el caso de un correo electrónico de grupo.\
**Pasos de solución de problemas:la lógica** Reintentar debe gestionar esto. Si aún no funciona, trabaje con el administrador de Salesforce para solucionar problemas con un activador problemático.
