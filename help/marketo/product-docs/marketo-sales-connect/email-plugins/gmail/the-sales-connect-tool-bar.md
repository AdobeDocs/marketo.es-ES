...
description: Obtenga información acerca de la barra de herramientas de Conexión de ventas en Gmail. Utilice la barra de herramientas de complementos para insertar plantillas, rastrear correos electrónicos e iniciar sesión en Salesforce.
...
| **[!UICONTROL Plantillas y conversaciones] botones** | Abre la página [!UICONTROL Plantillas] y la página [!UICONTROL Conversaciones] de la aplicación web [1, respectivamente. ](https://toutapp.com/login)Todo dentro de su página de Gmail. |
