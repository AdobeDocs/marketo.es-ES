---
description: Aprenda a registrar los motivos de las llamadas y los resultados de las llamadas a Salesforce desde Sales Connect. Asegúrese de que la disposición de la llamada se sincronice con los campos de Salesforce correctos.
