---
description: Comprenda los resultados de las llamadas en Sales Connect. Registrar el resultado después de cada llamada para sincronizar la actividad y la disposición con Salesforce.
