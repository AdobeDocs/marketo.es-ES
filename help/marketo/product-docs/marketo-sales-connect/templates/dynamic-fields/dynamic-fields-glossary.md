...
description: Obtenga información sobre los campos dinámicos en Sales Connect. Utilice este glosario para buscar campos de combinación disponibles para plantillas y personalización.
