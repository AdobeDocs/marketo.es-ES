---
description: Descubra cómo se sincronizan las tareas de recordatorio de Sales Connect con Salesforce. Descubra el comportamiento de sincronización y dónde aparecen las tareas en Salesforce.
