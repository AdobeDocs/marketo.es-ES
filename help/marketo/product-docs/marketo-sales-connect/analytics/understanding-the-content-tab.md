...
Desplácese hacia abajo por la página para ver la sección [!UICONTROL Plantillas] que muestra todas las plantillas que su equipo ha estado utilizando (en este lapso de tiempo) con la mayor cantidad de vistas*.*
