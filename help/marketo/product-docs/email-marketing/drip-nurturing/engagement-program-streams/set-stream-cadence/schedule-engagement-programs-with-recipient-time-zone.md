...
1. En el programa de participación, vaya a la pestaña **Transmisiones** y haga clic en la programación de cadencia de una transmisión para editarla.

   ![](assets/image2017-12-5-13-3a36-3a21.png)

1. [Establece la configuración de cadencia](/help/marketo/product-docs/email-marketing/drip-nurturing/engagement-program-streams/set-stream-cadence.md) como lo harías normalmente y luego marca la casilla **Zona horaria del destinatario**. Recuerde que su primer lanzamiento debe ser al menos 25 horas en el futuro. Haga clic en **Guardar**.
