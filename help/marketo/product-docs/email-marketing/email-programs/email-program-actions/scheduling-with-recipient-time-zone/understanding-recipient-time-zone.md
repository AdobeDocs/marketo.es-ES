...
>[!NOTE]
>
>La zona horaria del destinatario funciona actualmente **only** con contenido de correo electrónico. No funcionará para los programas de participación predeterminados.

## Programas de email {#email-programs}

Hay dos escenarios principales en los que [programación de un programa de correo electrónico](/help/marketo/product-docs/email-marketing/email-programs/email-program-actions/scheduling-with-recipient-time-zone/schedule-email-programs-with-recipient-time-zone.md):
...
En casos en los que **only** País o **only** Estado disponible:
...
Si todavía no podemos determinar la zona horaria de alguien desde ninguna combinación de estos campos, **not** asigne un huso horario y el correo electrónico se enviará en función del huso horario de suscripción a Marketo. Por lo tanto, si el programa está programado para las 9:00 de la mañana PDT, las personas sin zona horaria asignada recibirán el correo electrónico a las 9:00 (PDT).
