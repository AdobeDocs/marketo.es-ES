...
description: Obtenga información acerca de la programación de zonas horarias de destinatarios para programas de correo electrónico. Enviar correos electrónicos a la misma hora local para cada destinatario.
