...
1. Las opciones predeterminadas **Criterios de ganador** se muestran primero.
   ...
   <tr>
   <td><b>Hacer clic para abrir %</b></td>
...
1. Elija una de las dos opciones disponibles.
   ...
   >[!NOTE]
   >
   >Si estás haciendo una prueba A/B de **Fecha/Hora**, solo puedes elegir **Manual**.
...
1. Automático es impresionante y es la opción predeterminada. Simplemente haga clic en **Siguiente**.

   ![](assets/image2014-9-12-15-3a54-3a35.png)

   >[!TIP]
   >
   >Si eliges **Manual**, se enviará la prueba y esperarás a que declares un ganador. Recibirá un informe de los resultados.
