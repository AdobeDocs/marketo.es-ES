...
description: Obtenga información sobre las diferencias entre las funciones del Editor de correo electrónico 2.0 y el nuevo Designer de correo electrónico. Utilice la tabla para comparar la disponibilidad de las capacidades.
...
<tbody>
  ...
  <tr>
    ...
    <td>Capacidad para generar la línea de asunto, parte del contenido o correo electrónico completo mediante <a href="/help/marketo/product-docs/email-marketing/email-designer/generate-content.md" target="_blank">IA generativa</a> modelos.</td>
    <td>No disponible</td>
    <td>Disponible</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Capacidad para clonar recursos en un programa.</td>
    <td>Disponible</td>
    <td>Disponible</td>
  </tr>
  <tr>
  ...
  <tr>
    <td>Temáticas sobre la marca</td>
    <td>Capacidad para <a href="/help/marketo/product-docs/email-marketing/email-designer/brands/brand-themes.md" target="_blank">aplicar temas aprobados</a> en toda la organización para garantizar la coherencia en elementos como estilo, color, tamaño de fuente, etc.</td>
    <td>No disponible</td>
    <td>Disponible</td>
  </tr>
  <tr>
