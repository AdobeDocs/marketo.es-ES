...
Para tener acceso a los fragmentos visuales, vaya a **Design Studio**. En el árbol de la izquierda, haga clic en **[!UICONTROL Fragmentos (nuevos)]**.

![Fragmentos de acceso](assets/fragments-1.png){width="600" zoomable="yes"}
