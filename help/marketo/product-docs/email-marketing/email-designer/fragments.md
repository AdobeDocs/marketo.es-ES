...
product: marketo
title: Fragmentos
description: Aprenda a crear y utilizar fragmentos como componentes de correo electrónico reutilizables. Agregue fragmentos de contenido visual a los correos electrónicos y las plantillas.
...
1. Si desea actualizar el contenido, haga clic en **[!UICONTROL Crear versión de borrador]** en la parte superior derecha.
   ...
   Haga clic en **[!UICONTROL Aceptar]** en el cuadro de diálogo para abrir la versión de borrador en el diseñador visual. Puede cambiar `image source`.
...
>[!MORELIKETHIS]
>
>[Fragmentos personalizables](/help/marketo/product-docs/email-marketing/email-designer/customizable-fragments.md)
