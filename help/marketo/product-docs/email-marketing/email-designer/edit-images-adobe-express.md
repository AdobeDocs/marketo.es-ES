...
description: Obtenga información sobre cómo editar imágenes en el Designer de correo electrónico con Adobe Express. Abra y perfeccione las imágenes sin salir de Marketo Engage.
...
1. Seleccione la imagen que desee editar.
   ...
   ![Haciendo clic en el nombre de la imagen](assets/edit-images-with-adobe-express-2a.png){width="600" zoomable="yes"}
...
1. En la ficha _Detalles_ de la imagen, haga clic en **[!UICONTROL Editar en Adobe Express]**.
   ...
   ![Haciendo clic en el botón Editar en Adobe Express](assets/edit-images-with-adobe-express-3a.png){width="600" zoomable="yes"}
