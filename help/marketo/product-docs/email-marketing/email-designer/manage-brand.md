...
description: Obtenga información sobre cómo crear y administrar directrices de marca en el correo electrónico de Designer. Configure y actualice la configuración de marca de sus correos electrónicos.
role: User
...
>[!AVAILABILITY]
>
>Debe aceptar el [acuerdo de usuario](https://www.adobe.com/legal/licenses-terms/adobe-dx-gen-ai-user-guidelines.html){target="_blank"} para poder usar el Asistente de IA en Adobe Marketo Engage. Para obtener más información, contacte con su representante de Adobe.
...
1. En la ficha **[!UICONTROL Estilo de escritura]**, haga clic en el icono **+** para agregar una directriz, excepción o exclusión.
...
1. En la ficha **[!UICONTROL Contenido visual]**, haga clic en el icono de tres puntos para agregar una directriz, una exclusión o un ejemplo.

1. Introduzca la guía, la exclusión o el ejemplo.
