...
description: Aprenda a crear, validar y administrar contenido de marca mediante el verificador de puntuación de marca.
...
>[!AVAILABILITY]
>
>Debe aceptar el [acuerdo de usuario](https://www.adobe.com/legal/licenses-terms/adobe-dx-gen-ai-user-guidelines.html){target="_blank"}{target="_blank"} para poder usar el Asistente de IA en Adobe Marketo Engage. Para obtener más información, contacte con su representante de Adobe.

## Validar el contenido con la alineación de marca {#validate-content}

Una vez [configurada y publicada](/help/marketo/product-docs/email-marketing/email-designer/brands/manage-brands.md#create-brand-kit){target="_blank"} su marca, evalúe la puntuación de alineación de marca directamente dentro de su campaña de correo electrónico para asegurarse de que el contenido se ajuste a las directrices de su marca.

1. En el correo electrónico, haga clic en el icono **[!UICONTROL Alineación de marca]**.

   Tu contenido evalúa automáticamente tu [marca predeterminada](/help/marketo/product-docs/email-marketing/email-designer/brands/manage-brands.md#default-brand){target="_blank"}.
...
1. Haz clic en el icono ![Pantalla completa para obtener información detallada](assets/icon-fullscreen.svg "Pantalla completa") para obtener una vista detallada de tu puntuación de calidad.
