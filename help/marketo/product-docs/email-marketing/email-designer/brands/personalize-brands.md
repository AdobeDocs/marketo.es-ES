...
Use la ficha **[!UICONTROL Acerca de la marca]** para establecer la identidad principal de su marca, y resaltar su propósito, personalidad, eslogan y otros atributos que la definen.
...
Ahora puedes personalizar aún más tu marca o [publicar tu marca](/help/marketo/product-docs/email-marketing/email-designer/brands/manage-brands.md#create-brand-kit).
