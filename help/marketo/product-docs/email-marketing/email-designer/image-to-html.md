...
description: Aprenda a convertir una imagen en una plantilla de correo electrónico editable de HTML. Utilice la herramienta de conversión de imagen a HTML sin código en el Designer de correo electrónico.
...
1. Desplácese hacia abajo y seleccione la casilla de verificación _el archivo cargado no contiene..._. Haga clic en **Convertir**.
...
1. Una vez completada la conversión, la plantilla se guardará automáticamente como borrador. Haga clic en su nombre para verlo o editarlo.
