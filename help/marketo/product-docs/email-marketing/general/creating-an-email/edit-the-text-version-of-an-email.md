...
>[!NOTE]
>
>No se trata de un artículo sobre la creación de un correo electrónico de solo texto. Para obtener más información, consulte [Creación de un correo electrónico de solo texto](/help/marketo/product-docs/email-marketing/general/creating-an-email/create-a-text-only-email.md).
