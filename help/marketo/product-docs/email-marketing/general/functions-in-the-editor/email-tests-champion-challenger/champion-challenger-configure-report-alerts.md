...
# Campeón/Challenger: Configurar alertas de informes {#champion-challenger-configure-report-alerts}
...
1. Compruebe que toda la información es correcta y haga clic en **Cerrar**.
   ...
   El informe incluirá detalles útiles, como el tipo de prueba, los criterios de ganador, la cantidad de correos electrónicos abiertos, etc. También habrá un enlace directo a la prueba en sí, lo que le permite declarar el ganador! Cosas geniales.
