...
description: Aprenda a añadir un token de script de correo electrónico al correo electrónico. Inserte contenido dinámico mediante tokens en el editor de correo electrónico.
...
1. Busque y seleccione el correo electrónico al que desee agregar el token y haga clic en **[!UICONTROL Editar borrador]**.
...
1. Busque y seleccione el token de script de correo electrónico que creó anteriormente y haga clic en **[!UICONTROL Insertar]**.
...
Cuando se envíe este correo electrónico, el script detrás del token se ejecutará y rellenará el contenido.
