...
Después de que... [creó su script de correo electrónico](/help/marketo/product-docs/email-marketing/general/using-tokens/create-an-email-script-token.md), querrá añadirlo a un correo electrónico para verlo en acción. Así es como.
...
1. Busque y seleccione el correo electrónico al que desee añadir el token y haga clic en **Editar borrador**.
...
>[!NOTE]
>
>No te olvides de [aprobar el correo electrónico](/help/marketo/product-docs/email-marketing/general/creating-an-email/approve-an-email.md).
