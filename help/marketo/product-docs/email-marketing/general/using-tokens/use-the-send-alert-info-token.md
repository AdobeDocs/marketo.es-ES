...
description: Aprenda a utilizar el token Enviar información de alerta en los correos electrónicos. Inserte dinámicamente detalles de envío, como la hora y el nombre del programa.
