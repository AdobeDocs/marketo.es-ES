...
Después de esta configuración inicial, revise nuestra [Prácticas recomendadas para una nueva instancia de Marketo Engage](/help/marketo/temp-getting-started-section/temp-best-practice-checklists/where-to-start.md) para aprovechar al máximo su inversión y prepararse para el éxito a largo plazo.
