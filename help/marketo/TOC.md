...
+ Introducción a Marketo {#getting-started-with-marketo}
   ...
   + [Centro de ayuda](getting-started/help-center.md)
   + [Glosario del Marketo Engage](getting-started/marketo-engage-glossary.md)
   ...
   + Herencia de una instancia de Marketo {#inheriting-a-marketo-instance}
      + [Nueva información general de herencia](getting-started/inheriting-a-marketo-instance/new-inherit-overview.md)
...
+ Documentos del producto {#product-docs}
   ...
   + Administration {#administration}
      ...
      + Marketo con identidad de Adobe {#marketo-with-adobe-identity}
         ...
         + [Migración a la identidad de Adobe](product-docs/administration/marketo-with-adobe-identity/migrating-to-adobe-identity.md)
   ...
   + Conceptos principales de Marketo {#core-marketo-concepts}
      ...
      + Programas {#programs}
         ...
         + Biblioteca de programas {#program-library}
            ...
            + [Programa de solicitud web WR-AAAA-MM](/help/marketo/product-docs/core-marketo-concepts/programs/program-library/wr-yyyy-mm-web-request-program.md)
            + [OA-YYYY-MM-Página de aterrizaje de Marketo de publicidad en línea](/help/marketo/product-docs/core-marketo-concepts/programs/program-library/oa-yyyy-mm-online-advertising-marketo-landing-page.md)
   ...
   + Generación de demanda {#demand-generation}
      ...
      + Dynamic Chat dos {#dynamic-chat-two}
         + [Resumen del Dynamic Chat](product-docs/demand-generation/dynamic-chat-two/dynamic-chat-overview.md)
         + [Comportamiento del bot de chat](product-docs/demand-generation/dynamic-chat-two/chatbot-behavior.md)
         + [Lista de reuniones](product-docs/demand-generation/dynamic-chat-two/meeting-list.md)
         + [Actividades del Dynamic Chat](product-docs/demand-generation/dynamic-chat-two/dynamic-chat-activities.md)
         + [Analytics](product-docs/demand-generation/dynamic-chat-two/analytics.md)
         + Chat automatizado {#automated-chat}
            + [Resumen de flujos de conversación](product-docs/demand-generation/dynamic-chat-two/automated-chat/conversational-flows-overview.md)
            + [Crear un flujo de conversación](product-docs/demand-generation/dynamic-chat-two/automated-chat/create-a-conversational-flow.md)
            + [Configuración de flujo de conversación para Marketo Engage Forms](product-docs/demand-generation/dynamic-chat-two/automated-chat/conversational-flow-settings-for-marketo-engage-forms.md)
            + [SDK de conversaciones](product-docs/demand-generation/dynamic-chat-two/automated-chat/conversations-sdk.md)
            + [Resumen del diálogo](product-docs/demand-generation/dynamic-chat-two/automated-chat/dialogue-overview.md)
            + [Crear un cuadro de diálogo](product-docs/demand-generation/dynamic-chat-two/automated-chat/create-a-dialogue.md)
            + [Criterios de audiencia](product-docs/demand-generation/dynamic-chat-two/automated-chat/audience-criteria.md)
            + [Diseñador de flujo](product-docs/demand-generation/dynamic-chat-two/automated-chat/stream-designer.md)
            + [Informes de  ](product-docs/demand-generation/dynamic-chat-two/automated-chat/reports.md)
         + Integraciones {#integrations}
            + [Adobe Marketo Engage](product-docs/demand-generation/dynamic-chat-two/integrations/adobe-marketo-engage.md)
            + [API de inserción de Adobe PDF](product-docs/demand-generation/dynamic-chat-two/integrations/adobe-pdf-embed-api.md)
         + Chat en directo {#live-chat}
            + [Información general de Live Chat](product-docs/demand-generation/dynamic-chat-two/live-chat/live-chat-overview.md)
            + [Bandeja de entrada del agente](product-docs/demand-generation/dynamic-chat-two/live-chat/agent-inbox.md)
            + [Notificaciones](product-docs/demand-generation/dynamic-chat-two/live-chat/notifications.md)
         + Instalación y configuración {#setup-and-configuration}
            + [Configuración inicial](product-docs/demand-generation/dynamic-chat-two/setup-and-configuration/initial-setup.md)
            + [Agregar o quitar usuarios de chat](product-docs/demand-generation/dynamic-chat-two/setup-and-configuration/add-or-remove-chat-users.md)
            + [Configuración](product-docs/demand-generation/dynamic-chat-two/setup-and-configuration/configuration.md)
            + [Configuración del agente](product-docs/demand-generation/dynamic-chat-two/setup-and-configuration/agent-settings.md)
            + [Administración de agentes](product-docs/demand-generation/dynamic-chat-two/setup-and-configuration/agent-management.md)
            + [Configuración de seguridad](product-docs/demand-generation/dynamic-chat-two/setup-and-configuration/security-settings.md)
            + [Enrutando](product-docs/demand-generation/dynamic-chat-two/setup-and-configuration/routing.md)
      + Dynamic Chat {#dynamic-chat}
         + [Liberar inserciones](product-docs/demand-generation/dynamic-chat/release-inserts.md)
         ...
         + Diálogos {#dialogues}
            ...
            + [Diseñador de flujo](product-docs/demand-generation/dynamic-chat/dialogues/stream-designer.md)
   ...
   + Marketo Sales Connect {#marketo-sales-connect}
      + Introducción {#getting-started}
         ...
         + Configuración del correo electrónico {#email-settings}
            + [Agregar identidad](product-docs/marketo-sales-connect/getting-started/email-settings/add-identity.md)
            ...
            + [Verifique su email](product-docs/marketo-sales-connect/getting-started/email-settings/verify-your-email.md)
      + Administración {#admin}
         ...
         + [Configuración para compartir](product-docs/marketo-sales-connect/admin/sharing-settings.md)
      ...
      + Correo electrónico {#email}
         ...
         + Cancela suscripción {#unsubscribes}
            ...
            + [Verificación de cancelación de suscripción de Marketo](product-docs/marketo-sales-connect/email/unsubscribes/marketo-unsubscribe-check.md)
   ...
   + Perspectiva de ventas de Marketo {#marketo-sales-insight}
      + Acciones {#actions}
         ...
         + Introducción {#getting-started}
            ...
            + Configuración del correo electrónico {#email-settings}
               + [Verifique su email](product-docs/marketo-sales-insight/actions/getting-started/email-settings/verify-your-email.md)
               ...
               + [Agregar identidad](product-docs/marketo-sales-insight/actions/getting-started/email-settings/add-identity.md)
         + Administración {#admin}
            ...
            + [Configuración para compartir](product-docs/marketo-sales-insight/actions/admin/sharing-settings.md)
         ...
         + CRM {#crm}
            ...
            + Acciones en Salesforce {#actions-in-salesforce}
               ...
               + [Uso de la campaña de adición masiva a ventas en Salesforce](product-docs/marketo-sales-insight/actions/crm/actions-in-salesforce/using-bulk-add-to-sales-campaign-in-salesforce.md)
         + Correo electrónico {#email}
            + Centro de comandos {#command-center}
            ...
            + Cancela suscripción {#unsubscribes}
               ...
               + [Verificación de cancelación de suscripción de Marketo](product-docs/marketo-sales-insight/actions/email/unsubscribes/marketo-unsubscribe-check.md)
         ...
         + Preguntas frecuentes {#faq}
            ...
            + [¿Por qué no se sincronizan mis campos de actividades y actividades de ventas con Salesforce?](product-docs/marketo-sales-insight/actions/faq/why-arent-my-sales-activities-and-activity-fields-syncing-to-salesforce.md)
         ...
         + Teléfono {#phone}
            + [Resultados de llamadas](product-docs/marketo-sales-insight/actions/phone/call-outcomes.md)
            + [Razones de llamada](product-docs/marketo-sales-insight/actions/phone/call-reasons.md)
            + [Registrar motivos de llamada y resultados de llamada a Salesforce](product-docs/marketo-sales-insight/actions/phone/log-call-reasons-and-call-outcomes-to-salesforce.md)
...
+ Notas de la versión {#release-notes}
   ...
   + [Versión actual](release-notes/current-test.md)
