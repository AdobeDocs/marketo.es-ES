...
+ Introducción a Marketo Engage {#getting-started}
   ...
   + Configuración inicial {#initial-setup}
      ...
      + [Configuración de protocolos](getting-started/initial-setup/configure-protocols-for-marketo.md)
      + [Configuración de usuarios](getting-started/initial-setup/user-setup.md)
   + Implementación de una nueva instancia de Marketo Engage {#implementing-a-new-marketo-engage-instance}
      + [Dónde comenzar](getting-started/implementing-a-new-marketo-engage-instance/where-to-start.md)
      ...
      + [Prácticas recomendadas para nuevas instancias: Lista de comprobación de la base de datos](getting-started/implementing-a-new-marketo-engage-instance/database-checklist.md)
      ...
      + [Prácticas recomendadas para nuevas instancias: Lista de control de las actividades de marketing](getting-started/implementing-a-new-marketo-engage-instance/marketing-activities-checklist.md)
      ...
      + [Prácticas recomendadas para nuevas instancias: Documente su configuración](getting-started/implementing-a-new-marketo-engage-instance/document-your-setup.md)
   + Cosas que debe saber {#things-to-know}
      + [Glosario de Marketo Engage](getting-started/things-to-know/marketo-engage-glossary.md)
      + {hide-from-toc}[Nuevo glosario](getting-started/things-to-know/new-glossary.md)
   ...
   + Ganancias rápidas {#quick-wins}
      ...
      + [Página de destino con formulario](getting-started/quick-wins/landing-page-with-a-form.md)
      ...
      + [Sistema de goteo y nutrición](getting-started/quick-wins/drip-drip-nurture.md)
      + [Personalizar un correo electrónico](getting-started/quick-wins/personalize-an-email.md)
      + [Alerta al representante de ventas](getting-started/quick-wins/alert-the-sales-rep.md)
      + [Actualizar los datos de la persona](getting-started/quick-wins/update-person-data.md)
      + [Redirigir una página de destino](getting-started/quick-wins/redirect-a-landing-page.md)
   ...
   + Herencia de una instancia de Marketo Engage {#inheriting-a-marketo-engage-instance}
      + [Dónde comenzar](getting-started/inheriting-a-marketo-engage-instance/where-to-start.md)
      ...
      + [Instancia heredada: Lista de comprobación de la base de datos](getting-started/inheriting-a-marketo-engage-instance/database-checklist.md)
...
+ Documentos del producto {#product-docs}
   ...
   + Aplicaciones adicionales {#additional-apps}
      + SEO {#seo}
         + Palabras clave {#keywords}
            + {hide-from-toc}[SEO - Exportando resultados de palabras clave](product-docs/additional-apps/seo/keywords/seo-exporting-keyword-results.md)
         + Páginas {#pages}
            + {hide-from-toc}[SEO - Problemas de exportación a CSV](product-docs/additional-apps/seo/pages/seo-export-issues-to-csv.md)
         + Informes {#reports}
   ...
   + Administración {#administration}
      ...
      + Integraciones adicionales {#additional-integrations}
         ...
         + [Añadir Google AdWords como servicio de LaunchPoint con una cuenta de administrador](product-docs/administration/additional-integrations/add-google-adwords-as-a-launchpoint-service-with-a-manager-account.md)
         ...
         + [Añadir reunión web de nivel 3 como servicio de LaunchPoint](product-docs/administration/additional-integrations/add-level-3-web-meeting-as-a-launchpoint-service.md)
         ...
         + {hide-from-toc}[Preguntas frecuentes sobre el seguimiento de Munchkin de próxima generación](product-docs/administration/additional-integrations/add-munchkin-tracking-code-to-your-website/next-generation-munchkin-tracking-faq.md)
         + [Añadir el inicio de sesión único a un portal](product-docs/administration/additional-integrations/add-single-sign-on-to-a-portal.md)
         ...
         + {hide-from-toc}[Configuración de la API de SOAP](product-docs/administration/additional-integrations/configuring-your-soap-api-settings.md)
         + [Conectar BrightTALK a Marketo](product-docs/administration/additional-integrations/connect-brighttalk-to-marketo.md)
         + [Creación de un servicio personalizado para utilizarlo con la API de ReST](product-docs/administration/additional-integrations/create-a-custom-service-for-use-with-rest-api.md)
         + [Creación de un webhook](product-docs/administration/additional-integrations/create-a-webhook.md)
      ...
      + Pista de auditoría {#audit-trail}
         + [Información general de seguimiento de auditoría](product-docs/administration/audit-trail/audit-trail-overview.md)
         + [Cambiar detalles en el seguimiento de auditoría](product-docs/administration/audit-trail/change-details-in-audit-trail.md)
         + [Habilitar seguimiento de auditoría](product-docs/administration/audit-trail/enable-audit-trail.md)
         + [Filtrado en seguimiento de auditoría](product-docs/administration/audit-trail/filtering-in-audit-trail.md)
         + [Historial de inicio de sesión de usuario](product-docs/administration/audit-trail/user-login-history.md)
      + Configuración del correo electrónico {#email-setup}
         + Añadir varios dominios de personalización de marca {#add-multiple-branding-domains}
            + [Añadir un dominio de personalización de marca adicional con espacios de trabajo](product-docs/administration/email-setup/add-multiple-branding-domains/add-an-additional-branding-domain-with-workspaces.md)
            + [Añadir un dominio de personalización de marca adicional](product-docs/administration/email-setup/add-multiple-branding-domains/add-an-additional-branding-domain.md)
            + [Eliminar un dominio de personalización de marca](product-docs/administration/email-setup/add-multiple-branding-domains/delete-a-branding-domain.md)
         ...
         + [Cambio de la etiqueta predeterminada Desde correo electrónico y Desde](product-docs/administration/email-setup/change-the-default-from-email-and-from-label.md)
      ...
      + Administración de campos {#field-management}
         ...
         + {hide-from-toc}[Administración de listas de selección](product-docs/administration/field-management/picklist-management.md)
      ...
      + Actividades personalizadas de Marketo {#marketo-custom-activities}
         + [Explicación de actividades personalizadas](product-docs/administration/marketo-custom-activities/understanding-custom-activities.md)
         + [Añadir/editar/eliminar campos de actividad personalizados de Marketo](product-docs/administration/marketo-custom-activities/add-edit-delete-marketo-custom-activity-fields.md)
         + [Creación de una actividad personalizada](product-docs/administration/marketo-custom-activities/create-a-custom-activity.md)
         + [Edición de una actividad personalizada](product-docs/administration/marketo-custom-activities/edit-a-custom-activity.md)
      ...
      + Objetos personalizables de Marketo {#marketo-custom-objects}
         + [Explicación de Objetos personalizables de Marketo](product-docs/administration/marketo-custom-objects/understanding-marketo-custom-objects.md)
         + [Añadir campos de objeto personalizables de Marketo](product-docs/administration/marketo-custom-objects/add-marketo-custom-object-fields.md)
         + [Añadir campos de vínculo de objetos personalizables de Marketo](product-docs/administration/marketo-custom-objects/add-marketo-custom-object-link-fields.md)
         + [Aprobar un objeto personalizable](product-docs/administration/marketo-custom-objects/approve-a-custom-object.md)
         + [Crear objetos personalizables de Marketo](product-docs/administration/marketo-custom-objects/create-marketo-custom-objects.md)
         + [Editar y eliminar un objeto personalizable de Marketo](product-docs/administration/marketo-custom-objects/edit-and-delete-a-marketo-custom-object.md)
         + [Editar y eliminar campos de objetos personalizables de Marketo](product-docs/administration/marketo-custom-objects/edit-and-delete-marketo-custom-object-fields.md)
         + [Importar datos de objetos personalizables](product-docs/administration/marketo-custom-objects/import-custom-object-data.md)
         + [Desactivar cambios en objetos personalizables](product-docs/administration/marketo-custom-objects/trigger-off-custom-object-changes.md)
         + [Exportación de metadatos de objeto personalizable](product-docs/administration/marketo-custom-objects/custom-object-metadata-export.md)
      ...
      + Configuración {#settings}
         ...
         + [Habilitar direcciones URL personalizadas para su cuenta](product-docs/administration/settings/enable-personalized-urls-for-your-account.md)
         ...
         + {hide-from-toc}[Paneles de uso del producto](product-docs/administration/settings/product-usage-dashboards.md)
      ...
      + Etiquetas {#tags}
         ...
         + [Creación de etiquetas personalizadas](product-docs/administration/tags/create-custom-tags.md)
      ...
      + Espacios de trabajo y particiones de personas {#workspaces-and-person-partitions}
         + [Explicación de espacios de trabajo y particiones de personas](product-docs/administration/workspaces-and-person-partitions/understanding-workspaces-and-person-partitions.md)
         ...
         + [Creación de un nuevo espacio de trabajo](product-docs/administration/workspaces-and-person-partitions/create-a-new-workspace.md)
         + [Crear una partición de personas](product-docs/administration/workspaces-and-person-partitions/create-a-person-partition.md)
         + [Eliminar un espacio de trabajo](product-docs/administration/workspaces-and-person-partitions/delete-a-workspace.md)
         + [Edición de un espacio de trabajo](product-docs/administration/workspaces-and-person-partitions/edit-a-workspace.md)
         + [Edición de una partición de personas existente](product-docs/administration/workspaces-and-person-partitions/edit-an-existing-person-partition.md)
   ...
   + Integraciones de Adobe Experience Cloud {#adobe-experience-cloud-integrations}
      + [Información general sobre las integraciones de Adobe Experience Cloud](product-docs/adobe-experience-cloud-integrations/adobe-experience-cloud-integrations-overview.md)
      + [Configuración de la asignación de organización de Adobe](product-docs/adobe-experience-cloud-integrations/set-up-adobe-organization-mapping.md)
      + [Sincronizar una audiencia desde Adobe Experience Cloud](product-docs/adobe-experience-cloud-integrations/sync-an-audience-from-adobe-experience-cloud.md)
   ...
   + Conceptos principales de Marketo {#core-marketo-concepts}
      + Campañas inteligentes {#smart-campaigns}
         ...
         + Creación de una campaña inteligente {#creating-a-smart-campaign}
            + [Explicación de las campañas inteligentes por lotes y activación](product-docs/core-marketo-concepts/smart-campaigns/creating-a-smart-campaign/understanding-batch-and-trigger-smart-campaigns.md)
            + [Crear nueva campaña inteligente](product-docs/core-marketo-concepts/smart-campaigns/creating-a-smart-campaign/create-a-new-smart-campaign.md)
            ...
            + [Definición de listas inteligentes para campañas inteligentes | Activación](product-docs/core-marketo-concepts/smart-campaigns/creating-a-smart-campaign/define-smart-list-for-smart-campaign-trigger.md)
            + [Comprobación de la campaña inteligente](product-docs/core-marketo-concepts/smart-campaigns/creating-a-smart-campaign/smart-campaign-checklist.md)
         + Uso de campañas inteligentes {#using-smart-campaigns}
            + [Anulación de la campaña inteligente](product-docs/core-marketo-concepts/smart-campaigns/using-smart-campaigns/abort-a-smart-campaign.md)
            + [Activación de una campaña inteligente de activador | Pestaña Programación](product-docs/core-marketo-concepts/smart-campaigns/using-smart-campaigns/activate-a-trigger-smart-campaign-schedule-tab.md)
            + [Aplicar límites de comunicación a campaña inteligente](product-docs/core-marketo-concepts/smart-campaigns/using-smart-campaigns/apply-communication-limits-to-smart-campaign.md)
            + [Limpieza de campañas de activador automático](product-docs/core-marketo-concepts/smart-campaigns/using-smart-campaigns/automatic-trigger-campaign-cleanup.md)
            ...
            + [Desactivación de una campaña inteligente de activador | Pestaña Programación](product-docs/core-marketo-concepts/smart-campaigns/using-smart-campaigns/deactivate-a-trigger-smart-campaign-schedule-tab.md)
            ...
            + [Anulación de restricciones de una persona en una campaña inteligente](product-docs/core-marketo-concepts/smart-campaigns/using-smart-campaigns/override-person-restrictions-in-a-smart-campaign.md)
            + [Anulación de prioridad para campañas de activador](product-docs/core-marketo-concepts/smart-campaigns/using-smart-campaigns/priority-override-for-trigger-campaigns.md)
            ...
            + [Configuración de una campaña inteligente de activador para ventas con “La campaña está solicitada”](product-docs/core-marketo-concepts/smart-campaigns/using-smart-campaigns/setting-up-a-trigger-smart-campaign-for-sales-using-campaign-is-requested.md)
         ...
         + Acciones de flujo {#flow-actions}
            ...
            + [Añadir a la lista](product-docs/core-marketo-concepts/smart-campaigns/flow-actions/add-to-list.md)
            ...
            + {hide-from-toc}[Dar crédito al referente](product-docs/core-marketo-concepts/smart-campaigns/flow-actions/give-credit-to-referrer.md)
            + [Momento interesante](product-docs/core-marketo-concepts/smart-campaigns/flow-actions/interesting-moment.md)
            + [Quitar del flujo](product-docs/core-marketo-concepts/smart-campaigns/flow-actions/remove-from-flow.md)
            ...
            + {hide-from-toc}[Acciones de flujo único desde la página de detalles de persona](product-docs/core-marketo-concepts/smart-campaigns/flow-actions/single-flow-actions-from-person-detail-page.md)
         ...
         + Acciones de flujo del programa {#program-flow-actions}
         ...
         + Acciones de flujo de Salesforce {#salesforce-flow-actions}
            ...
            + [Cambiar estado de la campaña SFDC](product-docs/core-marketo-concepts/smart-campaigns/salesforce-flow-actions/change-status-in-sfdc-campaign.md)
            ...
            + [Quitar de la campaña de SFDC](product-docs/core-marketo-concepts/smart-campaigns/salesforce-flow-actions/remove-from-sfdc-campaign.md)
         ...
         + Datos de la campaña inteligente {#smart-campaign-data}
            ...
            + [Ver miembros de la campaña inteligente](product-docs/core-marketo-concepts/smart-campaigns/smart-campaign-data/view-smart-campaign-members.md)
            + [Ver resultados de la campaña inteligente](product-docs/core-marketo-concepts/smart-campaigns/smart-campaign-data/view-smart-campaign-results.md)
      + Listas inteligentes y listas estáticas {#smart-lists-and-static-lists}
         ...
         + Creación de una lista inteligente {#creating-a-smart-list}
            ...
            + [Definir filtros de la lista inteligente](product-docs/core-marketo-concepts/smart-lists-and-static-lists/creating-a-smart-list/define-smart-list-filters.md)
            + [Buscar y añadir filtros a una lista inteligente](product-docs/core-marketo-concepts/smart-lists-and-static-lists/creating-a-smart-list/find-and-add-filters-to-a-smart-list.md)
         ...
         + Uso de listas inteligentes {#using-smart-lists}
            + [Añadir una restricción a un filtro de listas inteligentes](product-docs/core-marketo-concepts/smart-lists-and-static-lists/using-smart-lists/add-a-constraint-to-a-smart-list-filter.md)
            + [Añadir varios valores a un filtro de listas inteligentes](product-docs/core-marketo-concepts/smart-lists-and-static-lists/using-smart-lists/add-multiple-values-to-a-smart-list-filter.md)
         ...
         + Administrar personas en listas inteligentes {#managing-people-in-smart-lists}
            ...
            + [Creación de una persona manualmente](product-docs/core-marketo-concepts/smart-lists-and-static-lists/managing-people-in-smart-lists/create-a-person-manually.md)
            + [Panel de la base de datos](product-docs/core-marketo-concepts/smart-lists-and-static-lists/managing-people-in-smart-lists/database-dashboard.md)
            ...
            + [Buscar todas las personas en una fase de ingresos](product-docs/core-marketo-concepts/smart-lists-and-static-lists/managing-people-in-smart-lists/find-all-people-in-a-revenue-stage.md)
            ...
            + [Uso de la búsqueda rápida en una lista o lista inteligente](product-docs/core-marketo-concepts/smart-lists-and-static-lists/managing-people-in-smart-lists/use-quick-find-in-a-list-or-smart-list.md)
         ...
         + Listas estáticas {#static-lists}
            + [Creación de una lista estática](product-docs/core-marketo-concepts/smart-lists-and-static-lists/static-lists/create-a-static-list.md)
      ...
      + Programas {#programs}
         ...
         + Trabajo con los programas {#working-with-programs}
            ...
            + [Vencimiento del recurso local](product-docs/core-marketo-concepts/programs/working-with-programs/local-asset-expiration.md)
            + [Administrar y ver miembros](product-docs/core-marketo-concepts/programs/working-with-programs/manage-and-view-members.md)
            + [Campos personalizados del miembro del programa](product-docs/core-marketo-concepts/programs/working-with-programs/program-member-custom-fields.md)
            ...
            + [Explicación de costes del período](product-docs/core-marketo-concepts/programs/working-with-programs/understanding-period-costs.md)
         ...
         + Biblioteca de programas {#program-library}
            + [Información general de la biblioteca de importación de programas](product-docs/core-marketo-concepts/programs/program-library/program-import-library-overview.md)
            + [EM-AAAA-MM-DD-Envío de un único correo electrónico](/help/marketo/product-docs/core-marketo-concepts/programs/program-library/em-yyyy-mm-dd-single-email-send.md)
            + [NL-AAAA-MM-Newsletter](/help/marketo/product-docs/core-marketo-concepts/programs/program-library/nl-yyyy-mm-newsletter.md)
            + [WBN-AAAA-MM-DD-Programa del seminario web](/help/marketo/product-docs/core-marketo-concepts/programs/program-library/wbn-yyyy-mm-dd-webinar-program.md)
            + [EV-AAAA-MM-DD-Programa del evento](/help/marketo/product-docs/core-marketo-concepts/programs/program-library/ev-yyyy-mm-dd-event-program.md)
            + [TS-AAAA-MM-DD-Programa de la feria comercial](/help/marketo/product-docs/core-marketo-concepts/programs/program-library/ts-yyyy-mm-dd-tradeshow-program.md)
            ...
            + [CT-AAAA-MM-Contenido en la página de destino de Marketo](/help/marketo/product-docs/core-marketo-concepts/programs/program-library/ct-yyyy-mm-content-on-marketo-landing-page.md)
            + [CT-AAAA-MM-Contenido de la página de destino que no es de Marketo](/help/marketo/product-docs/core-marketo-concepts/programs/program-library/ct-yyyy-mm-content-non-marketo-landing-page.md)
            + [WR-AAAA-MM-Programa de solicitud web](/help/marketo/product-docs/core-marketo-concepts/programs/program-library/wr-yyyy-mm-web-request-program.md)
            + [OA-AAAA-MM- Página de destino de publicidad en línea de Marketo](/help/marketo/product-docs/core-marketo-concepts/programs/program-library/oa-yyyy-mm-online-advertising-marketo-landing-page.md)
            + [OP-Administración de datos](/help/marketo/product-docs/core-marketo-concepts/programs/program-library/op-data-management.md)
            + [OP-Gestión de clientes potenciales](/help/marketo/product-docs/core-marketo-concepts/programs/program-library/op-lead-management.md)
            + [OP-Comportamiento de puntuación](/help/marketo/product-docs/core-marketo-concepts/programs/program-library/op-scoring-behavior.md)
            + [OP-Puntuación-Demográfica](/help/marketo/product-docs/core-marketo-concepts/programs/program-library/op-scoring-demographic.md)
            + [OP-Adquisición-API](/help/marketo/product-docs/core-marketo-concepts/programs/program-library/op-acquisition-api.md)
            + [OP-Administración de la capacidad de entrega](/help/marketo/product-docs/core-marketo-concepts/programs/program-library/op-deliverability-management.md)
            ...
            + [Plantilla de la página de destino de inicio rápido](/help/marketo/product-docs/core-marketo-concepts/programs/program-library/quick-start-landing-page-template.md)
         + Informe de rendimiento del programa {#program-performance-report}
            ...
            + [Añadir columnas de estado del programa a un informe de programa](product-docs/core-marketo-concepts/programs/program-performance-report/add-program-status-columns-to-a-program-report.md)
         ...
         + Vista de calendario del programa {#program-schedule-view}
            ...
            + [Creación de una campaña inteligente por lotes en la vista Calendario del programa](product-docs/core-marketo-concepts/programs/program-schedule-view/creating-a-batch-smart-campaign-in-the-program-schedule-view.md)
            ...
            + [Creación de una entrada en la vista Calendario del programa](product-docs/core-marketo-concepts/programs/program-schedule-view/creating-an-entry-in-the-program-schedule-view.md)
            + [Creación de superposiciones personalizadas en la vista Calendario del programa](product-docs/core-marketo-concepts/programs/program-schedule-view/creating-custom-overlays-in-program-schedule-view.md)
            + [Edición de entradas en la vista Calendario del programa](product-docs/core-marketo-concepts/programs/program-schedule-view/editing-entries-in-the-program-schedule-view.md)
            ...
            + [Movimiento de entradas en la vista Calendario del programa](product-docs/core-marketo-concepts/programs/program-schedule-view/moving-entries-in-the-program-schedule-view.md)
            + [Navegación por la vista Calendario del programa](product-docs/core-marketo-concepts/programs/program-schedule-view/navigating-the-program-schedule-view.md)
            + [Tipos de entradas de la vista Calendario del programa](product-docs/core-marketo-concepts/programs/program-schedule-view/program-schedule-view-entry-types.md)
            + [Volver a ejecutar una campaña inteligente en la vista Calendario del programa](product-docs/core-marketo-concepts/programs/program-schedule-view/rerun-a-smart-campaign-in-the-program-schedule-view.md)
            + [Reprogramar una campaña inteligente por lotes en la vista Calendario del programa](product-docs/core-marketo-concepts/programs/program-schedule-view/reschedule-a-batch-smart-campaign-in-the-program-schedule-view.md)
      ...
      + Calendario de marketing {#marketing-calendar}
         + Explicación del calendario {#understanding-the-calendar}
            ...
            + [Ver detalles de la entrada](product-docs/core-marketo-concepts/marketing-calendar/understanding-the-calendar/view-entry-details.md)
         ...
         + Calendario HD {#calendar-hd}
            + [Añadir una imagen de fondo a una presentación](product-docs/core-marketo-concepts/marketing-calendar/calendar-hd/add-a-background-image-to-a-presentation.md)
            + [Clonar una presentación](product-docs/core-marketo-concepts/marketing-calendar/calendar-hd/clone-a-presentation.md)
            + [Creación de una meta personalizada](product-docs/core-marketo-concepts/marketing-calendar/calendar-hd/create-a-custom-goal.md)
            + [Creación de una presentación](product-docs/core-marketo-concepts/marketing-calendar/calendar-hd/create-a-presentation.md)
            + [Creación de una meta de lista inteligente](product-docs/core-marketo-concepts/marketing-calendar/calendar-hd/create-a-smart-list-goal.md)
      ...
      + Aplicaciones móviles {#mobile-apps}
         + Registro en eventos {#event-check-in}
            + [Información general sobre el registro en eventos](product-docs/core-marketo-concepts/mobile-apps/event-check-in/event-check-in-overview.md)
         ...
         + Momentos de Marketo {#marketo-moments}
            + Explicación de los momentos {#understanding-moments}
               ...
               + [Explicación de las tarjetas de los programas de correo electrónico](product-docs/core-marketo-concepts/mobile-apps/marketo-moments/understanding-moments/understanding-email-program-cards.md)
               ...
               + [Explicación de las tarjetas de campañas inteligentes](product-docs/core-marketo-concepts/mobile-apps/marketo-moments/understanding-moments/understanding-smart-campaign-cards.md)
            + Trabajo con momentos {#working-with-moments}
               ...
               + [Personalización de momentos Marketo](product-docs/core-marketo-concepts/mobile-apps/marketo-moments/working-with-moments/personalizing-marketo-moments.md)
      ...
      + Varios {#miscellaneous}
         ...
         + {hide-from-toc}[Glosario de métodos abreviados de teclado](product-docs/core-marketo-concepts/miscellaneous/keyboard-shortcuts-glossary.md)
         + [Zona protegida de Marketo](product-docs/core-marketo-concepts/miscellaneous/marketo-sandbox.md)
         + [Administración de la privacidad](product-docs/core-marketo-concepts/miscellaneous/privacy-management.md)
      ...
      + Audiencias predictivas {#predictive-audiences}
         + [Introducción a audiencias predictivas](product-docs/core-marketo-concepts/predictive-audiences/getting-started-with-predictive-audiences.md)
   ...
   + Sincronización de CRM {#crm-sync}
      + Sincronización de Microsoft Dynamics {#microsoft-dynamics}
         ...
         + Configuración de sincronización {#sync-setup}
            + [Descargar la solución Gestión de clientes potenciales de Marketo](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/download-the-marketo-lead-management-solution.md)
            ...
            + Microsoft Dynamics 365 con conexión S2S{#microsoft-dynamics-365-with-s2s-connection}
               ...
               + [Paso 3 de 3: Conexión de la solución Marketo con conexión S2S](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-365-with-s2s-connection/step-3-of-3-connect.md)
            + Conectarse a versiones heredadas {#connecting-to-legacy-versions}
               + [Paso 1 de 3: Instalar la solución de Marketo (2011, local)](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/connecting-to-legacy-versions/step-1-of-3-install-2011.md)
               ...
               + [Paso 1 de 3: Instalar la solución de Marketo en Dynamics (2015, local)](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/connecting-to-legacy-versions/step-1-of-3-install-2015.md)
         ...
         + Datos de sincronización de Microsoft Dynamics {#microsoft-dynamics-sync-details}
            ...
            + [Información general de sincronización de campañas](product-docs/crm-sync/microsoft-dynamics-sync/microsoft-dynamics-sync-details/campaign-sync-overview.md)
         ...
         + Datos del filtro de sincronización de Dynamics personalizado {#custom-dynamics-sync-filter-details}
            ...
            + [Reglas de filtro de sincronización personalizado para una dirección de correo electrónico](product-docs/crm-sync/microsoft-dynamics-sync/create-a-custom-dynamics-sync-filter/custom-sync-filter-rules-for-an-email-address.md)
         ...
         + [Registrar una aplicación con Azure para adquirir su ID de cliente o ID de aplicación](product-docs/crm-sync/microsoft-dynamics-sync/register-an-app-with-azure-to-acquire-your-client-id-app-id.md)
      ...
      + Sincronización con Salesforce {#salesforce-sync}
         ...
         + Configuración {#setup}
            + Empresas/Sin límites {#enterprise-unlimited-edition}
               ...
               + [Paso 3 de 3: Conectar Marketo y Salesforce (para empresas y sin límites)](product-docs/crm-sync/salesforce-sync/setup/enterprise-unlimited-edition/step-3-of-3-connect-marketo-and-salesforce-enterprise-unlimited.md)
            + Edición profesional {#professional-edition}
               + [Paso 1 de 3: Añadir campos de Marketo a Salesforce (profesional)](product-docs/crm-sync/salesforce-sync/setup/professional-edition/step-1-of-3-add-marketo-fields-to-salesforce-professional.md)
            ...
            + Pasos opcionales {#optional-steps}
               + [Añadir o quitar campos de objetos personalizados como restricciones de listas inteligentes o activador](product-docs/crm-sync/salesforce-sync/setup/optional-steps/add-remove-custom-object-field-as-smart-list-trigger-constraints.md)
               ...
               + [Habilitar/deshabilitar la sincronización de la campaña](product-docs/crm-sync/salesforce-sync/setup/optional-steps/enable-disable-campaign-sync.md)
               ...
               + [Establecer apellidos de persona y nombre de empresa predeterminados](product-docs/crm-sync/salesforce-sync/setup/optional-steps/set-default-person-last-name-and-company-name.md)
         ...
         + Detalles de sincronización de SFDC {#sfdc-sync-details}
            ...
            + [Sincronización de SFDC: sincronización de cuentas](product-docs/crm-sync/salesforce-sync/sfdc-sync-details/sfdc-sync-account-sync.md)
            ...
            + [Sincronización de SFDC: sincronización de campañas](product-docs/crm-sync/salesforce-sync/sfdc-sync-details/sfdc-sync-campaign-sync.md)
         ...
         + [Añadir o quitar valores de la lista de selección](product-docs/crm-sync/salesforce-sync/add-remove-picklist-values.md)
      ...
      + Sincronización de Veeva CRM {#veeva-crm-sync}
         ...
         + Detalles de la sincronización {#sync-details}
            + [Añadir o quitar campos de objetos personalizados como restricciones de listas inteligentes o activador](product-docs/crm-sync/veeva-crm-sync/sync-details/add-remove-custom-object-field-as-smart-list-trigger-constraints.md)
            + {hide-from-toc}[Sincronización de objetos personalizados](product-docs/crm-sync/veeva-crm-sync/sync-details/custom-object-sync.md)
            ...
            + [Preguntas frecuentes sobre la sincronización de cuenta de persona](product-docs/crm-sync/veeva-crm-sync/sync-details/person-account-sync-faq.md)
   ...
   + Generación de demanda {#demand-generation}
      + Integraciones de red de anuncios {#ad-network-integrations}
         + [Explicación de las integraciones de red de anuncios](product-docs/demand-generation/ad-network-integrations/understanding-ad-network-integrations.md)
         ...
         + [Añadir Segmentación por lista de clientes de Google como servicio de LaunchPoint](product-docs/demand-generation/ad-network-integrations/add-google-customer-match-as-a-launchpoint-service.md)
         ...
         + [Enviar una lista a una red de anuncios](product-docs/demand-generation/ad-network-integrations/send-a-list-to-an-ad-network.md)
      ...
      + Dynamic Chat {#dynamic-chat}
         ...
         + Instalación y configuración {#setup-and-configuration}
            ...
            + [Añadir o quitar usuarios de chat](product-docs/demand-generation/dynamic-chat/setup-and-configuration/add-or-remove-chat-users.md)
            ...
            + [Gestión de agentes](product-docs/demand-generation/dynamic-chat/setup-and-configuration/agent-management.md)
            + [Configuración de seguridad](product-docs/demand-generation/dynamic-chat/setup-and-configuration/security-settings.md)
            + [Enrutamiento](product-docs/demand-generation/dynamic-chat/setup-and-configuration/routing.md)
         ...
         + Chat automatizado {#automated-chat}
            + [Información general de flujo conversacional](product-docs/demand-generation/dynamic-chat/automated-chat/conversational-flow-overview.md)
            + [Crear un flujo conversacional](product-docs/demand-generation/dynamic-chat/automated-chat/create-a-conversational-flow.md)
            + [Configuración del flujo conversacional para los formularios de Marketo Engage](product-docs/demand-generation/dynamic-chat/automated-chat/conversational-flow-settings-for-marketo-engage-forms.md)
            + [Información general del diálogo](product-docs/demand-generation/dynamic-chat/automated-chat/dialogue-overview.md)
         ...
         + Chat en directo {#live-chat}
            + [Información general del chat en directo](product-docs/demand-generation/dynamic-chat/live-chat/live-chat-overview.md)
            + [Bandeja de entrada del agente](product-docs/demand-generation/dynamic-chat/live-chat/agent-inbox.md)
            + {hide-from-toc}[Notificaciones](product-docs/demand-generation/dynamic-chat/live-chat/notifications.md)
         + IA generativa {#generative-ai}
            + [Información general de IA generativa](product-docs/demand-generation/dynamic-chat/generative-ai/overview.md)
            ...
            + [Preguntas sin respuesta](product-docs/demand-generation/dynamic-chat/generative-ai/unanswered-questions.md)
      + Eventos {#events}
         + Explicación de eventos {#understanding-events}
            ...
            + [Socios del evento](product-docs/demand-generation/events/understanding-events/event-partners.md)
            ...
            + {hide-from-toc}[Configurar un límite de evento](product-docs/demand-generation/events/understanding-events/setting-an-event-cap.md)
            + {hide-from-toc}[Estableciendo metas de evento](product-docs/demand-generation/events/understanding-events/setting-event-goals.md)
         + Crear un evento {#create-an-event}
            + [Crear un evento con Adobe Connect](product-docs/demand-generation/events/create-an-event/create-an-event-with-adobe-connect.md)
            + [Crear un evento con GotoWebinar](product-docs/demand-generation/events/create-an-event/create-an-event-with-gotowebinar.md)
            ...
            + Crear un evento con el adaptador Marketo ON24 {#create-an-event-with-the-marketo-on24-adapter}
               ...
               + [Crear su evento de seminario web en ON24](product-docs/demand-generation/events/create-an-event/create-an-event-with-the-marketo-on24-adapter/create-your-webinar-event-in-on24.md)
               ...
               + [Explicación de los estados del programa del seminario web](product-docs/demand-generation/events/create-an-event/create-an-event-with-the-marketo-on24-adapter/understanding-webinar-program-statuses.md)
         + Seminarios web interactivos {#interactive-webinars}
            + [Información general de seminarios web interactivos](product-docs/demand-generation/events/interactive-webinars/interactive-webinars-overview.md)
            + [Introducción a seminarios web interactivos](product-docs/demand-generation/events/interactive-webinars/get-started-with-interactive-webinars.md)
            ...
            + [Creación de un seminario web interactivo](product-docs/demand-generation/events/interactive-webinars/create-an-interactive-webinar.md)
            ...
            + [Añadir un equipo al seminario web](product-docs/demand-generation/events/interactive-webinars/add-a-webinar-team.md)
            + [Prueba de un seminario web interactivo](product-docs/demand-generation/events/interactive-webinars/testing-an-interactive-webinar.md)
            ...
            + [Flujos de trabajo de evento](product-docs/demand-generation/events/interactive-webinars/event-workflows.md)
      ...
      + Facebook {#facebook}
         ...
         + [Creación de una audiencia personalizada en Facebook](product-docs/demand-generation/facebook/create-a-custom-audience-in-facebook.md)
         + {hide-from-toc}[Editar configuración de publicación enriquecida de Facebook](product-docs/demand-generation/facebook/edit-facebook-rich-post-settings.md)
         + [Publicación de páginas de destino en Facebook](product-docs/demand-generation/facebook/publish-landing-pages-to-facebook.md)
         ...
         + [Configuración de conversiones de Facebook sin conexión](product-docs/demand-generation/facebook/set-up-facebook-offline-conversions.md)
         + [Prueba de anuncios de clientes potenciales de Facebook para la integración de escritorio con Marketo](product-docs/demand-generation/facebook/test-facebook-lead-ads-for-desktop-integration-with-marketo.md)
         + [Prueba de anuncios de clientes potenciales de Facebook para la integración móvil con Marketo](product-docs/demand-generation/facebook/test-facebook-lead-ads-for-mobile-integration-with-marketo.md)
      ...
      + Formularios {#forms}
         + Creación de un formulario {#creating-a-form}
            + [Creación de un formulario](product-docs/demand-generation/forms/creating-a-form/create-a-form.md)
            + [Añadir un campo a un formulario](product-docs/demand-generation/forms/creating-a-form/add-a-field-to-a-form.md)
            + [Aprobación de un formulario](product-docs/demand-generation/forms/creating-a-form/approve-a-form.md)
            ...
            + [Selección de un tema de formulario](product-docs/demand-generation/forms/creating-a-form/select-a-form-theme.md)
         ...
         + Acciones de formulario {#form-actions}
            + [Añadir una lista de selección de país a su formulario](product-docs/demand-generation/forms/form-actions/add-a-country-picklist-to-your-form.md)
            + [Añadir texto enriquecido a un formulario](product-docs/demand-generation/forms/form-actions/add-rich-text-to-a-form.md)
            ...
            + [Configurar una creación de perfiles progresiva del formulario](product-docs/demand-generation/forms/form-actions/configure-form-progressive-profiling.md)
            ...
            + [Deshabilitar compleción de formulario social](product-docs/demand-generation/forms/form-actions/disable-social-form-fill.md)
            + [Edición de un formulario](product-docs/demand-generation/forms/form-actions/edit-a-form.md)
            ...
            + {hide-from-toc}[Habilitar el relleno de formulario social en un formulario](product-docs/demand-generation/forms/form-actions/enable-social-form-fill-on-a-form.md)
            + {hide-from-toc}[Preguntas frecuentes sobre el relleno de formularios sociales en LinkedIn](product-docs/demand-generation/forms/form-actions/linkedin-social-form-fill-faqs.md)
            ...
            + [Uso de un formulario en Lightbox](product-docs/demand-generation/forms/form-actions/use-a-form-in-a-lightbox.md)
         + Diseño del formulario {#form-design}
         ...
         + Campos del formulario {#form-fields}
            + [Añadir un conjunto de campos a un formulario](product-docs/demand-generation/forms/form-fields/add-a-fieldset-to-a-form.md)
            + [Añadir texto de sugerencia a un campo de formulario](product-docs/demand-generation/forms/form-fields/add-hint-text-to-a-form-field.md)
            + [Añadir instrucciones de ayuda contextual a un campo de formulario](product-docs/demand-generation/forms/form-fields/add-tooltip-instructions-to-a-form-field.md)
            ...
            + [Eliminar campo de un formulario](product-docs/demand-generation/forms/form-fields/delete-a-field-in-a-form.md)
         ...
         + Uso de CAPTCHA {#using-captcha}
            + [Configuración de un reCAPTCHA versión 3](product-docs/demand-generation/forms/using-captcha/setting-up-recaptcha-v3.md)
            + [Habilitar CAPTCHA en formularios de Marketo](product-docs/demand-generation/forms/using-captcha/enable-captcha-in-marketo-forms.md)
      + Imágenes y archivos {#images-and-files}
         + {hide-from-toc}[Nuevo documento para agregar imágenes](product-docs/demand-generation/images-and-files/new-add-images-doc.md)
         + [Añadir imágenes y archivos a Marketo](product-docs/demand-generation/images-and-files/add-images-and-files-to-marketo.md)
         + {hide-from-toc}[Editar Assets con Adobe Express](product-docs/demand-generation/images-and-files/edit-assets-with-adobe-express.md)
         ...
         + [Captar las imágenes desde la página web](product-docs/demand-generation/images-and-files/grab-the-images-from-a-web-page.md)
         + [Editor de imágenes](product-docs/demand-generation/images-and-files/image-editor.md)
      ...
      + Páginas de aterrizaje {#landing-pages}
         + Explicación de las páginas de destino {#understanding-landing-pages}
            ...
            + [Grupos de prueba de la página de destino](product-docs/demand-generation/landing-pages/understanding-landing-pages/landing-page-test-groups.md)
            + [Explicación de las páginas de aterrizaje de forma libre y guiadas](product-docs/demand-generation/landing-pages/understanding-landing-pages/understanding-free-form-vs-guided-landing-pages.md)
         + Páginas de destino de forma libre {#free-form-landing-pages}
            + [Adición de un vínculo a una imagen de página de destino de forma libre](product-docs/demand-generation/landing-pages/free-form-landing-pages/add-a-link-to-a-free-form-landing-page-image.md)
            + [Adición de un vínculo a una imagen en una página de destino de forma libre](product-docs/demand-generation/landing-pages/free-form-landing-pages/add-a-link-to-an-image-in-a-free-form-landing-page.md)
            + [Añadir una vista móvil para la página de destino de forma libre](product-docs/demand-generation/landing-pages/free-form-landing-pages/add-a-mobile-view-for-your-free-form-landing-page.md)
            + [Añadir un nuevo formulario a una página de destino de forma libre](product-docs/demand-generation/landing-pages/free-form-landing-pages/add-a-new-form-to-a-free-form-landing-page.md)
            + {hide-from-toc}[Agregar un botón social a una página de aterrizaje de forma libre](product-docs/demand-generation/landing-pages/free-form-landing-pages/add-a-social-button-to-a-free-form-landing-page.md)
            + {hide-from-toc}[Agregar un vídeo a una página de aterrizaje de forma libre](product-docs/demand-generation/landing-pages/free-form-landing-pages/add-a-video-to-a-free-form-landing-page.md)
            + [Añadir una imagen a una página de destino de forma libre](product-docs/demand-generation/landing-pages/free-form-landing-pages/add-an-image-to-a-free-form-landing-page.md)
            + [Añadir un rectángulo a una página de destino de forma libre](product-docs/demand-generation/landing-pages/free-form-landing-pages/adding-a-rectangle-to-a-free-form-landing-page.md)
            + [Añadir un HTML personalizado a una página de destino de forma libre](product-docs/demand-generation/landing-pages/free-form-landing-pages/adding-custom-html-to-a-free-form-landing-page.md)
            + [Creación de una página de destino de forma libre](product-docs/demand-generation/landing-pages/free-form-landing-pages/create-a-free-form-landing-page.md)
            + [Personalizar la vista móvil para la página de destino de forma libre](product-docs/demand-generation/landing-pages/free-form-landing-pages/customize-mobile-view-for-your-free-form-landing-page.md)
            + [Uso de contenido dinámico en una página de destino de forma libre](product-docs/demand-generation/landing-pages/free-form-landing-pages/use-dynamic-content-in-a-free-form-landing-page.md)
            + [Uso de guías para el diseño de páginas de destino de forma libre](product-docs/demand-generation/landing-pages/free-form-landing-pages/use-guides-for-free-form-landing-page-design.md)
         + Páginas de destino guiadas {#guided-landing-pages}
            + [Añadir un formulario a una página de destino guiada](product-docs/demand-generation/landing-pages/guided-landing-pages/add-a-form-to-a-guided-landing-page.md)
            + [Añadir una imagen a una página de destino guiada](product-docs/demand-generation/landing-pages/guided-landing-pages/add-an-image-to-a-guided-landing-page.md)
            + [Creación de una página de destino guiada](product-docs/demand-generation/landing-pages/guided-landing-pages/create-a-guided-landing-page.md)
         + Acciones de la página de destino {#landing-page-actions}
            + [Aprobar varias páginas de destino a la vez](product-docs/demand-generation/landing-pages/landing-page-actions/approve-multiple-landing-pages-at-once.md)
            + [Cambio de la URL de la página de destino](product-docs/demand-generation/landing-pages/landing-page-actions/change-the-landing-page-url.md)
            + [Clonación de un grupo de prueba de la página de destino](product-docs/demand-generation/landing-pages/landing-page-actions/cloning-a-landing-page-test-group.md)
            + [Personalización de las direcciones URL de su página de destino con un CNAME](product-docs/demand-generation/landing-pages/landing-page-actions/customize-your-landing-page-urls-with-a-cname.md)
            + [Editar título y metadatos de la página de destino](product-docs/demand-generation/landing-pages/landing-page-actions/edit-landing-page-title-and-metadata.md)
            + [Filtrado de un informe de rendimiento de la página de destino](product-docs/demand-generation/landing-pages/landing-page-actions/filter-a-landing-page-performance-report.md)
            + [Previsualización de una página de destino con contenido dinámico](product-docs/demand-generation/landing-pages/landing-page-actions/preview-a-landing-page-with-dynamic-content.md)
            + [Previsualización de la página de destino](product-docs/demand-generation/landing-pages/landing-page-actions/preview-a-landing-page.md)
            + [Redirigir una página de destino de Marketo a otra página](product-docs/demand-generation/landing-pages/landing-page-actions/redirect-a-marketo-landing-page-to-another-page.md)
         + Plantillas de la página de destino {#landing-page-templates}
            + [Creación de una plantilla de la página de destino de forma libre](product-docs/demand-generation/landing-pages/landing-page-templates/create-a-free-form-landing-page-template.md)
            + [Crear una plantilla de la página de destino guiada](product-docs/demand-generation/landing-pages/landing-page-templates/create-a-guided-landing-page-template.md)
            + [Editar una plantilla de la página de destino de Marketo](product-docs/demand-generation/landing-pages/landing-page-templates/edit-a-marketo-landing-page-template.md)
            + [Hacer compatible una plantilla de página de destino de forma libre existente con dispositivos móviles](product-docs/demand-generation/landing-pages/landing-page-templates/make-an-existing-free-form-landing-page-template-mobile-compatible.md)
            ...
            + [Lista de plantillas de la página de destino guiada](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-template-list.md)
            + Plantillas de la página de destino guiada {#guided-landing-page-templates}
         ...
         + Personalización de páginas de destino {#personalizing-landing-pages}
      ...
      + Social {#social}
         + Funciones sociales {#social-functions}
            + [Configuración de formularios de generación de clientes potenciales de LinkedIn](product-docs/demand-generation/social/social-functions/set-up-linkedin-lead-gen-forms.md)
            ...
            + [Uso de filtros y activadores de formulario de generación de posibles clientes de LinkedIn en una campaña inteligente](product-docs/demand-generation/social/social-functions/use-linkedin-lead-gen-form-filters-and-triggers-in-a-smart-campaign.md)
   + Marketing por correo electrónico {#email-marketing}
      + Entregabilidad {#deliverability}
         + [Cancelación la suscripción duradera](product-docs/email-marketing/deliverability/durable-unsubscribe.md)
         + [Paquete de herramientas para la entregabilidad del correo electrónico: Cómo importar una lista semilla](product-docs/email-marketing/deliverability/email-deliverability-power-pack-how-to-import-a-seed-list.md)
         + [Devoluciones graves y leves de correos electrónicos](product-docs/email-marketing/deliverability/hard-and-soft-bounces-in-email.md)
         + [Configurar una firma personalizada de DKIM](product-docs/email-marketing/deliverability/set-up-a-custom-dkim-signature.md)
         + [Configuración de SPF y DKIM para la entregabilidad de correo electrónico](product-docs/email-marketing/deliverability/set-up-spf-and-dkim-for-your-email-deliverability.md)
         ...
         + Inbox Tracker {#inbox-tracker}
            + [Tutoriales de Inbox Tracker](product-docs/email-marketing/deliverability/inbox-tracker/inbox-tracker-tutorials.md)
      + Sistema de nutrición {#drip-nurturing}
         ...
         + Flujos del programa de participación {#engagement-program-streams}
            ...
            + [Cambiar nombre de flujo](product-docs/email-marketing/drip-nurturing/engagement-program-streams/rename-a-stream.md)
            ...
            + [Planificar programas de participación con la zona horaria del destinatario](product-docs/email-marketing/drip-nurturing/engagement-program-streams/set-stream-cadence/schedule-engagement-programs-with-recipient-time-zone.md)
         ...
         + Uso de programas de participación {#using-engagement-programs}
            ...
            + [Consultar miembros de un programa de participación](product-docs/email-marketing/drip-nurturing/using-engagement-programs/see-members-of-an-engagement-program.md)
         ...
         + Informes y notificaciones {#reports-and-notifications}
            + [Informe de rendimiento del flujo de participación](product-docs/email-marketing/drip-nurturing/reports-and-notifications/engagement-stream-performance-report.md)
         ...
         + Uso de contenido de flujo {#using-stream-content}
            + [Activar y desactivar contenido de flujo](product-docs/email-marketing/drip-nurturing/using-stream-content/activate-and-deactivate-stream-content.md)
            ...
            + [Editar disponibilidad de contenido de flujo](product-docs/email-marketing/drip-nurturing/using-stream-content/edit-availability-of-stream-content.md)
      ...
      + Diseñador de correo electrónico {#email-designer}
         + Marcas {#brands}
            ...
            + {hide-from-toc}[Personaliza tus marcas](product-docs/email-marketing/email-designer/brands/personalize-brands.md)
         ...
         + [Convertir imágenes a plantillas HTML](product-docs/email-marketing/email-designer/image-to-html.md)
         + [Editor de HTML avanzado de plantilla de correo electrónico](product-docs/email-marketing/email-designer/advanced-html-mode.md)
         ...
         + {hide-from-toc}[Tokens de Personalization](product-docs/email-marketing/email-designer/personalization-tokens.md)
         ...
         + [Fragmentos personalizables](product-docs/email-marketing/email-designer/customizable-fragments.md)
      ...
      + Programas de correo electrónico {#email-programs}
         ...
         + Acciones de programa de correo electrónico {#email-program-actions}
            ...
            + Prueba de correo electrónico - Prueba A/B {#email-test-a-b-test}
               + [Añadir prueba A/B](product-docs/email-marketing/email-programs/email-program-actions/email-test-a-b-test/add-an-a-b-test.md)
               + [Cancelar prueba A/B](product-docs/email-marketing/email-programs/email-program-actions/email-test-a-b-test/cancel-the-a-b-test.md)
               + [Definir criterios del ganador de prueba A/B](product-docs/email-marketing/email-programs/email-program-actions/email-test-a-b-test/define-the-a-b-test-winner-criteria.md)
               + [Programar prueba A/B](product-docs/email-marketing/email-programs/email-program-actions/email-test-a-b-test/schedule-the-a-b-test.md)
               + [Explicación de opciones de prueba de correo electrónico](product-docs/email-marketing/email-programs/email-program-actions/email-test-a-b-test/understanding-email-testing-options.md)
               ...
               + [Usar prueba A/B “Dirección de origen”](product-docs/email-marketing/email-programs/email-program-actions/email-test-a-b-test/use-from-address-a-b-testing.md)
            ...
            + [Inicio rápido para programas de correo electrónico](product-docs/email-marketing/email-programs/email-program-actions/head-start-for-email-programs.md)
            + [Mover un correo electrónico](product-docs/email-marketing/email-programs/email-program-actions/move-an-email.md)
            + [Planifique su programa de correo electrónico](product-docs/email-marketing/email-programs/email-program-actions/schedule-your-email-program.md)
            + Programación con zona horaria del destinatario {#scheduling-with-recipient-time-zone}
               + [Anular el envío de programas de correo electrónico programados con la zona horaria del destinatario](product-docs/email-marketing/email-programs/email-program-actions/scheduling-with-recipient-time-zone/abort-delivery-of-email-programs-scheduled-with-recipient-time-zone.md)
               + [Planificar programas de correo electrónico con zona horaria del destinatario](product-docs/email-marketing/email-programs/email-program-actions/scheduling-with-recipient-time-zone/schedule-email-programs-with-recipient-time-zone.md)
      ...
      + General {#general}
         ...
         + Nuevo diseñador de correo electrónico beta {#beta-new-email-designer}
            + {hide-from-toc}[Nueva descripción general del diseñador de correo electrónico (beta)](product-docs/email-marketing/general/beta-new-email-designer/overview.md)
            + {hide-from-toc}[Creación de correo electrónico](product-docs/email-marketing/general/beta-new-email-designer/email-authoring.md)
            + {hide-from-toc}[Plantillas de correo electrónico](product-docs/email-marketing/general/beta-new-email-designer/email-templates.md)
         + Creación de un correo electrónico {#creating-an-email}
            ...
            + [Enviar muestra de correo electrónico](product-docs/email-marketing/general/creating-an-email/send-a-sample-email.md)
         ...
         + Editor de correo electrónico 2 {#email-editor-2}
            ...
            + {hide-from-toc}[Transición al Editor de correo electrónico 2.0](product-docs/email-marketing/general/email-editor-2/transitioning-to-email-editor-2-0.md)
         + Funciones en el editor {#functions-in-the-editor}
            ...
            + [Uso del contenido dinámico en un correo electrónico](product-docs/email-marketing/general/functions-in-the-editor/using-dynamic-content-in-an-email.md)
            + [Añadir un fragmento a un correo electrónico.](product-docs/email-marketing/general/functions-in-the-editor/add-a-snippet-to-an-email.md)
            + [Añadir un vínculo Ver como página web a un correo electrónico](product-docs/email-marketing/general/functions-in-the-editor/add-a-view-as-web-page-link-to-an-email.md)
            ...
            + Pruebas de correo electrónico: campeón-aspirante {#email-tests-champion-challenger}
               ...
               + [Campeón/Aspirante: aprobar la prueba de correo electrónico](product-docs/email-marketing/general/functions-in-the-editor/email-tests-champion-challenger/champion-challenger-approve-your-email-test.md)
               + [Campeón/Aspirante: análisis](product-docs/email-marketing/general/functions-in-the-editor/email-tests-champion-challenger/champion-challenger-analytics.md)
               + [Campeón/Aspirante: declarar un campeón](product-docs/email-marketing/general/functions-in-the-editor/email-tests-champion-challenger/champion-challenger-declare-a-champion.md)
               + [Campeón/Aspirante: definir criterios de campeón](product-docs/email-marketing/general/functions-in-the-editor/email-tests-champion-challenger/champion-challenger-define-champion-criteria.md)
               + [Campeón/Aspirante: descartar una prueba de correo electrónico](product-docs/email-marketing/general/functions-in-the-editor/email-tests-champion-challenger/champion-challenger-discard-an-email-test.md)
   ...
   + Marketo Engage Modern UX {#marketo-engage-modern-ux}
      + [Información general](product-docs/marketo-engage-modern-ux/overview.md)
      + [Uso de la búsqueda global](product-docs/marketo-engage-modern-ux/using-the-global-search.md)
      + {hide-from-toc}[Conmutador de alternancia](product-docs/marketo-engage-modern-ux/toggle-switch.md)
   ...
   + Marketo Sales Connect {#marketo-sales-connect}
      ...
      + Administrador {#admin}
         ...
         + [Creación de un subequipo](product-docs/marketo-sales-connect/admin/create-a-sub-team.md)
      ...
      + Campañas {#campaigns}
         ...
         + [Quitar personas de una campaña](product-docs/marketo-sales-connect/campaigns/remove-people-from-a-campaign.md)
      ...
      + CRM {#crm}
         + Personalización de Salesforce {#salesforce-customization}
            ...
            + [Cómo conectar Sales Connect a su zona protegida de Salesforce](product-docs/marketo-sales-connect/crm/salesforce-customization/how-to-connect-sales-connect-to-your-salesforce-sandbox.md)
            ...
            + [Cómo instalar botones de Sales Connect en Salesforce](product-docs/marketo-sales-connect/crm/salesforce-customization/how-to-install-sales-connect-buttons-in-salesforce.md)
            ...
            + [Instalación de campos de eventos de Sales Connect en el historial de actividades](product-docs/marketo-sales-connect/crm/salesforce-customization/install-sales-connect-event-fields-on-activity-history.md)
            ...
            + [Paneles de control de sistemas de informes en Salesforce](product-docs/marketo-sales-connect/crm/salesforce-customization/reporting-dashboards-in-salesforce.md)
      ...
      + Complementos de correo electrónico {#email-plugins}
         + Gmail {#gmail}
            ...
            + [Conexión del correo electrónico para usuarios de Gmail](product-docs/marketo-sales-connect/email-plugins/gmail/email-connection-for-gmail-users.md)
            + [Gmail no inserta la firma de Sales Connect](product-docs/marketo-sales-connect/email-plugins/gmail/gmail-not-pulling-in-sales-connect-signature.md)
            + [Cómo añadir una plantilla](product-docs/marketo-sales-connect/email-plugins/gmail/how-to-add-a-template.md)
            + [Instalar el complemento de correo electrónico de Sales Connect para Gmail](product-docs/marketo-sales-connect/email-plugins/gmail/install-the-sales-connect-email-plugin-for-gmail.md)
            ...
            + [Cómo impedir que la dirección secundaria de Gmail se integre con Sales Connect](product-docs/marketo-sales-connect/email-plugins/gmail/preventing-secondary-gmail-address-from-integrating-with-sales-connect.md)
            ...
            + [Barra de herramientas de Sales Connect](product-docs/marketo-sales-connect/email-plugins/gmail/the-sales-connect-tool-bar.md)
      ...
      + Correo electrónico {#email}
         + Centro de comandos {#command-center}
            ...
            + [Columnas de correo electrónico y diseño de página del correo electrónico](product-docs/marketo-sales-connect/email/command-center/email-columns-and-email-page-layout.md)
         ...
         + Preguntas comunes sobre el seguimiento {#common-tracking-questions}
            ...
            + [Cómo configurar el seguimiento del dominio personalizado](product-docs/marketo-sales-connect/email/common-tracking-questions/how-to-set-up-custom-domain-tracking.md)
            + [Cómo seguir los archivos adjuntos del correo electrónico](product-docs/marketo-sales-connect/email/common-tracking-questions/how-to-track-your-email-attachments.md)
         ...
         + Cancelaciones de suscripción {#unsubscribes}
            ...
            + [Sincronizar cancelaciones de suscripción con Salesforce](product-docs/marketo-sales-connect/email/unsubscribes/syncing-unsubscribes-with-salesforce.md)
            + [Grupo de cancelación de suscripción](product-docs/marketo-sales-connect/email/unsubscribes/unsubscribe-group.md)
         ...
         + Usar la ventana de composición {#using-the-compose-window}
            ...
            + [Redactar correos electrónicos masivos con selección y envío](product-docs/marketo-sales-connect/email/using-the-compose-window/composing-bulk-emails-with-select-and-send.md)
            + [Programar un correo electrónico](product-docs/marketo-sales-connect/email/using-the-compose-window/scheduling-an-email.md)
      ...
      + Preguntas frecuentes {#faq}
         ...
         + [No puedo acceder a mi cuenta. ¿Qué debo hacer?](product-docs/marketo-sales-connect/faq/i-got-locked-out-of-my-account-what-do-i-do.md)
      ...
      + Personas {#people}
         ...
         + Administrar contactos {#managing-contacts}
            ...
            + [Cómo gestiona Sales Connect la eliminación de duplicados de correo electrónico](product-docs/marketo-sales-connect/people/managing-contacts/how-sales-connect-handles-email-de-duping.md)
      ...
      + Teléfono {#phone}
         ...
         + [No se ha registrado en el historial de actividades](product-docs/marketo-sales-connect/phone/didnt-log-to-activity-history.md)
         + [No se ha registrado en Salesforce](product-docs/marketo-sales-connect/phone/didnt-log-to-salesforce.md)
         + [Habilitar la grabación de llamadas](product-docs/marketo-sales-connect/phone/enable-call-recording.md)
         + [Registrar los motivos de la llamada y los resultados de la llamada en Salesforce](product-docs/marketo-sales-connect/phone/log-call-reasons-and-call-outcomes-to-salesforce.md)
         + [Llamadas internacionales del teléfono de ventas](product-docs/marketo-sales-connect/phone/sales-phone-international-calling.md)
   ...
   + Marketo Sales Insight {#marketo-sales-insight}
      + Acciones {#actions}
         ...
         + Administrador {#admin}
            ...
            + [Bloqueo del contenido](product-docs/marketo-sales-insight/actions/admin/content-lockdown.md)
            + [Crear un equipo](product-docs/marketo-sales-insight/actions/admin/creating-a-team.md)
            + [Cómo configurar el seguimiento del dominio personalizado](product-docs/marketo-sales-insight/actions/admin/how-to-set-up-custom-domain-tracking.md)
            + [Invitar a usuarios y administradores](product-docs/marketo-sales-insight/actions/admin/invite-users-and-admins.md)
            + [Configurar administración de inicio de sesión](product-docs/marketo-sales-insight/actions/admin/login-management-settings.md)
         ...
         + Campañas {#campaigns}
            ...
            + [Configuración de la campaña de ventas](product-docs/marketo-sales-insight/actions/campaigns/sales-campaign-settings.md)
         ...
         + CRM {#crm}
            ...
            + Integración de Salesforce {#salesforce-integration}
               ...
               + {hide-from-toc}[Registro de respuestas](product-docs/marketo-sales-insight/actions/crm/salesforce-integration/reply-logging.md)
         ...
         + Preguntas frecuentes {#faq}
            ...
            + {hide-from-toc}[¿Es compatible Sales Insight Actions con Salesforce Lightning?](product-docs/marketo-sales-insight/actions/faq/is-sales-insight-actions-compatible-with-salesforce-lightning.md)
         ...
         + Teléfono {#phone}
            ...
            + [Habilitar la grabación de llamadas](product-docs/marketo-sales-insight/actions/phone/enable-call-recording.md)
         ...
         + Plantillas {#templates}
            ...
            + {hide-from-toc}[Administrar categorías de plantilla](product-docs/marketo-sales-insight/actions/templates/manage-template-categories.md)
            ...
            + {hide-from-toc}[Ver lista de plantillas como otro usuario](product-docs/marketo-sales-insight/actions/templates/view-template-list-as-another-user.md)
      + Usar MSI {#using-msi}
      ...
      + MSI para Microsoft Dynamics {#msi-for-microsoft-dynamics}
         ...
         + Instalando {#installing}
            + [Descargar la solución Marketo Sales Insight para Microsoft Dynamics](product-docs/marketo-sales-insight/msi-for-microsoft-dynamics/installing/download-the-marketo-sales-insight-solution-for-microsoft-dynamics.md)
         ...
         + Configuración y uso {#setting-up-and-using}
            + [Añadir un posible cliente o contacto a una campaña de Marketo desde Microsoft Dynamics](product-docs/marketo-sales-insight/msi-for-microsoft-dynamics/setting-up-and-using/add-a-lead-contact-to-a-marketo-campaign-from-microsoft-dynamics.md)
            ...
            + [Configuración de estrellas y llamas para registros de posibles clientes o contactos](product-docs/marketo-sales-insight/msi-for-microsoft-dynamics/setting-up-and-using/setting-up-stars-and-flames-for-lead-contact-records.md)
         + Desinstalación {#uninstalling}
            + [Deshabilitar la sincronización global de MS Dynamics](product-docs/marketo-sales-insight/msi-for-microsoft-dynamics/uninstalling/disable-global-ms-dynamics-sync.md)
         ...
         + Actualizando {#updating}
            + [Actualizar la solución Marketo Sales Insight para Microsoft Dynamics](product-docs/marketo-sales-insight/msi-for-microsoft-dynamics/updating/upgrade-the-marketo-sales-insight-solution-for-microsoft-dynamics.md)
      + MSI para Salesforce {#msi-for-salesforce}
         + Instalación {#installation}
            + [Instalación del paquete de Marketo Sales Insight en Salesforce AppExchange](product-docs/marketo-sales-insight/msi-for-salesforce/installation/install-marketo-sales-insight-package-in-salesforce-appexchange.md)
         + Configuración {#configuration}
            + [Configuración de Marketo Sales Insight en Salesforce para empresas y sin límites](product-docs/marketo-sales-insight/msi-for-salesforce/configuration/configure-marketo-sales-insight-in-salesforce-enterprise-unlimited.md)
            + [Configuración de Marketo Sales Insight en Salesforce Edición profesional](product-docs/marketo-sales-insight/msi-for-salesforce/configuration/configure-marketo-sales-insight-in-salesforce-professional-edition.md)
         ...
         + MSI para dispositivos móviles {#msi-for-mobile}
            ...
            + [Enviar correo electrónico y acciones de campaña y lista de observación de Marketo en Salesforce1](product-docs/marketo-sales-insight/msi-for-salesforce/msi-for-mobile/send-marketo-email-and-campaign-and-watchlist-actions-in-salesforce1.md)
         + Actualizando {#upgrading}
            + [Actualizando el paquete MSI](product-docs/marketo-sales-insight/msi-for-salesforce/upgrading/upgrading-your-msi-package.md)
      + Complemento de MSI Outlook {#msi-outlook-plugin}
         ...
         + [Instalar el complemento de Marketo para Outlook con una clave de empresa](product-docs/marketo-sales-insight/msi-outlook-plugin/install-the-marketo-add-in-for-outlook-with-an-enterprise-key.md)
         + [Instalar el complemento de correo electrónico de Marketo para Outlook con un código de registro](product-docs/marketo-sales-insight/msi-outlook-plugin/install-the-marketo-email-add-in-for-outlook-with-a-registration-code.md)
         ...
         + [Instalación del complemento de Marketo Outlook por parte del TI](product-docs/marketo-sales-insight/msi-outlook-plugin/marketo-outlook-plugin-installation-by-it.md)
         + [Desinstalación del complemento de Marketo Outlook por parte del TI](product-docs/marketo-sales-insight/msi-outlook-plugin/marketo-outlook-plugin-uninstall-by-it.md)
         + [Enviar y hacer seguimiento de un correo electrónico con el complemento de correo electrónico para Outlook](product-docs/marketo-sales-insight/msi-outlook-plugin/send-and-track-an-email-with-the-email-add-in-for-outlook.md)
   ...
   + Marketing móvil {#mobile-marketing}
      + Administrador {#admin}
         ...
         + [Configurar el acceso push de Android para aplicaciones móviles](product-docs/mobile-marketing/admin/configure-mobile-app-android-push-access.md)
         + [Configurar el acceso push de iOS para aplicaciones móviles](product-docs/mobile-marketing/admin/configure-mobile-app-ios-push-access.md)
         + [Eliminar la aplicación móvil](product-docs/mobile-marketing/admin/delete-mobile-app.md)
         + [Enviar código SDK a un desarrollador](product-docs/mobile-marketing/admin/send-sdk-code-to-a-developer.md)
         + [Verificar la configuración de mensajes push](product-docs/mobile-marketing/admin/verify-push-configuration.md)
      + Mensajes en la aplicación {#in-app-messages}
         ...
         + Crear mensajes en la aplicación {#creating-in-app-messages}
            ...
            + [Añadir imágenes de mensaje en la aplicación](product-docs/mobile-marketing/in-app-messages/creating-in-app-messages/add-in-app-message-images.md)
            + [Elegir un diseño para el mensaje en la aplicación](product-docs/mobile-marketing/in-app-messages/creating-in-app-messages/choose-a-layout-for-your-in-app-message.md)
            + [Crear un texto de mensaje en la aplicación](product-docs/mobile-marketing/in-app-messages/creating-in-app-messages/create-in-app-message-text.md)
            + [Establecer el botón Descartar y Aprobar el mensaje](product-docs/mobile-marketing/in-app-messages/creating-in-app-messages/set-up-the-dismiss-button-and-approve-the-message.md)
            + [Establecer el fondo del mensaje en la aplicación](product-docs/mobile-marketing/in-app-messages/creating-in-app-messages/set-up-the-in-app-message-background.md)
            + [Establecer el botón Mensaje en la aplicación](product-docs/mobile-marketing/in-app-messages/creating-in-app-messages/set-up-the-in-app-message-button.md)
         + Enviar el mensaje en la aplicación {#sending-your-in-app-message}
            + [Envíe el mensaje en la aplicación](product-docs/mobile-marketing/in-app-messages/sending-your-in-app-message/send-your-in-app-message.md)
            ...
            + [Previsualizar el mensaje en la aplicación](product-docs/mobile-marketing/in-app-messages/sending-your-in-app-message/select-your-in-app-message.md)
            + [Establecer la audiencia del mensaje en la aplicación](product-docs/mobile-marketing/in-app-messages/sending-your-in-app-message/set-your-in-app-message-audience.md)
      + Notificaciones push {#push-notifications}
         ...
         + [Configurar notificación push para dispositivos móviles](product-docs/mobile-marketing/push-notifications/configure-mobile-push-notification.md)
         + [Crear una notificación push](product-docs/mobile-marketing/push-notifications/create-a-push-notification.md)
         + [Eliminar notificación push para dispositivos móviles](product-docs/mobile-marketing/push-notifications/delete-mobile-push-notification.md)
         + [Editar notificación push para dispositivos móviles](product-docs/mobile-marketing/push-notifications/edit-mobile-push-notification.md)
         + [Previsualizar una notificación push](product-docs/mobile-marketing/push-notifications/preview-a-push-notification.md)
         + [Enviar una notificación push para dispositivos móviles](product-docs/mobile-marketing/push-notifications/send-a-mobile-push-notification.md)
         ...
         + [Entender las notificaciones push](product-docs/mobile-marketing/push-notifications/understanding-push-notifications.md)
         + [Ver el tablero de notificaciones push](product-docs/mobile-marketing/push-notifications/view-the-push-notification-dashboard.md)
      + Mensajes SMS de Vibes {#vibes-sms-messages}
         + [Crear un mensaje SMS](product-docs/mobile-marketing/vibes-sms-messages/create-an-sms-message.md)
         + [Enviar un mensaje SMS](product-docs/mobile-marketing/vibes-sms-messages/send-an-sms-message.md)
         + [Usar opciones de SMS en una campaña inteligente](product-docs/mobile-marketing/vibes-sms-messages/using-sms-options-in-a-smart-campaign.md)
         + [Sistema de informes de SMS](product-docs/mobile-marketing/vibes-sms-messages/sms-reporting.md)
   ...
   + Personalización {#personalization}
      + Segmentación y fragmentos {#segmentation-and-snippets}
         + Segmentación {#segmentation}
            ...
            + [Definir reglas de segmento](product-docs/personalization/segmentation-and-snippets/segmentation/define-segment-rules.md)
            ...
            + [Agrupar informes de correo electrónico por segmentaciones](product-docs/personalization/segmentation-and-snippets/segmentation/group-email-reports-by-segmentations.md)
         ...
         + Fragmentos {#snippets}
            ...
            + [Editar fragmentos de código con contenido dinámico](product-docs/personalization/segmentation-and-snippets/snippets/edit-snippets-with-dynamic-content.md)
            + [Vista previa de un fragmento](product-docs/personalization/segmentation-and-snippets/snippets/preview-a-snippet.md)
            + [No aprobar un fragmento](product-docs/personalization/segmentation-and-snippets/snippets/unapprove-a-snippet.md)
   + Contenido predictivo {#predictive-content}
      ...
      + Cómo trabajar con todo el contenido {#working-with-all-content}
         + [Comprensión de todo el contenido](product-docs/predictive-content/working-with-all-content/understanding-all-content.md)
         + [Añadir nuevo contenido](product-docs/predictive-content/working-with-all-content/add-new-content.md)
         + [Aprobar un título para el contenido predictivo](product-docs/predictive-content/working-with-all-content/approve-a-title-for-predictive-content.md)
         ...
         + [No aprobar un título para el contenido predictivo](product-docs/predictive-content/working-with-all-content/unapprove-a-title-for-predictive-content.md)
      + Habilitación del contenido predictivo {#enabling-predictive-content}
         + [Habilitar el contenido predictivo para medios enriquecidos web](product-docs/predictive-content/enabling-predictive-content/enable-predictive-content-for-web-rich-media.md)
         + [Habilitar el contenido predictivo en correos electrónicos](product-docs/predictive-content/enabling-predictive-content/enable-predictive-content-in-emails.md)
      ...
      + Cómo trabajar con el contenido predictivo {#working-with-predictive-content}
         + [Comprensión del contenido predictivo](product-docs/predictive-content/working-with-predictive-content/understanding-predictive-content.md)
   ...
   + Sistema de informes {#reporting}
      ...
      + Sistemas de informes básicos {#basic-reporting}
         + Creación de informes {#creating-reports}
            ...
            + [Navegación por la página principal de análisis](product-docs/reporting/basic-reporting/creating-reports/navigating-the-analytics-home-page.md)
            ...
            + [Explicación de Mis informes y los informes de grupo](product-docs/reporting/basic-reporting/creating-reports/understanding-my-reports-and-group-reports.md)
         + Edición de informes {#editing-reports}
            + [Añadir columnas personalizadas al informe de una persona](product-docs/reporting/basic-reporting/editing-reports/add-custom-columns-to-a-person-report.md)
            + [Añadir columnas de oportunidad a un informe de posible cliente](product-docs/reporting/basic-reporting/editing-reports/add-opportunity-columns-to-a-lead-report.md)
            + [Cambiar el lapso de tiempo de un informe](product-docs/reporting/basic-reporting/editing-reports/change-a-report-time-frame.md)
         ...
         + Informe de actividad {#report-activity}
            ...
            + [Cambiar la caducidad de las direcciones URL en los correos electrónicos del informe](product-docs/reporting/basic-reporting/report-activity/change-the-expiration-time-for-urls-in-report-emails.md)
            + [Clonar un informe en informes de grupo](product-docs/reporting/basic-reporting/report-activity/clone-a-report-to-group-reports.md)
            ...
            + [Filtrar recursos en informes por correo electrónico de campaña](product-docs/reporting/basic-reporting/report-activity/filter-assets-in-a-campaign-email-reports.md)
            + [Filtrar recursos en un informe por correo electrónico](product-docs/reporting/basic-reporting/report-activity/filter-assets-in-an-email-report.md)
            + [Filtrar registros eliminados o combinados en un informe de rendimiento por correo electrónico](product-docs/reporting/basic-reporting/report-activity/filter-deleted-merged-records-email-performance-report.md)
            ...
            + [Informar sobre el correo electrónico, el rendimiento de la campaña en espacios de trabajo](product-docs/reporting/basic-reporting/report-activity/report-email-campaign-performance-across-workspaces.md)
            + [Compartir un modelo en varios espacios de trabajo](product-docs/reporting/basic-reporting/report-activity/share-a-model-across-workspaces.md)
            + [Seguimiento de actividades anónimas y personas](product-docs/reporting/basic-reporting/report-activity/tracking-anonymous-activity-and-people.md)
         + Informe de suscripciones {#report-subscriptions}
            ...
            + [Proteger la configuración de administración de suscripción](product-docs/reporting/basic-reporting/report-subscriptions/secure-the-subscription-admin-setting.md)
            + [Suscribirse a un informe básico](product-docs/reporting/basic-reporting/report-subscriptions/subscribe-to-a-basic-report.md)
            + [Suscribirse a una lista inteligente](product-docs/reporting/basic-reporting/report-subscriptions/subscribe-to-a-smart-list.md)
         + Tipos de informes {#report-types}
            + [Informe de actividad de campaña](product-docs/reporting/basic-reporting/report-types/campaign-activity-report.md)
            + [Informe de rendimiento de correos electrónicos de la campaña](product-docs/reporting/basic-reporting/report-types/campaign-email-performance-report.md)
            + [Informe de la actividad en la web de la compañía](product-docs/reporting/basic-reporting/report-types/company-web-activity-report.md)
            + [Informe de personas por estado](product-docs/reporting/basic-reporting/report-types/people-by-status-report.md)
            ...
            + [Páginas web vistas, informe de actividad de la página web](product-docs/reporting/basic-reporting/report-types/web-page-activity-report/web-pages-viewed-web-page-activity-report.md)
      + Información del correo electrónico {#email-insights}
         + [Información general de perspectivas del correo electrónico](product-docs/reporting/email-insights/email-insights-overview.md)
         ...
         + [Información general de Analytics de perspectivas de correo electrónico](product-docs/reporting/email-insights/email-insights-analytics-overview.md)
         + [Preguntas frecuentes sobre perspectivas de correo electrónico](product-docs/reporting/email-insights/email-insights-faq.md)
         ...
         + [Información general sobre envíos de perspectivas de correo electrónico](product-docs/reporting/email-insights/email-insights-sends-overview.md)
         + [Filtrar en perspectivas de correo electrónico](product-docs/reporting/email-insights/filtering-in-email-insights.md)
      + Perspectivas de rendimiento {#performance-insights}
         ...
         + [Filtrar en perspectivas de rendimiento](product-docs/reporting/performance-insights/filtering-in-performance-insights.md)
         + [Información general sobre contribución de perspectivas de rendimiento](product-docs/reporting/performance-insights/performance-insights-contribution-overview.md)
         ...
         + [Información general de tendencias de perspectivas de rendimiento](product-docs/reporting/performance-insights/performance-insights-trend-overview.md)
      ...
      + Análisis del ciclo de ingresos {#revenue-cycle-analytics}
         + Análisis de correo electrónico {#email-analysis}
            ...
            + [Creación de un informe de análisis de correo electrónico que muestre información del programa](product-docs/reporting/revenue-cycle-analytics/email-analysis/build-an-email-analysis-report-that-shows-program-information.md)
         ...
         + Analizador de influencia de la oportunidad {#opportunity-influence-analyzer}
            + [Explicación del analizador de influencia de la oportunidad](product-docs/reporting/revenue-cycle-analytics/opportunity-influence-analyzer/understanding-the-opportunity-influence-analyzer.md)
            + [Configurar un analizador de influencia de la oportunidad](product-docs/reporting/revenue-cycle-analytics/opportunity-influence-analyzer/configure-an-opportunity-influence-analyzer.md)
            + [Crear un analizador de influencia de la oportunidad](product-docs/reporting/revenue-cycle-analytics/opportunity-influence-analyzer/create-an-opportunity-influence-analyzer.md)
            + [Exportar datos del analizador de influencia de la oportunidad](product-docs/reporting/revenue-cycle-analytics/opportunity-influence-analyzer/export-opportunity-influence-analyzer-data.md)
            + [Contar la historia de marketing con un analizador de influencia de la oportunidad](product-docs/reporting/revenue-cycle-analytics/opportunity-influence-analyzer/tell-the-marketing-story-with-an-opportunity-influence-analyzer.md)
         + Análisis del programa {#program-analytics}
            + [Información general sobre el sistema de informes avanzado de programas](product-docs/reporting/revenue-cycle-analytics/program-analytics/advanced-program-reporting-overview.md)
            + [Creación de un informe de análisis de abonos al programa que enumere los posibles clientes](product-docs/reporting/revenue-cycle-analytics/program-analytics/build-a-program-membership-analysis-report-that-lists-leads.md)
            ...
            + [Crear un programa sin un coste de período disponible en el explorador de ingresos y en los analizadores](product-docs/reporting/revenue-cycle-analytics/program-analytics/make-a-program-without-a-period-cost-available-in-revenue-explorer-and-analyzers.md)
            + [Anular el comportamiento de análisis a nivel de programa](product-docs/reporting/revenue-cycle-analytics/program-analytics/override-analytics-behavior-at-the-program-level.md)
            ...
            + [Explicación del área de análisis de miembros del programa](product-docs/reporting/revenue-cycle-analytics/program-analytics/understanding-the-program-membership-analysis-area.md)
            ...
            + [Explicación del área de análisis de la fase de ingresos del programa](product-docs/reporting/revenue-cycle-analytics/program-analytics/understanding-the-program-revenue-stage-analysis-area.md)
         + Modelos del ciclo de ingresos {#revenue-cycle-models}
            + [Aprobar/no aprobar un modelo de ingresos](product-docs/reporting/revenue-cycle-analytics/revenue-cycle-models/approve-unapprove-a-revenue-model.md)
            ...
            + [Iniciar el seguimiento por la cuenta en el modelador de ingresos](product-docs/reporting/revenue-cycle-analytics/revenue-cycle-models/start-tracking-by-account-in-the-revenue-modeler.md)
            ...
            + [Uso de fases de puerta del modelo de ingresos](product-docs/reporting/revenue-cycle-analytics/revenue-cycle-models/using-revenue-model-gate-stages.md)
            + [Uso de fases de inventario del modelo de ingresos](product-docs/reporting/revenue-cycle-analytics/revenue-cycle-models/using-revenue-model-inventory-stages.md)
            + [Uso de fases de SLA del modelo de ingresos](product-docs/reporting/revenue-cycle-analytics/revenue-cycle-models/using-revenue-model-sla-stages.md)
         ...
         + Explorador de ingresos {#revenue-explorer}
            + [Adición de medidas personalizadas a un informe de explorador de ingresos](product-docs/reporting/revenue-cycle-analytics/revenue-explorer/adding-custom-measures-to-a-revenue-explorer-report.md)
            + [Adición de campos a un informe de explorador de ingresos](product-docs/reporting/revenue-cycle-analytics/revenue-explorer/adding-fields-to-a-revenue-explorer-report.md)
            + [Crear un informe de explorador de ingresos](product-docs/reporting/revenue-cycle-analytics/revenue-explorer/create-a-revenue-explorer-report.md)
            ...
            + [Exportación de un informe de explorador de ingresos](product-docs/reporting/revenue-cycle-analytics/revenue-explorer/exporting-a-revenue-explorer-report.md)
            ...
            + [Tipos de informe del explorador de ingresos](product-docs/reporting/revenue-cycle-analytics/revenue-explorer/revenue-explorer-report-types.md)
            ...
            + [Suscribirse a un informe del explorador de ingresos](product-docs/reporting/revenue-cycle-analytics/revenue-explorer/subscribe-to-a-revenue-explorer-report.md)
         ...
         + Herramientas de ingresos {#revenue-tools}
            + [Definir costes del período](product-docs/reporting/revenue-cycle-analytics/revenue-tools/define-period-costs.md)
            + [Habilitar la sincronización de campos personalizados para el análisis del ciclo de ingresos](product-docs/reporting/revenue-cycle-analytics/revenue-tools/enabling-custom-field-sync-for-revenue-cycle-analytics.md)
            + [Informe de personas por fase de ingresos](product-docs/reporting/revenue-cycle-analytics/revenue-tools/people-by-revenue-stage-report.md)
      ...
      + Análisis avanzados de BI {#advanced-bi-analytics}
   ...
   + Administración de cuentas objetivo {#target-account-management}
      + Configuración {#setup}
         ...
         + [Ajustes del equipo de cuentas](product-docs/target-account-management/setup-tam/account-team-setup.md)
         ...
         + [Configurar los datos de la cuenta](product-docs/target-account-management/setup-tam/set-up-account-insight.md)
         + [Información general del complemento de datos de la cuenta](product-docs/target-account-management/setup-tam/account-insight-plug-in-overview.md)
         + [Invitar a usuarios a acceder a los datos de cuenta](product-docs/target-account-management/setup-tam/invite-users-to-access-account-insight.md)
      + Objetivo {#target}
         + Cuentas nombradas {#named-accounts}
            + [Información general de cuenta nombrada](product-docs/target-account-management/target/named-accounts/named-account-overview.md)
            + [Importar cuentas nombradas](product-docs/target-account-management/target/named-accounts/import-named-accounts.md)
            + [Añadir una cuenta con nombre existente a una lista de cuentas](product-docs/target-account-management/target/named-accounts/add-an-existing-named-account-to-an-account-list.md)
            + [Crear una cuenta nombrada](product-docs/target-account-management/target/named-accounts/create-a-named-account.md)
            + [Añadir personas a una cuenta nombrada](product-docs/target-account-management/target/named-accounts/add-people-to-a-named-account.md)
            + [Cuentas de Discover](product-docs/target-account-management/target/named-accounts/discover-accounts.md)
            ...
            + [Jerarquías de TAM](product-docs/target-account-management/target/named-accounts/tam-hierarchies.md)
         ...
         + [Creación de un público de cuentas coincidentes en LinkedIn](product-docs/target-account-management/target/create-an-account-matched-audience-on-linkedin.md)
      + Participación {#engage}
         + [Filtros de cuenta](product-docs/target-account-management/engage/account-filters.md)
         + [Activadores de la cuenta](product-docs/target-account-management/engage/account-triggers.md)
      + Medida {#measure}
         + [Panel de control principal de TAM](product-docs/target-account-management/measure/tam-main-dashboard.md)
         + [Configuración de informes TAM](product-docs/target-account-management/measure/tam-report-setup.md)
         + [Informe de ventas de TAM](product-docs/target-account-management/measure/tam-sales-report.md)
         + [Información sobre la lista de cuentas](product-docs/target-account-management/measure/account-list-insights.md)
         + [Dimensión de la cuenta con nombre en RCA](product-docs/target-account-management/measure/named-account-dimension-in-rca.md)
         + [Información sobre la cuenta con nombre](product-docs/target-account-management/measure/named-account-insights.md)
         + [Uso de personas](product-docs/target-account-management/using-personas.md)
      + Perfil de cuenta {#account-profiling}
         + [Configuración del perfil de cuenta](product-docs/target-account-management/account-profiling/setting-up-account-profiling.md)
         + [Clasificación y ajuste del perfil de cuenta](product-docs/target-account-management/account-profiling/account-profiling-ranking-and-tuning.md)
         + [Detección de nuevas cuentas](product-docs/target-account-management/account-profiling/new-account-discovery.md)
   + Personalización web {#web-personalization}
      ...
      + Introducción {#getting-started}
         ...
         + [Configuración de la personalización web para no realizar el seguimiento](product-docs/web-personalization/getting-started/setting-web-personalization-to-do-not-track.md)
         + [Configuración de usuario](product-docs/web-personalization/getting-started/user-settings.md)
         + [Espacios de trabajo en la personalización web](product-docs/web-personalization/getting-started/workspaces-in-web-personalization.md)
      + Implementación de etiquetas RTP {#rtp-tag-implementation}
         + [Implementación de JavaScript RTP](product-docs/web-personalization/rtp-tag-implementation/deploy-the-rtp-javascript.md)
         ...
         + [Implementación de RTP mediante Tealium Tag Manager](product-docs/web-personalization/rtp-tag-implementation/implementing-rtp-using-tealium-tag-manager.md)
      + Sistema de informes para la personalización web {#reporting-for-web-personalization}
         ...
         + [Explicación del sistema de informes](product-docs/web-personalization/reporting-for-web-personalization/understanding-the-summary-report.md)
         + Integraciones de análisis web {#web-analytics-integrations}
            + [Paneles de control RTP personalizados en Google Universal Analytics](product-docs/web-personalization/reporting-for-web-personalization/web-analytics-integrations/custom-rtp-dashboards-in-google-universal-analytics.md)
            + [Informes de RTP personalizados en Google Universal Analytics](product-docs/web-personalization/reporting-for-web-personalization/web-analytics-integrations/custom-rtp-reports-in-google-universal-analytics.md)
      ...
      + Explicación de la personalización web {#understanding-web-personalization}
         + [Explicación del análisis de contenido](product-docs/web-personalization/understanding-web-personalization/understanding-content-analytics.md)
         ...
         + [Información general de la personalización web](product-docs/web-personalization/understanding-web-personalization/web-personalization-overview.md)
      + Uso de plantillas {#using-templates}
         + [Guardar la campaña como una plantilla](product-docs/web-personalization/using-templates/save-your-campaign-as-a-template.md)
      ...
      + Uso de segmentos web {#using-web-segments}
         ...
         + [Creación de un segmento mediante una lista estática](product-docs/web-personalization/using-web-segments/create-a-segment-using-a-static-list.md)
         + [Creación de un segmento mediante datos de personas conocidas](product-docs/web-personalization/using-web-segments/create-a-segment-using-known-person-data.md)
         + [Búsqueda de campañas web que utilicen un segmento específico](product-docs/web-personalization/using-web-segments/find-web-campaigns-that-are-using-a-specific-segment.md)
         ...
         + [Ver segmentos de una etiqueta específica](product-docs/web-personalization/using-web-segments/view-segments-from-a-specific-label.md)
      ...
      + Resegmentación de sitios web {#website-retargeting}
         ...
         + [Resegmentación con datos de personalización web](product-docs/web-personalization/website-retargeting/retargeting-with-web-personalization-data.md)
      + Cómo trabajar con campañas web {#working-with-web-campaigns}
         + [Realización de la prueba AB para la campaña web](product-docs/web-personalization/working-with-web-campaigns/ab-test-your-web-campaign.md)
         ...
         + [Archivado de una campaña web](product-docs/web-personalization/working-with-web-campaigns/archive-a-web-campaign.md)
         + [Clonación de una campaña web](product-docs/web-personalization/working-with-web-campaigns/clone-a-web-campaign.md)
         ...
         + [Definición de una lista inteligente para actividades de personalización web](product-docs/web-personalization/working-with-web-campaigns/define-a-smart-list-for-web-personalization-activities.md)
         + [Eliminación de una campaña web](product-docs/web-personalization/working-with-web-campaigns/delete-a-web-campaign.md)
         + [Edición de una campaña web existente](product-docs/web-personalization/working-with-web-campaigns/edit-an-existing-web-campaign.md)
         + [Incrustación de un formulario en una campaña web](product-docs/web-personalization/working-with-web-campaigns/embed-a-form-into-a-web-campaign.md)
         ...
         + [Etiquetar las campañas web](product-docs/web-personalization/working-with-web-campaigns/label-your-web-campaigns.md)
         + [Iniciar/poner en pausa una campaña web](product-docs/web-personalization/working-with-web-campaigns/launch-pause-a-web-campaign.md)
         ...
         + [Programación de una campaña web](product-docs/web-personalization/working-with-web-campaigns/schedule-a-web-campaign.md)
         + [Definir la forma en que se muestra la campaña web](product-docs/web-personalization/working-with-web-campaigns/set-how-your-web-campaign-displays.md)
         + [Ordenar campañas web por la fecha o el rendimiento](product-docs/web-personalization/working-with-web-campaigns/sort-web-campaigns-by-latest-or-top-performing.md)
         + [Uso del editor de texto enriquecido de la personalización web](product-docs/web-personalization/working-with-web-campaigns/using-the-web-personalization-rich-text-editor.md)
         + [Visualización de campañas web de una etiqueta específica](product-docs/web-personalization/working-with-web-campaigns/view-web-campaigns-from-a-specific-label.md)
+ Notas de la versión {#release-notes}
   + [Programación de versiones](release-notes/release-schedule.md)
   + [Versión actual](release-notes/current.md)
   + {hide-from-toc}[TEMP. de versión actual](release-notes/current-temp.md)
   + [Versión de Dynamic Chat](release-notes/dynamic-chat.md)
   + {hide-from-toc}[TEMP. de versión de Dynamic Chat](release-notes/dynamic-chat-temp.md)
   + Versiones anteriores {#previous-releases}
      ...
      + 2025 {#2025}
         ...
         + [Notas de la versión: 25 de octubre](release-notes/previous-releases/2025/release-notes-oct-25.md)
      + 2024 {#2024}
         ...
         + [Notas de la versión: junio de 2024](release-notes/previous-releases/2024/release-notes-june-24.md)
         + [Notas de la versión: julio de 2024](release-notes/previous-releases/2024/release-notes-july-24.md)
         + [Notas de la versión: octubre de 2024](release-notes/previous-releases/2024/release-notes-oct-24.md)
      + 2023 {#2023}
         ...
         + [Notas de la versión: septiembre de 2023](release-notes/previous-releases/2023/release-notes-sep-23.md)
         + [Notas de la versión: octubre de 2023](release-notes/previous-releases/2023/release-notes-oct-23.md)
      + 2022 {#2022}
         + [Notas de la versión: enero de 2022](release-notes/previous-releases/2022/release-notes-jan-22.md)
         ...
         + [Notas de la versión: junio de 2022](release-notes/previous-releases/2022/release-notes-june-22.md)
         + [Notas de la versión: agosto de 2022](release-notes/previous-releases/2022/release-notes-aug-22.md)
         + [Notas de la versión: octubre de 2022](release-notes/previous-releases/2022/release-notes-oct-22.md)
      + 2021 {#2021}
         ...
         + [Notas de la versión: octubre de 2021](release-notes/previous-releases/2021/release-notes-oct-21.md)
      + 2020 {#2020}
         + [Notas de la versión: enero de 2020](release-notes/previous-releases/2020/release-notes-jan-20.md)
         + [Notas de la versión: febrero de 2020](release-notes/previous-releases/2020/release-notes-feb-20.md)
         + [Notas de la versión: junio de 2020](release-notes/previous-releases/2020/release-notes-june-20.md)
         + [Notas de la versión: julio de 2020](release-notes/previous-releases/2020/release-notes-july-20.md)
         + [Notas de la versión: mayo de 2020](release-notes/previous-releases/2020/release-notes-oct-20.md)
      + 2019 {#2019}
      ...
      + 2017 {#2017}
         + [Notas de la versión: mejoras de ABM de abril de 2017](release-notes/previous-releases/2017/release-notes-april-17-abm-enhancements.md)
         + [Notas de la versión: mejoras de ABM de agosto de 2017](release-notes/previous-releases/2017/release-notes-august-17-abm-enhancements.md)
      ...
      + 2012 {#2012}
         ...
         + [Notas de la versión: enero/febrero de 2012](release-notes/previous-releases/2012/release-notes-jan-feb-2012.md)
