...
+ Documentos del producto {#product-docs}
   ...
   + Marketo Sales Connect {#marketo-sales-connect}
      ...
      + FAQ {#faq}
         ...
         + [¿Con Qué Exploradores Son Compatibles Las Acciones De Perspectiva De Ventas?](product-docs/marketo-sales-connect/faq/which-browsers-does-sales-insight-actions-support.md)
   ...
   + Perspectiva de ventas de Marketo {#marketo-sales-insight}
      + Acciones {#actions}
         ...
         + Integraciones {#integrations}
            + [Registro de correos electrónicos en una fuente externa](product-docs/marketo-sales-insight/actions/integrations/log-emails-to-an-external-source.md)
         + Marketo {#marketo}
