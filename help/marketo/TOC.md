...
+ Documentos del producto {#product-docs}
   ...
   + Conceptos principales de Marketo {#core-marketo-concepts}
      ...
      + No son Recorridos {#not-journeys}
         + [Resumen de nombres](product-docs/core-marketo-concepts/not-journeys/name-overview.md)
         + [Ficha Nombre](product-docs/core-marketo-concepts/not-journeys/name-tab.md)
         + [Pestaña Configuración](product-docs/core-marketo-concepts/not-journeys/settings-tab.md)
   ...
   + Perspectiva de ventas de Marketo {#marketo-sales-insight}
      + Acciones {#actions}
         ...
         + Integraciones de correo electrónico {#email-integrations}
            ...
            + Outlook {#outlook}
               + [Conectar con Outlook](product-docs/marketo-sales-insight/actions/email-integrations/outlook/connect-to-outlook.md)
         + Preguntas frecuentes {#faq}
