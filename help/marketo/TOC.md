...
+ Documentos de producto {#product-docs}
   ...
   + Administración {#administration}
      ...
      + Administración de campos {#field-management}
         ...
         + [Cambiar el tipo de un campo personalizado Marketo](product-docs/administration/field-management/change-the-type-of-a-marketo-custom-field.md)
      ...
      + Marketing a actividades personalizadas {#marketo-custom-activities}
         ...
         + [Agregar, editar o eliminar un marcador a campos de actividad personalizados](product-docs/administration/marketo-custom-activities/add-edit-delete-marketo-custom-activity-fields.md)
      ...
      + Marketo Custom Objects {#marketo-custom-objects}
         + [Explicación de Marketo Custom Objects](product-docs/administration/marketo-custom-objects/understanding-marketo-custom-objects.md)
         + [Agregar marcador a campos de objeto personalizados](product-docs/administration/marketo-custom-objects/add-marketo-custom-object-fields.md)
         + [Agregar Marketo A Campos De Vínculo De Objeto Personalizado](product-docs/administration/marketo-custom-objects/add-marketo-custom-object-link-fields.md)
         + [Aprobar un objeto personalizado](product-docs/administration/marketo-custom-objects/approve-a-custom-object.md)
         + [Crear Marketo con objetos personalizados](product-docs/administration/marketo-custom-objects/create-marketo-custom-objects.md)
   ...
   + Conceptos principales de Marketo {#core-marketo-concepts}
      + Campañas inteligentes {#smart-campaigns}
         ...
         + Acciones de flujo {#flow-actions}
            ...
            + [Llamar a Weblock](product-docs/core-marketo-concepts/smart-campaigns/flow-actions/call-webhook.md)
            ...
            + [Dar crédito al referente](product-docs/core-marketo-concepts/smart-campaigns/flow-actions/give-credit-to-referrer.md)
         ...
         + Acciones de flujo de programa {#program-flow-actions}
            ...
            + [Cambiar la cadencia del programa de participación](product-docs/core-marketo-concepts/smart-campaigns/program-flow-actions/change-engagement-program-cadence.md)
         ...
         + Acciones de flujo de Salesforce {#salesforce-flow-actions}
            + [Añadir a la campaña SFDC](product-docs/core-marketo-concepts/smart-campaigns/salesforce-flow-actions/add-to-sfdc-campaign.md)
            + [Cambiar propietario](product-docs/core-marketo-concepts/smart-campaigns/salesforce-flow-actions/change-owner.md)
            + [Cambiar estado en una campaña SFDC](product-docs/core-marketo-concepts/smart-campaigns/salesforce-flow-actions/change-status-in-sfdc-campaign.md)
            ...
            + [Eliminar de la campaña SFDC](product-docs/core-marketo-concepts/smart-campaigns/salesforce-flow-actions/remove-from-sfdc-campaign.md)
      ...
      + Aplicaciones móviles {#mobile-apps}
         ...
         + Momentos de Marketo {#marketo-moments}
            ...
            + Uso de momentos {#working-with-moments}
               ...
               + [Personalización de los momentos de Marketo](product-docs/core-marketo-concepts/mobile-apps/marketo-moments/working-with-moments/personalizing-marketo-moments.md)
   ...
   + Sincronización de CRM {#crm-sync}
      + Microsoft Dynamics Sync {#microsoft-dynamics}
         ...
         + Configuración de sincronización {#sync-setup}
            ...
            + Microsoft Dynamics 2011 On-Premies {#microsoft-dynamics-2011-on-premises}
               ...
               + [Paso 3 de 3: Conectar Microsoft Dynamics con Marketo (local de 2011)](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-2011-on-premises/step-3-of-3-connect.md)
            + Microsoft Dynamics 2013 On-Premies {#microsoft-dynamics-2013-on-premises}
               + [Paso 1 de 3: Instalación de la solución Marketo en Dynamics (local 2013)](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-2013-on-premises/step-1-of-3-install.md)
            ...
            + Microsoft Dynamics 2015 On-Premies/2016 Dynamics 365 On-Premies {#microsoft-dynamics-2015-on-premises-2016-dynamics-365-on-premises}
               + [Paso 1 de 3: Instalación de la solución de Marketo - Locales 2015 / Locales 2016 Dynamics 365](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-2015-on-premises-2016-dynamics-365-on-premises/step-1-of-3-install.md)
               ...
               + [Paso 3 de 3: Conecte Marketo y Dynamics 2015 On-Premies/2016 Dynamics 365 On-Premies](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-2015-on-premises-2016-dynamics-365-on-premises/step-3-of-3-connect.md)
      ...
      + Configuración {#setup}
         ...
         + Pasos opcionales {#optional-steps}
            ...
            + [Hacer que el usuario de Marketo sincronice con el de Marketing](product-docs/crm-sync/salesforce-sync/setup/optional-steps/enable-disable-campaign-sync/make-marketo-sync-user-a-marketing-user.md)
         ...
         + [Configuración de OAuth 2.0](product-docs/crm-sync/salesforce-sync/setting-up-oauth-2-0.md)
   + Generación de demanda {#demand-generation}
      ...
      + Eventos {#events}
         ...
         + Crear un evento {#create-an-event}
            ...
            + [Configuración de eventos y sincronización de marketing con el seminario web](product-docs/demand-generation/events/create-an-event/create-an-event-with-the-marketo-on24-adapter/configure-event-settings-and-sync-marketo-with-your-webinar.md)
      ...
      + Facebook {#facebook}
         + [Agregar posibles clientes a una audiencia personalizada en Facebook](product-docs/demand-generation/facebook/add-leads-to-a-custom-audience-in-facebook.md)
         ...
         + [Asignar campos personalizados al marketo](product-docs/demand-generation/facebook/set-up-facebook-lead-ads/map-custom-fields-to-marketo.md)
      ...
      + Páginas de aterrizaje {#landing-pages}
         + Explicación de las páginas de aterrizaje {#understanding-landing-pages}
            ...
            + [Grupos de prueba de la página de aterrizaje](product-docs/demand-generation/landing-pages/understanding-landing-pages/landing-page-test-groups.md)
   ...
   + Experiencia de Marketo Engage de próxima generación {#marketo-engage-next-generation-experience}
      + [Información general](product-docs/marketo-engage-next-generation-experience/overview.md)
   ...
   + Conexión de ventas de Marketo {#marketo-sales-connect}
      ...
      + People {#people}
         ...
         + Administración de contactos {#managing-contacts}
            ...
            + [Conectar los posibles clientes de Marketo con los posibles clientes de Sales Connect](product-docs/marketo-sales-connect/people/managing-contacts/connect-your-marketo-leads-with-sales-connect-leads.md)
   ...
   + Perspectiva de ventas de Marketo {#marketo-sales-insight}
      ...
      + MSI para Microsoft Dynamics {#msi-for-microsoft-dynamics}
         ...
         + Instalación de {#installing}
            + [Descargar la solución de Marketo Sales Insight para Microsoft Dynamics](product-docs/marketo-sales-insight/msi-for-microsoft-dynamics/installing/download-the-marketo-sales-insight-solution-for-microsoft-dynamics.md)
      ...
      + MSI para Salesforce {#msi-for-salesforce}
         ...
         + MSI para móvil {#msi-for-mobile}
            ...
            + [Enviar acciones de Marketo Email y Campaign y Watchlist en Salesforce1](product-docs/marketo-sales-insight/msi-for-salesforce/msi-for-mobile/send-marketo-email-and-campaign-and-watchlist-actions-in-salesforce1.md)
      ...
      + Complemento de MSI Outlook {#msi-outlook-plugin}
         ...
         + [Instalación del complemento Marketo para Outlook con una clave de empresa](product-docs/marketo-sales-insight/msi-outlook-plugin/install-the-marketo-add-in-for-outlook-with-an-enterprise-key.md)
         ...
         + [Expedir una licencia de complemento de Marketo Email](product-docs/marketo-sales-insight/msi-outlook-plugin/issue-a-marketo-email-add-in-license.md)
   ...
   + Informes {#reporting}
      ...
      + Análisis del ciclo de ingresos {#revenue-cycle-analytics}
         ...
         + Modelos de ciclo de ingresos {#revenue-cycle-models}
            ...
            + [Ejemplo de modelo de ingresos de Clic en Marketo](product-docs/reporting/revenue-cycle-analytics/revenue-cycle-models/cloning-a-marketo-example-revenue-model.md)
