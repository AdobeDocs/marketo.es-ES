...
* Lea las [**directrices de la comunidad de marketing**](https://nation.marketo.com/t5/community-guidelines/ct-p/community-guidelines){target="_blank"}.
...
1. [Después de crear tu perfil](https://nation.marketo.com/){target="_blank"} con tu nueva información de compañía, envía una solicitud a `ccare@marketo.com` para que los datos de tu perfil de comunidad anterior se combinen con el nuevo.
...
* Para obtener asistencia técnica con algo que no funcione correctamente, póngase en contacto con **[Atención al cliente Marketo Engage](https://nation.marketo.com/t5/Support/ct-p/Support){target="_blank"}**.

* Conéctese con otros usuarios Marketo Engage de la **[Comunidad de Adobe Marketo Engage](https://nation.marketo.com/){target="_blank"}** y aprenda de ellos.
...
* Vea **[vídeos de tutoriales seleccionados](https://experienceleague.adobe.com/docs/marketo-learn/tutorials/overview.html?lang=es){target="_blank"}** sobre diferentes aspectos de Marketo Engage.
