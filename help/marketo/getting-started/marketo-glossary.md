...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colspan="1">Fecha en la que se conoce a una persona en Marketo. Esta fecha corresponde al valor de <strong>Programa de adquisición</strong> que adquirió a la persona.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1">Se usa para confirmar cuándo se usa un <strong>recurso</strong> está listo para el consumo. Los recursos no se pueden ver públicamente hasta que se hayan aprobado.</td> 
  </tr> 
  <tr> 
   <td colspan="1"><strong> recurso</strong></td> 
   <td colspan="1">Un elemento que sirve como contenido en su instancia de Marketo (p. ej., <strong>email</strong>, <strong>página de aterrizaje</strong>, <strong>campaña inteligente</strong>, etc.).</td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colspan="1">Una unidad organizativa que puede contener varias <strong>programas</strong> y/o <strong>campañas inteligentes</strong>. Al igual que una carpeta en el escritorio, las carpetas de Marketo se utilizan para la organización y los informes.</td> 
  </tr> 
  <tr> 
   ...
   <td colspan="1">Una conversión es el evento de envío de correos electrónicos desde un <strong>programa de participación</strong>.</td> 
  </tr> 
  <tr> 
   ...
   <td colspan="1">Tipo de actividad de marketing asociada a un <strong>programa</strong> (por ejemplo, correo electrónico, <strong>seminario web, </strong>feria comercial, exposición en carretera, publicidad en línea, etc.). </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1">Una condición adicional que puede agregar a la lista inteligente <strong>filtros</strong>/<strong>déclencheur </strong>para ayudarle a limitar la búsqueda.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1">Un área de <strong>Personalización web</strong> que muestra el contenido existente descubierto de su sitio web, así como el rendimiento del contenido.</td> 
  </tr> 
  <tr> 
   <td colspan="1"><strong>Nivel de participación en el contenido</strong></td> 
   <td colspan="1">Una puntuación de 0 a 100 puntos que Marketo proporcionará al contenido en un <strong>programa de participación</strong>. La puntuación se determina mediante una fórmula sofisticada que utiliza <strong>opens</strong>, <strong>clicks</strong>, <strong>cancelar suscripciones</strong>, éxito del programa, etc.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1">Campo no estándar que crea el usuario para satisfacer necesidades específicas. Tipos de campos personalizados <a href="/help/marketo/product-docs/administration/field-management/custom-field-type-glossary.md" rel="nofollow">tener su propio glosario</a>.</td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colspan="1">La capacidad de un mensaje de correo electrónico para llegar a la bandeja de entrada del destinatario deseado, que puede verse afectada por <strong>spam</strong> y filtros del lado del cliente. Distinto a "Enviado", que solo indica que el correo electrónico se entregó al servidor de destinatarios.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1">Una directiva de seguridad de correo electrónico basada en DNS que estandariza el funcionamiento y la interpretación de <strong>SPF</strong> y <strong>DKIM</strong>, lo que permite a los proveedores de buzones de correo validar que las solicitudes de correo que provienen de un dominio provienen de fuentes válidas para ese dominio. Además, permite a los remitentes especificar cómo se debe tratar el correo que falla en la validación.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1">Un estado maestro de cancelación de suscripción que garantiza que <strong>cancelar suscripción</strong> se elimina y se vuelve a crear una persona, o si se crea un nuevo registro con una misma dirección de correo electrónico que ya no se ha suscrito, ese registro seguirá cancelándose la suscripción.</td> 
  </tr> 
  <tr> 
   ...
   <td colspan="1">Contenido (p. ej., imágenes, fragmentos, texto, etc.) que rellena en un <strong>email</strong> o <strong>página de aterrizaje</strong> según los criterios especificados, lo que le permite personalizar la experiencia para el lector. </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colspan="1">Campo predeterminado en Marketo que indica si la dirección de correo electrónico de una persona está o no en su <strong>base de datos</strong> es entregable.</td> 
  </tr> 
  <tr> 
   <td colspan="1"> 
    <div> 
  ...
  <tr> 
   ...
   <td colspan="1">Estado que impide que una persona reciba correos electrónicos durante 24 horas después de un <strong>devolución fuerte</strong> ocurre. Después de 24 horas, la persona vuelve a ser enviada. </td> 
  </tr> 
  <tr> 
   <td colspan="1"> 
    <div> 
  ...
  <tr> 
   ...
   <td>Puntuación basada en un algoritmo propietario que tiene en cuenta: comportamiento comprometido (<strong>opens</strong>, <strong>clicks</strong>, éxito del programa) y comportamiento desactivado (cancelar suscripciones).</td> 
  </tr> 
  <tr> 
   ...
   <td>Algo que ocurre para que pueda comunicarse con sus clientes y clientes potenciales. Los eventos sin conexión suelen consistir en reuniones o ferias, y los eventos en línea suelen <strong>seminarios web</strong>.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1">Tipo de programa en Marketo. Los programas de eventos se utilizan para automatizar sus <strong>events</strong>, tanto en línea como fuera de línea (por ejemplo, seminarios web, encuentros, ferias, etc.).  </td> 
  </tr> 
  <tr> 
   ...
   <td colspan="1">Cuando una persona ha recibido cada parte de contenido en un flujo de participación. Las personas marcadas como agotadas permanecerán como tales hasta que se añadan <strong>contenido</strong> se añade.</td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>Una herramienta utilizada en <strong>listas inteligentes</strong> que le permite reducir la audiencia (por ejemplo, todas las personas de la base de datos que residan en California). Los filtros se pueden usar en ambas <strong>Lote</strong> y <strong>Campañas de déclencheur</strong>.</td> 
  </tr> 
  <tr> 
   <td><strong>Flujo</strong></td> 
   <td><p>El área de una <strong>campaña inteligente</strong> que determina qué les sucede a las personas que ha elegido mediante los criterios establecidos en la variable <strong>lista inteligente</strong>. El flujo consiste en uno o más <strong>pasos de flujo</strong>.</p></td> 
  </tr> 
  <tr> 
   ...
   <td>También se denomina acción de flujo: una acción que tiene lugar para la persona o personas que ha elegido (como parte de un <strong>campaña inteligente</strong>, una acción de flujo único de una <strong><a href="/help/marketo/product-docs/core-marketo-concepts/smart-lists-and-static-lists/using-smart-lists/run-a-single-flow-step-from-a-smart-list.md" rel="nofollow">lista inteligente</a></strong>o una sola acción de flujo en una persona).</td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>Recursos creados en <strong>Design Studio</strong> para uso en <strong>programas</strong> en su instancia de Marketo. </td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td><p>Cualquier dato de persona en Marketo <strong>base de datos</strong> se consideran datos de personas conocidas. Hay varias formas de que alguien entre en la base de datos, entre ellas: Sincronización de CRM, rellenado de un formulario, importación de lista/entrada manual, programática (integraciones de API/socio de rest), etc. Inicialmente, los visitantes web <strong>cookie</strong> (y son anónimos) a través de Marketo <strong>Munchkin</strong> seguimiento web y se asignan posteriormente al registro de persona conocida correspondiente cuando se produce una acción identificable (por ejemplo, hacer clic en un vínculo rastreado en un correo electrónico de Marketo, rellenar un formulario con su dirección de correo electrónico o asignarse manualmente a través de las API de posible cliente de asociación de Marketo en ambos <a href="https://developers.marketo.com/javascript-api/lead-tracking/api-reference/#munchkin_associatelead">Munchkin</a> y <a href="https://developers.marketo.com/rest-api/endpoint-reference/lead-database-endpoint-reference/#!/Leads/associatedLeadUsingPOST">API de Rest</a></p></td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colspan="1">Una colección de personas. En Marketo hay listas inteligentes y listas estáticas. A <a href="/help/marketo/product-docs/core-marketo-concepts/smart-lists-and-static-lists/understanding-smart-lists.md" rel="nofollow">lista inteligente</a> es una lista dinámica de personas que pueden cambiar constantemente, ya que se basa en filtros definidos (por ejemplo, todas las personas de la base de datos que viven en California). Cuando nuevas personas cumplen los criterios (o las personas existentes ya no cumplen los requisitos), la lista cambia. A <a href="/help/marketo/product-docs/core-marketo-concepts/smart-lists-and-static-lists/static-lists/understanding-static-lists.md" rel="nofollow">lista estática</a> es, bueno, estático. No cambia a menos que agregue o elimine manualmente a alguien.</td> 
  </tr> 
  <tr> 
   ...
   <td><strong>Recursos</strong> se utiliza dentro de un <strong>programa</strong>.</td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colspan="1">Este campo se configura manualmente mediante la variable <strong>usuario</strong> para crear alguien en su Marketo <strong>base de datos</strong> se puede desenviar temporalmente.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1">Una función de complemento que permite a los especialistas en marketing potenciar a sus vendedores con perspectivas de marketing a partir de sus <strong>CRM</strong>.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1">Variables personalizadas que se pueden crear. Son <a href="/help/marketo/product-docs/core-marketo-concepts/programs/tokens/managing-my-tokens.md" rel="nofollow">created</a> en <strong>carpetas de campaña</strong> o <strong>programas</strong>.</td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td><p>Una apertura se registra cuando las imágenes se descargan en un <strong>email</strong>. Aunque no incluya una imagen, Marketo inserta de forma predeterminada un solo píxel de seguimiento en todos los correos electrónicos de HTML. Los correos electrónicos de solo texto no pueden registrar una apertura.</p></td> 
  </tr> 
  <tr> 
   ...
   <td colspan="1"> Un correo electrónico que ignora <strong>Cancelación de suscripción</strong> y <strong>Marketing suspendido</strong> estado. Se ha pensado para su uso en correos electrónicos críticos o de respuesta automática. No está pensado para el marketing. Los correos electrónicos operativos no se enviarán a personas con <strong>Incluido en la lista de bloqueados</strong> o <strong>Correo electrónico no válido</strong> estado. <br></td> 
  </tr> 
  <tr> 
   <td><strong>Oportunidades</strong></td> 
   <td>Una oportunidad puede asociarse con un <strong>person</strong> o <strong>account</strong> como posible venta futura. Normalmente entran en Marketo a través de una <strong>CRM</strong>o mediante <strong>API</strong>.</td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>Un individuo en su Marketo <strong>base de datos</strong> con el que interactúa mediante campañas de marketing.</td> 
  </tr> 
  <tr> 
   ...
   <td colspan="1">Las particiones de persona actúan como independientes <strong>bases de datos</strong>. Cada partición tiene su propia gente que no desduplica ni combina con otras particiones.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1">Una encuesta en Marketo es como una encuesta normal. Crear un tema para que las personas voten y lo compartan en su Marketo <strong>páginas de aterrizaje</strong>, su sitio web o medios sociales.</td> 
  </tr> 
  <tr> 
   <td> 
    <div> 
   ...
   <td>(anteriormente conocido como ContentAI) Función de complemento que ayuda a los usuarios de Marketo a atraer mejor a los visitantes web y a los destinatarios de correo electrónico con los más relevantes <strong>contenido</strong>, con recomendaciones que utilizan aprendizaje automático y análisis predictivos.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1"> El mes asociado al <strong>coste de período</strong> de <strong>programa</strong>.</td> 
  </tr> 
  <tr> 
   ...
   <td colspan="1">Un tipo de informe en Marketo. Le permite ver cómo están funcionando sus programas. Filtrar por <strong>etiquetas</strong>, <strong>coste de período</strong>, etc.</td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td>Cuando una persona cumple los criterios predeterminados en un <strong>campaña inteligente</strong>, cumplen los requisitos para ello. Puede establecer reglas de cualificación para determinar cuántas veces pueden ejecutarse a través de la variable <strong>flujo</strong> en dicha campaña inteligente.</p></td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colspan="1"><p>Puntuación del rendimiento a lo largo del tiempo, compuesta por varias señales y/o puntos de datos. La reputación podría estar vinculada al dominio de un remitente, <strong>contenido</strong>, o dirección IP y afecta a <strong>capacidad de entrega</strong>.</p></td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1">Una herramienta utilizada en <strong>Análisis del ciclo de ingresos (RCA)</strong> que utiliza una serie de etapas, lo que le permite rastrear dónde <strong>posible cliente</strong> en cualquier momento durante el esfuerzo por convertirlos.</td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colspan="1">Una prueba <strong>email</strong> usted se envía (y/u otros) para ver cómo se ve antes de enviarlo a sus clientes. También puede utilizar muestras para probar <strong>contenido dinámico</strong>.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colspan="1"><strong><a href="/help/marketo/product-docs/email-marketing/deliverability/set-up-spf-and-dkim-for-your-email-deliverability.md" rel="nofollow">Marco de políticas del remitente</a> (SPF)</strong></td> 
  ...
  <tr> 
   ...
   <td colspan="1">Una de las herramientas más importantes de Marketo. Realizan las acciones que usted designe según los criterios que usted determine. (consulte también <strong><a href="#b">Campaña por lotes</a></strong> y <strong><a href="#t">Campaña de déclencheur</a></strong>)</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1">Un bloque de <strong>contenido</strong> (texto, imagen) que se puede precrear e insertar rápidamente en <strong>páginas de aterrizaje</strong>/<strong>correos electrónicos</strong> en adelante.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1">Direcciones de correo electrónico que los ISP y los proveedores de seguridad de correo electrónico monitorean específicamente para atrapar a los remitentes de correo no deseado. Pueden incluir direcciones nunca utilizadas, dominios de error y dominios caducados. Los diferentes tipos de trampas de correo no deseado pueden indicar diferentes problemas con la adquisición de problemas con formularios (trampas de correo no deseado tipográficas), el mantenimiento inadecuado de una base de datos o la eliminación de direcciones no válidas (trampas de correo no deseado de dominio caducado) o la adquisición de direcciones sin permiso, a menudo mediante listas de compras (trampas de correo no deseado prístinas). Cualquier correo enviado a estas direcciones se marca como <strong>spam</strong>.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1">Recopilación de prioridades <strong>contenido</strong> que se usa en un <strong>programa de participación</strong> para nutrir a la gente. <a href="/help/marketo/product-docs/email-marketing/drip-nurturing/creating-an-engagement-program/add-content-to-a-stream.md" rel="nofollow">Contenido</a> se distribuye en el orden que designe.</td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colspan="1">Cuando <strong>person</strong> decide no recibir más correos electrónicos de marketing, otro término para la exclusión.</td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>Un tipo de informe en Marketo. Le permite ver el <i>o</i> personas anónimas que visiten su sitio web.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td>Seminario basado en la Web. En Marketo, los seminarios web se pueden llevar a cabo a través de diferentes <strong><a href="/help/marketo/product-docs/demand-generation/events/understanding-events/event-partners.md" rel="nofollow">socios de eventos.</a></strong></td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td>Un pequeño elemento gráfico de una aplicación que permite una interacción específica. Los widgets solo están disponibles en el Marketo Sky (distinto de un <a href="/help/marketo/product-docs/web-personalization/working-with-web-campaigns/create-a-new-widget-web-campaign.md" rel="nofollow">Widget web campaign)</a></td> 
  </tr> 
  <tr> 
   <td><strong>Comodín</strong></td> 
   <td>Se utiliza un carácter (*) en <strong>Personalización web</strong>) que se utiliza antes o después de una cadena para sustituir a cualquier otro carácter de una cadena.</td> 
  </tr> 
  <tr> 
   ...
   <td>Un área separada en Marketo que contiene marketing <strong>activos</strong>. Por ejemplo, puede tener un espacio de trabajo denominado "Norteamérica" que utilice estrictamente para el marketing de esa región. Europa, Asia, etc.</td> 
  </tr>  
 </tbody> 
</table>
