...
Para obtener la información más reciente, marque esta página como favorito. Para recibir actualizaciones de estado al inicio y al finalizar la migración, pero [debes suscribirte](https://experienceleague.adobe.com/es/docs/marketo/using/getting-started/things-to-know/system-status-notifications){target="_blank"} para recibirlas. También puede visitar https://status.adobe.com/es-es/.
