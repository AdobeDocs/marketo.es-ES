...
<tbody>
  <tr>
    ...
    <li><a href="https://experienceleague.adobe.com/es/docs/marketo/using/product-docs/reporting/basic-reporting/editing-reports/change-a-report-time-frame">Usar un periodo de tiempo relevante</a> (por ejemplo, hasta la fecha, últimos 90 días, etc.) para que el informe proporcione una vista precisa de la participación de correo electrónico estándar y las métricas de envío.</li>
  ...
  <tr>
    ...
    <li>Filtre las métricas de los informes de rendimiento de personas por <a href="https://experienceleague.adobe.com/es/docs/marketo/using/product-docs/reporting/basic-reporting/editing-reports/add-custom-columns-to-a-person-report">mediante sus listas inteligentes como columnas personalizadas.</a></li>
  ...
  <tr>
    ...
    <p>
    <li><a href="https://experienceleague.adobe.com/es/docs/marketo/using/product-docs/core-marketo-concepts/programs/program-performance-report/create-a-program-performance-report">Mida la eficacia de sus tácticas de marketing</a> dentro de programas selectivos.</li>
    ...
    <ul><li>Recuerde que el mantenimiento de <a href="https://experienceleague.adobe.com/es/docs/marketo/using/product-docs/core-marketo-concepts/programs/working-with-programs/using-period-costs-in-a-program">costos de período</a> es fundamental para aprovechar el informe de rendimiento del programa.</li></ul></li>
    <p>
    <img src="assets/tip-icon.png" alt="icono de nota"> SUGERENCIA: para agregar y ver <a href="https://experienceleague.adobe.com/es/docs/marketo/using/getting-started/quick-wins/import-a-list-of-people">listas importadas</a> en los informes de rendimiento del programa, asegúrese de que sus equipos seleccionen el programa de adquisición adecuado para el etiquetado. Considere <a href="https://experienceleague.adobe.com/es/docs/marketo-learn/tutorials/programs-and-campaigns/default-programs/create-and-measure-default-programs">crear un programa predeterminado</a> para seleccionarlo como programa de adquisición cuando las listas importadas no se apliquen a ningún canal. Esto garantiza que cualquier persona importada tenga un programa de adquisición válido relacionado con el origen, la unidad de negocio, el canal, etc., en lugar de un valor en blanco.</td>
  </tr>
  <tr>
    <td>Informe de rendimiento de la página de destino</td>
  ...
  <tr>
    <td>Informe de actividad de la página web</td>
...
<tbody>
  <tr>
    <td>Informe de rendimiento de vínculos de correo electrónico</td>
  ...
  <tr>
    <td>Informe de actividad de campaña</td>
    <td><li>Cree el <a href="https://experienceleague.adobe.com/es/docs/marketo/using/product-docs/reporting/basic-reporting/report-types/campaign-activity-report" target="_blank">Informe de actividad de campaña</a> y elija un período dentro de su carpeta operativa en Actividades de marketing.</li>
