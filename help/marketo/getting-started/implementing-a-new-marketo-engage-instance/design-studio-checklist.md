...
<tbody>
  ...
  <tr>
    <td>Privacidad y cumplimiento</td>
    <td><li>Conservar los formularios <a href="https://business.adobe.com/resources/ebooks/the-gdpr-and-the-marketer.html" target="_blank">Reglamento General de Protección de Datos (RGPD)</a> compatible.</li></td>
  </tr>
  <tr>
...
<tbody>
  ...
  <tr>
    <td>Privacidad y cumplimiento</td>
    <td><li><a href="https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/email-marketing/general/functions-in-the-editor/add-a-snippet-to-an-email" target="_blank">Añadir fragmentos de código</a> a sus plantillas de correo electrónico para controlar bloques reutilizables como el año de copyright, la ubicación global y el idioma específico del cumplimiento normativo.</li>
    <li><a href="https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/email-marketing/general/using-tokens/add-an-email-script-token-to-your-email" target="_blank">Añadir tokens</a> para personalizar el contenido en función de la audiencia de destino.</li></td>
  </tr>
</tbody>
</table>
