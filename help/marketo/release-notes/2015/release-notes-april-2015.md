...
La nueva [Página de inicio de Analytics](/help/marketo/product-docs/reporting/basic-reporting/creating-reports/navigating-the-analytics-home-page.md) permite un acceso rápido para ejecutar informes ad-hoc en los tipos de informes disponibles.
...
**Compromiso con dispositivos móviles de marketing**

Con la participación de dispositivos móviles de Marketing Cloud, la entrega de experiencias móviles atractivas es fácil. Cree campañas altamente personalizadas que proporcionen contenido atractivo sin necesidad de depender nunca de un equipo de desarrollo de aplicaciones. Los nuevos filtros y déclencheur le permiten escuchar y responder en el canal móvil mediante notificaciones push.
