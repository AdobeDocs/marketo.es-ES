...
## Perspectivas de rendimiento de Marketo {#marketo-performance-insights}

[Perspectivas de rendimiento de Marketo](/help/marketo/product-docs/reporting/performance-insights/performance-insights-overview.md)
...
## Actualizaciones de Marketo [!DNL Sales Engage], Launch y [!DNL ToutApp] {#marketo-sales-engage-launch-and-toutapp-updates}
...
* [!DNL ToutApp] actualizaciones

>[!AVAILABILITY]
>
>[!DNL Sales Engage] es un producto de complemento. Póngase en contacto con el administrador de éxitos del cliente o con el ejecutivo de cuentas de Marketo para obtener un presupuesto.

Impulse más canalizaciones e ingresos al potenciar las ventas con la inteligencia, el contenido, los libros de reproducción y los análisis para convertir más de sus posibles clientes en oportunidades de ventas. [!DNL Sales Engage] proporciona a ventas y marketing una plataforma unificada para la participación en todo el recorrido del cliente y permite una mejor coordinación mediante una vista compartida de los puntos de contacto del cliente.
...
* **Experiencia de configuración de cuenta optimizada**: configure su cuenta y conéctela a [!DNL Gmail], [!DNL Outlook] y otros sistemas más rápido.

## Marketo Sky Open Beta {#marketo-sky-open-beta}

[Marketo Sky Open Beta](https://help.marketo.com/)

Adquiera la versión beta abierta de Marketo Sky para obtener acceso a más de 100 nuevas funciones que mejoran la productividad, entre ellas:
...
## [!UICONTROL Perspectivas de rendimiento] {#performance-insights}

[[!UICONTROL Perspectivas de rendimiento]](/help/marketo/product-docs/reporting/performance-insights/performance-insights-overview.md)
...
Comparta fácilmente sus gráficos rápidos con otros usuarios de [!UICONTROL Performance Insights].
...
Integración de Facebook Workplace

Envíe notificaciones del sistema y momentos interesantes a [!DNL Facebook Workplace].

API de lista estática
...
El seguimiento mejorado de [!DNL Munchkin] cumple con las regulaciones de privacidad locales e internacionales al hacer anónimas las direcciones IP de los visitantes web y permitirles excluirse permanentemente del seguimiento web.
