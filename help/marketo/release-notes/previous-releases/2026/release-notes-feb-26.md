...
<table style="table-layout:auto">
 ...
 <tr>
  ...
  <tr>
   ...
   <td>Publicado</td>
   <td><a href="https://experienceleague.adobe.com/es/docs/marketo/using/product-docs/email-marketing/email-designer/ai-assistant#create-content-for-a-specific-section">Creación de contenido para una sección específica del correo electrónico</a></td>
  </tr>
  </tbody>
</table>
<br/>
