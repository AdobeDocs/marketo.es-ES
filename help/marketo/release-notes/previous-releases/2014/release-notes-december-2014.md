...
description: 'Notas de la versión, diciembre de 2014: Documentación del producto de Marketo'
...
La versión de diciembre de 2014 incluye las siguientes funciones. Compruebe la disponibilidad de las funciones en Marketo Edition. Después de la versión, asegúrese de volver para encontrar vínculos a artículos detallados para cada función.
...
Los vínculos dentro de los scripts de correo electrónico ahora se rastrearán y estarán disponibles en el informe Rendimiento del vínculo de correo electrónico .
...
El lanzamiento se realizará a partir de mediados de diciembre y continuará durante los próximos meses.

## Ingresos Explorer Búsqueda y presentación actualizadas {#revenue-explorer-upgraded-look-and-feel}
...
Administre y supervise sus cuentas clave de alto rendimiento en la nueva página Cuentas con nombre . Cargue nuevas listas de cuentas con nombre para identificar y segmentar estas organizaciones. Hemos automatizado el proceso, lo que le proporciona más control y flexibilidad para implementar sus planes de marketing basados en cuentas y dirigir las cuentas clave a través de diferentes canales (web y publicidad).
...
Hemos agregado un nuevo efecto deslizante para las campañas In Zone para permitir que el contenido personalizado se deslice en su lugar al cargar la página.
