...
Muestre los activos de marketing de su equipo con el nuevo modo de presentación del calendario. ¡Son buenos para televisores o monitores gigantes en toda la oficina! Defina y muestre los objetivos en función de una lista inteligente o de métricas personalizadas.

>[!NOTE]
>
>Esta función no está disponible para las ediciones estándar y de demostración.
...
El Explorador de ingresos tiene un aspecto totalmente nuevo, así como el nuevo tipo de gráfico radial. Lo haremos durante las dos primeras semanas de abril.
...
Compatible con el último instalador ahora [accesible a través de la aplicación](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/update-the-marketo-solution-for-microsoft-dynamics.md).
