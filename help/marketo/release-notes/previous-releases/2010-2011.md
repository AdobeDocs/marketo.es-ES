...
* **Sincronización de programas con campañas de Salesforce**: sincroniza tus programas de Marketo con campañas de Salesforce, incluidos los miembros, el estado y el costo.
...
* **Uso compartido en medios sociales de las páginas de destino**: agrega y configura fácilmente botones para compartir en medios sociales en tus correos electrónicos, incluidos Facebook, Twitter, LinkedIn y Google+.
* **Compatibilidad con oportunidades nativas**: Especialmente útil para los clientes que no utilizan Salesforce como su CRM, hemos lanzado un conjunto de nuevas API para realizar operaciones de Crear, Leer, Actualizar y Eliminar (CRUD) en el objeto Opportunity dentro de Marketo.
...
* **Compatibilidad con navegadores**: Compatibilidad con navegadores Google Chrome y Firefox 6. Las nuevas versiones de estos exploradores, así como Internet Explorer, serán compatibles a medida que se publiquen.
...
* **Personalizar estrellas y llamas**: ahora puede elegir qué campos de puntuación impulsan las estrellas y llamas en Sales Insight.
...
* **Adaptador de WebEx**: conecte sin problemas un evento inteligente a un evento de WebEx (se requiere el Centro de eventos de WebEx) y use las páginas de aterrizaje y los formularios de Marketo para capturar a los inscritos y registrarlos automáticamente en WebEx.
...
* **Analizador de programas**: con un simple vistazo puede comparar fácilmente diferentes canales (por ejemplo, seminarios web, ferias comerciales, colocaciones de anuncios, etc.) y evalúan cuáles son los que generan los mejores retornos en una amplia selección de mediciones de éxito.
...
* **Adaptador WebEx**: Envíe la información de registro a WebEx a través de campañas de Marketo y extraiga la información de asistencia después del evento.
...
* **Mejoras en el editor de correo electrónico**: se han corregido más de 20 errores, incluidos errores dirigidos específicamente a Chrome.
...
* **Actualización de perspectivas de ventas**: mejoras de rendimiento además de enviar hasta 200 correos electrónicos a la vez.
...
* **Integración de capítulos para la perspectiva de ventas**: Ahora incluimos momentos interesantes en su cronología de capítulos.
* **Reglas de asignación de partición de cliente potencial**: Simplifique la asignación de particiones para nuevos clientes potenciales de Salesforce y API
...
* SOAP SOAP **Configuración de la API de**: Obtenga la configuración de la API de datos mediante la interfaz de Marketo.
