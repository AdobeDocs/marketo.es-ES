...
* **Nueva ficha Configuración de informes**: Hemos realizado cambios en donde puede configurar la configuración del informe. Una nueva ficha, denominada Configuración, está disponible en todos los informes.
...
* **Descubra los informes del Explorador de ingresos desde el analizador de eficacia de programas**: Si hace clic en cualquier hipervínculo de la ventana de detalles del programa, se le dirigirá a un informe detallado en el Explorador de ciclo de ingresos.
...
* **Compatibilidad con navegadores**: Compatibilidad con los navegadores Google Chrome y Firefox 6. Las nuevas versiones de estos navegadores, así como Internet Explorer, serán compatibles a medida que se vayan publicando.
...
* **Administración de programas multicanal**: Administre de forma eficiente programas complejos en varios canales, incluidos anuncios en línea, campañas de vídeo, eventos móviles, virtuales y medios sociales.
...
* **Informe Rendimiento del Programa**: Comprenda la eficacia de los programas y eventos de marketing con nuevas métricas, como los nuevos nombres adquiridos y los posibles clientes que hayan alcanzado los criterios de éxito definidos.
...
* **Tokens en el valor de cambio de datos**: Utilice tokens en un paso Cambiar el valor de los datos para actualizar un campo.
...
* **Baja duradera**: Mejoras que automatizan situaciones complejas de cancelación de suscripción.
...
* **Visita web ****explorar en profundidad**: Ver las páginas web que vio un posible cliente desde el informe de actividad web.
...
* **Informe de correo electrónico de la campaña**: Cree informes personalizados para ver el rendimiento de los correos electrónicos por campaña.
...
* **Cambio de escenario manual del modelado**: Utilice este déclencheur en el modelo cuando los posibles clientes se muevan manualmente a un escenario.
...
* **Informe de clic en el correo electrónico**: Ver detalles sobre en qué vínculos de correo electrónico se hizo clic.
...
* **Actualizaciones en la búsqueda de posibles clientes**: Busque posibles clientes más rápido al utilizar la Vista rápida.
