...
* **Sincronizar objetos personalizados de Salesforce**: Use sus objetos de Salesforce en listas inteligentes y campañas.
...
* **Vínculo de Salesforce en Enviar información de alerta**: Cuando uses un token de Enviar información de alerta en un mensaje de correo electrónico y el posible cliente esté en Salesforce, obtendrás vínculos a Salesforce y Marketo.
...
* **Más complementos de jQuery hospedados** para usar en páginas de aterrizaje. Hay disponibles todo tipo de funciones dinámicas en páginas de aterrizaje con HTML personalizado. Pídenos ayuda hoy mismo. Publicaremos el &quot;How-to&quot; pronto. Algunas posibilidades:
