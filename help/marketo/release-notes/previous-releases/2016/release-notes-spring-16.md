...
>[!NOTE]
>
>El Editor de correo electrónico 2.0 (con el Selector de plantilla) se implementará gradualmente a partir del 3 de junio. Completaremos el despliegue para el 30 de junio. A diferencia de las perspectivas de correo electrónico, no se le notificará cuando tenga acceso. Para ver si lo hace, siga los pasos indicados en [este artículo](/help/marketo/product-docs/email-marketing/general/email-editor-2/transitioning-to-email-editor-2-0.md).
...
**Ficha Administración de errores de sincronización**: Examinar, buscar o exportar posibles clientes (y otros objetos) que no se hayan sincronizado con detalles como operación, dirección, código de error y mensaje de error.
...
**Las actualizaciones de complementos ya están documentadas:** Consulte la [artículo de documentos de actualizaciones del complemento](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/marketo-plugin-releases-for-microsoft-dynamics.md).
