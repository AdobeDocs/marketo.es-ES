...
<table style="table-layout:auto">
 ...
 <tr>
  ...
  <tr>
   ...
   <td><a href="https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/marketo-ai/skills/product-knowledge" target="_blank">Información general sobre Marketo AI</a></td>
  </tr>
  <tr>
   <td> </td>
   <td> </td>
  ...
  <tr>
   ...
   <td>Abrir versión beta</td>
   <td><a href="https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/marketo-ai/skills/investigate-leads" target="_blank">Información general sobre Marketo AI</a></td>
  </tr>
  <tr>
   <td> </td>
   <td> </td>
