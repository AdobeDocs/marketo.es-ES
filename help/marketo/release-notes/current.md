...
<table> 
  ...
  <tr> 
   <td>Enviado</td>
   <td><a href="/help/marketo/product-docs/core-marketo-concepts/programs/working-with-programs/program-member-custom-field-sync.md">Sincronización de campos personalizados del miembro del programa</a></td>
  </tr>
  </tbody>
</table>
