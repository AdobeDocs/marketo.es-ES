---
description: Temp - Documentos de Marketo - Documentación del producto
title: Temp
hide: true
hidefromtoc: true
...
* **Mejorado utilizado por el componente para detalles de plantillas de correo electrónico y detalles de fragmentos**: Mejorar la experiencia mediante una nueva pestaña utilizada por la interfaz de usuario que proporciona información adicional sobre cada uno de los recursos utilizados por , como cuándo se modificó por última vez y quién lo hizo. Puede realizar análisis fácilmente mediante las funciones de búsqueda, clasificación y filtrado. Este nuevo componente de interfaz de usuario se incorporará a partir de los recursos de plantilla de correo electrónico y fragmento de código .
...
* **Pantallas actualizadas en la experiencia de usuario moderna**: Ofrecemos pantallas adicionales y actualizadas en la experiencia de próxima generación que ofrecen un diseño actualizado y mejoras de uso accesibles mediante el conmutador:
...
* **Personalización en la confirmación de la reunión para el chat dinámico**: Los agentes pueden personalizar las confirmaciones de correo electrónico de reserva de reuniones utilizando los campos Marketo Engage persona y empresa para interactuar mejor con los clientes (por ejemplo: salude al visitante por su nombre en el correo electrónico de notificación de reserva de reunión automatizada).
...
* **Informe Participación en el diálogo para la conversación dinámica**: Proporciona una vista de la participación del diálogo a lo largo del tiempo, incluida la capacidad de filtrar por tipo de visitante y tipo de participación.
...
* **Selector de fecha y hora de bots para chat dinámico**: Bien.
