...
[Utilice la ](/help/marketo/product-docs/email-marketing/email-programs/email-program-actions/email-test-a-b-test/define-the-a-b-test-winner-criteria.md) puntuación de participación para determinar la variante ganadora en la prueba de división A/B o en la prueba de Champion/Challenger. La prueba debe ejecutarse durante un mínimo de 24 horas para obtener una puntuación de participación adecuada.

![](assets/image2014-9-22-10-3a46-3a49.png)

## Pestaña Resultados del programa de correo electrónico {#email-program-results-tab}

[Vea los ](/help/marketo/product-docs/email-marketing/email-programs/email-program-data/view-email-program-results.md) resultados y las actividades registradas para el programa de correo electrónico.

![](assets/image2014-9-22-10-3a47-3a19.png)

## Personas/posibles clientes bloqueados del correo electrónico {#people-leads-blocked-from-mailing}

[Haga clic en las personas o posibles clientes bloqueados del número de ](/help/marketo/product-docs/email-marketing/email-programs/managing-people-in-email-programs/define-an-audience-with-a-smart-list.md) correo para ver quién no recibirá el correo electrónico debido a la cancelación de la suscripción, la inclusión en una lista negra, la existencia de una dirección de correo electrónico no válida o en blanco o la suspensión de la comercialización.

![](assets/image2014-9-22-10-3a47-3a42.png)

## Exportar datos del programa de correo electrónico {#export-email-program-data}
...
## Actualización de los filtros de vínculo de clics y el Déclencheur {#update-to-clicks-link-filters-and-trigger}
