...
## [Pista de auditoría](https://docs.marketo.com/display/docs/audit+trail) {#audit-trail}
...
## [Integración de LaunchPoint de SMS de Marketo-Vibes](https://docs.marketo.com/display/docs/vibes+sms+messages) {#marketo-vibes-sms-launchpoint-integration}
...
## [Varios dominios de marca](https://docs.marketo.com/display/docs/add+multiple+branding+domains) {#multiple-branding-domains}
