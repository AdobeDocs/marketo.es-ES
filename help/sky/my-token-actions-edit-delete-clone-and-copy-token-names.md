...
Para copiar el nombre de un token en el portapapeles (es decir, {{my.Evento Calendar File}}), haga clic con el botón derecho en el token y seleccione [!UICONTROL **Copiar nombre**] de token.
