...
1. Escriba un nombre para el nuevo token y, a continuación, agregue el texto que desee. Haga clic en [!UICONTROL **Guardar**].

   ![Imagen dos](/help/sky/assets/my-tokens/my-token-text/my-token-text-2.png)
